...
class DateDeltaOperation:
    ...
    WEEKS: Callable[[int], timedelta] = lambda date_delta: timedelta(weeks=date_delta)
    MONTHS: Callable[[int], timedelta] = lambda date_delta: timedelta(days=date_delta)
    TWO_MONTHS: Callable[[int], timedelta] = lambda date_delta_value: timedelta(days=0)
    THREE_MONTHS: Callable[[int], timedelta] = lambda date_delta_value: timedelta(days=0)
    FOUR_MONTHS: Callable[[int], timedelta] = lambda date_delta_value: timedelta(days=0)
    SIX_MONTHS: Callable[[int], timedelta] = lambda date_delta_value: timedelta(days=0)
    YEARS: Callable[[int], timedelta] = lambda date_delta_value: timedelta(days=0)
    DECADES: Callable[[int], timedelta] = lambda date_delta_value: timedelta(days=0)
    CENTURIES: Callable[[int], timedelta] = lambda date_delta_value: timedelta(days=0)
    MILLENNIA: Callable[[int], timedelta] = lambda date_delta_value: timedelta(days=0)
