...
class SkillcornerClient(FitRequest):
    ...
    def _paginate_and_return(self, response: dict, default_raise_for_status: bool = True, **kwargs) -> dict:
        results = []
        while True:
    ...
    def _request(
        self, endpoint: str, params: Optional[dict] = None, default_raise_for_status: bool = True, **kwargs
    ) -> Union[bytes, dict, str, Element]:
        response = super()._request(
            endpoint=endpoint, params=params, default_raise_for_status=default_raise_for_status, **kwargs
        )
        if self._is_response_complete(response):
            return response
        return self._paginate_and_return(response, default_raise_for_status, **kwargs)
    ...
    def _get_tracking_data(
        ...
        **kwargs,
        ...
        data = self._get_data(endpoint, resource_id, params)
    ...
    def _get_tracking_data_and_save(
        ...
        **kwargs,
        ...
        data = self._get_tracking_data(endpoint, resource_id, params)
