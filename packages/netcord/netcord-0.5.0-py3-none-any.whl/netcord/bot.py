...
class Bot(_main_bot):  # type: ignore
    """The neCord bot class. This is a subclass of :class:`discord.Bot` if you use Pycord.
    ...
    **kwargs:
    ...
    async def get_application_context(self, interaction: discord.Interaction, cls=neContext):
    ...
    def add_help_command(
        ...
        *,
        ...
        if not DPY:
            self.load_extension("necord.cogs.pyc.help_setup", package="necord")
    ...
    def add_status_changer(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("necord.cogs.pyc.status_changer_setup", package="necord")
    ...
    def add_blacklist(
        ...
        *,
        ...
        neConfig.blacklist = Blacklist(
            db_path,
            db_name,
            raise_error,
            owner_only,
        )
        neConfig.admin_guilds = admin_server_ids

        self.enabled_extensions.append("blacklist")
        if not DPY:
            self.load_extension("necord.cogs.pyc.blacklist_setup", package="necord")
    ...
    async def setup_hook(self):
        ...
        for ext in self.enabled_extensions:
            await self.load_extension(f".cogs.dpy.{ext}_setup", package="necord")
...
class PrefixBot(Bot, commands.Bot):
    ...
    This class can be used if you want to use neCord with prefix commands.
...
class BridgeBot(Bot, bridge.Bot):
    ...
    This class can be used if you want to use neCord with bridge commands.
    This is only needed for Pycord.
    """
