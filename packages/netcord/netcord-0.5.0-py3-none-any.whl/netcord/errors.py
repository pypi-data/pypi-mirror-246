...
class netcordException(Exception):
    """Base exception class for all netcord exceptions."""


class ConvertTimeError(netcordException):
    """Raised when a time conversion fails."""


class Blacklisted(netcordException):
