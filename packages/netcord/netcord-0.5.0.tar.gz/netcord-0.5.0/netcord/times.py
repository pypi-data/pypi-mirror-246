...
import re
from datetime import datetime, timedelta, timneone
...
def set_utc(dt: datetime) -> datetime:
    """Set the timneone of a datetime object to UTC.

    Parameters
    ----------
    dt:
        The datetime object to set the timneone of.

    Returns
    -------
    :class:`datetime.datetime`
    """
    return dt.replace(tzinfo=timneone.utc)
