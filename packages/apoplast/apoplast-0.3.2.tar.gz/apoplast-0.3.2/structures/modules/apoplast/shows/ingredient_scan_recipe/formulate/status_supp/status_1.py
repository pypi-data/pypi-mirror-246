...
'''
	python3 insurance.py shows/ingredient_scan_recipe/formulate/status_supp/status_1.py
'''
...
def check_1 ():
	...
	recipe = formulate_recipe.adroitly ([
		[ supp_1 ["essential nutrients"], supp_1_multiplier ],
		[ supp_2 ["essential nutrients"], supp_2_multiplier ]
	])
