...
'''
	python3 insurance.py shows/ingredient_scan/recipe/formulate/status_food/status_3.py
'''
...
import apoplast.shows.ingredient_scan_recipe.formulate.assertions.ingredient as ingredient_assertion
...
def check_1 ():
	...
	botany.show ("grove measures:", recipe ["measures"])
	botany.show ("protein:", protein)
