...
class AivProjectAPI(object):
    ...
    def current_project_id(self):
        self.__cur_proj_item = self.__proj_rec.current_project_item  # local record - chosen project
        project_items = self.get_project_items()  # remote record - project lists
        ids = [pi.project_id for pi in project_items]
        pid = self.__cur_proj_item.project_id
        # check validation
        ...
        self.__proj_rec.current_project_item = self.__cur_proj_item
