...
class KnotJacobian():
    ...
    def knotVelEndVel(self, arg0: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> None:
        pass
    @property
    def torquesEndPos(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, n]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]
        """
    @torquesEndPos.setter
    def torquesEndPos(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> None:
        pass
    @property
    def torquesEndVel(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, n]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]
        """
    @torquesEndVel.setter
    def torquesEndVel(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> None:
        pass
    pass
class LossGradient():
    def __init__(self) -> None: ...
...
class MappedBackpropSnapshot():
    def backprop(self, world: nimblephysics_libs._nimblephysics.simulation.World, thisTimestepLoss: LossGradient, nextTimestepLosses: dict[str, LossGradient], perfLog: nimblephysics_libs._nimblephysics.performance.PerformanceLog = None, exploreAlternateStrategies: bool = False) -> None: ...
...
class WrtMassBodyNodyEntry():
    ...
    def type(self, arg0: WrtMassBodyNodeEntryType) -> None:
        pass
    pass
def convertJointSpaceToWorldSpace(world: nimblephysics_libs._nimblephysics.simulation.World, jointSpace: numpy.ndarray[numpy.float64, _Shape[m, n]], nodes: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode], space: ConvertToSpace, backprop: bool = False, useIK: bool = True) -> numpy.ndarray[numpy.float64, _Shape[m, n]]:
    """
...
def forwardPass(world: nimblephysics_libs._nimblephysics.simulation.World, idempotent: bool = False) -> BackpropSnapshot:
    pass
def mappedForwardPass(world: nimblephysics_libs._nimblephysics.simulation.World, mappings: dict[str, Mapping], idempotent: bool = False) -> MappedBackpropSnapshot:
    pass
COM: nimblephysics_libs._nimblephysics.neural.WrtMassBodyNodeEntryType # value = <WrtMassBodyNodeEntryType.COM: 1>
COM_POS: nimblephysics_libs._nimblephysics.neural.ConvertToSpace # value = <ConvertToSpace.COM_POS: 4>
COM_VEL_LINEAR: nimblephysics_libs._nimblephysics.neural.ConvertToSpace # value = <ConvertToSpace.COM_VEL_LINEAR: 6>
