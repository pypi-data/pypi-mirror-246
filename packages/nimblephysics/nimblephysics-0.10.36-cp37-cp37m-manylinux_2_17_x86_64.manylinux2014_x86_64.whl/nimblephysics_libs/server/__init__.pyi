...
class GUIStateMachine():
    ...
    def createLine(self, key: str, points: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]], color: numpy.ndarray[numpy.float64, _Shape[4, 1]] = array([0.5, 0.5, 0.5, 1. ]), layer: str = '', width: list[float] = []) -> None: ...
    ...
    def createPlot(self, key: str, fromTopLeft: numpy.ndarray[numpy.int32, _Shape[2, 1]], size: numpy.ndarray[numpy.int32, _Shape[2, 1]], xs: list[float], minX: float, maxX: float, ys: list[float], minY: float, maxY: float, plotType: str, layer: str = '') -> None: ...
