...
class GraphFlowDiscretizer():
    ...
    def cleanUpArcRates(self, energyLevels: numpy.ndarray[numpy.float64, _Shape[m, n]], arcRates: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> numpy.ndarray[numpy.float64, _Shape[m, n]]: 
        ...
        """
    def discretize(self, maxSimultaneousParticles: int, energyLevels: numpy.ndarray[numpy.float64, _Shape[m, n]], arcRates: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> list[ParticlePath]: 
        """
...
class MultivariateGaussian():
    def __init__(self, variables: list[str], mu: numpy.ndarray[numpy.float64, _Shape[m, 1]], cov: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> None: ...
    ...
    def convertFromMap(self, values: dict[str, float]) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    def convertToMap(self, values: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> dict[str, float]: ...
    def debugToStdout(self) -> None: ...
    def getCov(self) -> numpy.ndarray[numpy.float64, _Shape[m, n]]: ...
    def getCovSubset(self, rowIndices: list[int], colIndices: list[int]) -> numpy.ndarray[numpy.float64, _Shape[m, n]]: ...
    ...
    def getMuSubset(self, indices: list[int]) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
