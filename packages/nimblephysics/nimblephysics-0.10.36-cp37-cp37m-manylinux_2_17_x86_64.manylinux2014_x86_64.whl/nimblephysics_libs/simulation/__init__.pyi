...
class World():
    ...
    def removeAllSimpleFrames(self) -> set[nimblephysics_libs._nimblephysics.dynamics.SimpleFrame]: ...
    def removeAllSkeletons(self) -> set[nimblephysics_libs._nimblephysics.dynamics.Skeleton]: ...
