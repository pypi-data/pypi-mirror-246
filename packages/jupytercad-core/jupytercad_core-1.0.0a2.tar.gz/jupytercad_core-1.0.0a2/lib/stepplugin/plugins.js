...
import { IJCadWorkerRegistryToken, IJupyterCadDocTracker, JupyterCadStepDoc } from '@jupytercad/schema';
import { IThemeManager } from '@jupyterlab/apputils';
import { JupyterCadStepModelFactory } from './modelfactory';
import { JupyterCadWidgetFactory } from '../factory';
const FACTORY = 'JupyterCAD STEP Viewer';
const activate = (app, tracker, themeManager, drive, workerRegistry) => {
