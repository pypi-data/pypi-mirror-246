...
class NetworksApi(object):
    ...
    def create_network(self, project_id, body, **kwargs):  # noqa: E501
        """Create network  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_network(project_id, body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_network_with_http_info(project_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_network_with_http_info(project_id, body, **kwargs)  # noqa: E501
            return data

    def create_network_with_http_info(self, project_id, body, **kwargs):  # noqa: E501
        """Create network  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_network_with_http_info(project_id, body, async_req=True)
        >>> result = thread.get()
