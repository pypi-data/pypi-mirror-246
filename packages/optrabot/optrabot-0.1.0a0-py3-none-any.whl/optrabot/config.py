...
def ensureInitialConfig() -> bool:
	...
	try:
		...
		confTradingMinimumPremium = inquirer.number(message="Mininum premium for an Iron Fly trade ($):",default=14, float_allowed=True, validate=EmptyInputValidator()).execute()
