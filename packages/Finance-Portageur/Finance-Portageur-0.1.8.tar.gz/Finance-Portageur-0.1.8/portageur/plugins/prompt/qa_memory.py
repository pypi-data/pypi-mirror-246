...
"""
    ...
    def output_parser_format_instruction(cls):
        ...
        **Option #2:**
        Use this if you want to respond directly to the human. Please refer the companies only by NAMES in your outputs. Markdown code snippet formatted in the following schema:
        
        ```json
        {{{{
            "action": "Final Answer",
            "chat_title": string, \\ A short title for the entire chat history, should be under 10 words
            "suggestions": List[string], \\ up to three suggested follow-up questions the user most likely wants to ask
