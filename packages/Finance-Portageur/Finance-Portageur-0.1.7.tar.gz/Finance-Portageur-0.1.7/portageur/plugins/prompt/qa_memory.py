...
"""
    ...
    def output_parser_format_instruction(cls):
        ...
        **Option #2:**
        Use this if you want to respond directly to the human. Please refer the companies only by names in "action_input". Markdown code snippet formatted in the following schema:
