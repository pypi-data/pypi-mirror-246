...
class PyVisWrapper:
    def __init__(self, notebook_mode: bool = False):
        ...
        self.relatie_color_dict = {
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Voedt': 'cd4d3f',
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Bevestiging': '000000',
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Sturing': '1a6e16',
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HoortBij': '9f6444',
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#VoedtAangestuurd': '982f68',
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#LigtOp': '45b94c',
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#SluitAanOp': '3485de',
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#IsInspectieVan': '93c3cf',
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HeeftBetrokkene': 'd09e3d',
            'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#HeeftAanvullendeGeometrie': '7615a0',
        }
        self.list_of_colors = (
