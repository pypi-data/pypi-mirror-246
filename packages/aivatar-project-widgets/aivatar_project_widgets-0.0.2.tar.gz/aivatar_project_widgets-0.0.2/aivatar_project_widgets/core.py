...
class AivProjectWindow(QtWidgets.QMainWindow):
    ...
    def __init_widgets(self, business_type):
        ...
        "QComboBox {font-size: 18px; font-family: \'Microsoft YaHei\'; color: #ccc; background-color: #2f2f2f; border-radius: 3px;}" \
        ...
        "QComboBox QAbstractItemView { color:#ccc; background-color: #2f2f2f; selection-background-color: #599cc9;}" \
        ...
        self.item_icon = QIcon(os.path.join(MODULE_PATH, "icons/project-0-50.png"))
