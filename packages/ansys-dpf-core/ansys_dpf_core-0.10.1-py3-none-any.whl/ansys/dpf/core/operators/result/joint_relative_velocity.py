...
class joint_relative_velocity(Operator):
    """Read/compute joint relative velocity by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute joint relative velocity by calling the readers defined by
            the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsJointRelativeVelocity
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsJointRelativeVelocity
        """
