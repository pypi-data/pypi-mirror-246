...
class mean_temperature(Operator):
    """Read Mean Temperature by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Mean Temperature by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsMeanTemperature
        """
