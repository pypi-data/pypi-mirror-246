...
class part_internal_energy(Operator):
    """Read Part Internal Energy (LSDyna) by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Part Internal Energy (LSDyna) by calling the readers defined by
            the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsPartInternalEnergy
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsPartInternalEnergy
        """
