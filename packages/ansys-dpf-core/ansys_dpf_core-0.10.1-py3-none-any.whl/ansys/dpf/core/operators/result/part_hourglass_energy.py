...
class part_hourglass_energy(Operator):
    """Read Part Hourglass Energy (LSDyna) by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Part Hourglass Energy (LSDyna) by calling the readers defined by
            the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsPartHourglassEnergy
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsPartHourglassEnergy
        """
