...
class wall_shear_stress(Operator):
    """Read Wall Shear Stress by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Wall Shear Stress by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsWallShearStress
        """
