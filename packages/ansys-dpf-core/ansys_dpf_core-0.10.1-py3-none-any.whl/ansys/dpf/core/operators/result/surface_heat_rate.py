...
class surface_heat_rate(Operator):
    """Read Surface Heat Rate by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Surface Heat Rate by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsSurfaceHeatRate
        """
