...
class part_rigid_body_velocity(Operator):
    """Read Part Rigid Body Velocity (LSDyna) by calling the readers defined
    by the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Part Rigid Body Velocity (LSDyna) by calling the readers defined
            by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsPartRigidBodyVelocity
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsPartRigidBodyVelocity
        """
