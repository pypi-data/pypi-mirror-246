...
class thermal_dissipation_energy(Operator):
    """Read/compute thermal dissipation energy by calling the readers defined
    by the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute thermal dissipation energy by calling the readers defined
            by the datasources."""
        spec = Specification(
