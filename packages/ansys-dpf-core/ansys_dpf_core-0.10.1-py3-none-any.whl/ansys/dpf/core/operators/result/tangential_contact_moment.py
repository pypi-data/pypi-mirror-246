...
class tangential_contact_moment(Operator):
    """Read/compute tangential contact moment by calling the readers defined
    by the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute tangential contact moment by calling the readers defined
            by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsTangentialContactMoment
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsTangentialContactMoment
        """
