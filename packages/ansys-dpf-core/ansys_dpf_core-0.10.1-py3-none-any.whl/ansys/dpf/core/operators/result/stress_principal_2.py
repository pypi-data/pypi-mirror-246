...
class stress_principal_2(Operator):
    """Read/compute element nodal component stresses 2nd principal component
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal component stresses 2nd principal component
