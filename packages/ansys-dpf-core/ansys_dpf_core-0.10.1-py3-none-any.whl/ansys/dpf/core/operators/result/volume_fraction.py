...
class volume_fraction(Operator):
    """Read Volume Fraction by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Volume Fraction by calling the readers defined by the
            datasources."""
        spec = Specification(
