...
class thermal_strain_Z(Operator):
    """Read/compute element nodal component thermal strains ZZ normal
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal component thermal strains ZZ normal
