...
class joint_relative_rotation(Operator):
    """Read/compute joint relative rotation by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute joint relative rotation by calling the readers defined by
            the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsJointRelativeRotation
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsJointRelativeRotation
        """
