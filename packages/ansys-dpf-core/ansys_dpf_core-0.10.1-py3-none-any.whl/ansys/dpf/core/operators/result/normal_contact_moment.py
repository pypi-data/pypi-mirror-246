...
class normal_contact_moment(Operator):
    """Read/compute normal contact moment by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute normal contact moment by calling the readers defined by
            the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsNormalContactMoment
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsNormalContactMoment
        """
