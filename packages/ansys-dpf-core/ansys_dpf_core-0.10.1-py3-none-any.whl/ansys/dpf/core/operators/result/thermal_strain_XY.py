...
class thermal_strain_XY(Operator):
    """Read/compute element nodal component thermal strains XY shear
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal component thermal strains XY shear
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsThermalStrainXy
        """
