...
class part_kinetic_energy(Operator):
    """Read Part Kinetic Energy (LSDyna) by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Part Kinetic Energy (LSDyna) by calling the readers defined by
            the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsPartKineticEnergy
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsPartKineticEnergy
        """
