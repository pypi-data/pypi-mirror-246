...
class raw_displacement(Operator):
    """Read/compute U vector from the finite element problem KU=F by calling
    ...
    @staticmethod
    def _spec():
        description = """Read/compute U vector from the finite element problem KU=F by calling
            the readers defined by the datasources."""
        spec = Specification(
