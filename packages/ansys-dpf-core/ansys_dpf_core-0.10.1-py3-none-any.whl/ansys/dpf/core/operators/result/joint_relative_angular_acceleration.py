...
class joint_relative_angular_acceleration(Operator):
    """Read/compute joint relative angular acceleration by calling the
    ...
    @staticmethod
    def _spec():
        description = """Read/compute joint relative angular acceleration by calling the
            readers defined by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsJointRelativeAngularAcceleration
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsJointRelativeAngularAcceleration
        """
