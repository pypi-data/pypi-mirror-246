...
class pressure(Operator):
    """Read/compute Pressure by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute Pressure by calling the readers defined by the
            datasources."""
        spec = Specification(
