...
class turbulent_viscosity(Operator):
    """Read Turbulent Viscosity by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Turbulent Viscosity by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsTurbulentViscosity
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsTurbulentViscosity
        """
