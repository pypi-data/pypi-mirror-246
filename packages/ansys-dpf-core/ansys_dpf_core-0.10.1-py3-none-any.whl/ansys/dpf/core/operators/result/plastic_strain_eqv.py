...
class plastic_strain_eqv(Operator):
    """Read/compute element nodal equivalent plastic strain by calling the
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal equivalent plastic strain by calling the
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsPlasticStrainEqv
        """
