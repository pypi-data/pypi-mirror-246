...
class stress_ratio(Operator):
    """Read/compute element nodal stress ratio by calling the readers defined
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal stress ratio by calling the readers defined
