...
class initial_coordinates(Operator):
    """Read/compute Initial Coordinates (LSDyna) by calling the readers
    ...
    @staticmethod
    def _spec():
        description = """Read/compute Initial Coordinates (LSDyna) by calling the readers
            defined by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsInitialCoordinates
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsInitialCoordinates
        """
