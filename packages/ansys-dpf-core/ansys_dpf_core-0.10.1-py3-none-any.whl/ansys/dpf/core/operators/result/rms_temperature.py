...
class rms_temperature(Operator):
    """Read RMS Temperature by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read RMS Temperature by calling the readers defined by the
            datasources."""
        spec = Specification(
