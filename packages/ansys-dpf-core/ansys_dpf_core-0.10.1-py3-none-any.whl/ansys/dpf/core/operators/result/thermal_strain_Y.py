...
class thermal_strain_Y(Operator):
    """Read/compute element nodal component thermal strains YY normal
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal component thermal strains YY normal
