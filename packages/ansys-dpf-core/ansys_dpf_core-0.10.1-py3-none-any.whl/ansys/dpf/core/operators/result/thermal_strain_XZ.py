...
class thermal_strain_XZ(Operator):
    """Read/compute element nodal component thermal strains XZ shear
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal component thermal strains XZ shear
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsThermalStrainXz
        """
