...
class thermal_strain_YZ(Operator):
    """Read/compute element nodal component thermal strains YZ shear
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal component thermal strains YZ shear
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsThermalStrainYz
        """
