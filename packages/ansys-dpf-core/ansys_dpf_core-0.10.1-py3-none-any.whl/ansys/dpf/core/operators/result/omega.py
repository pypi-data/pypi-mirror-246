...
class omega(Operator):
    """Read Turbulent Specific Dissipation Rate (omega) by calling the
    ...
    @staticmethod
    def _spec():
        description = """Read Turbulent Specific Dissipation Rate (omega) by calling the
            readers defined by the datasources."""
        spec = Specification(
