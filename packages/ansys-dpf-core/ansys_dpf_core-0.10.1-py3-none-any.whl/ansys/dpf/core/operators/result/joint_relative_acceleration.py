...
class joint_relative_acceleration(Operator):
    """Read/compute joint relative acceleration by calling the readers
    ...
    @staticmethod
    def _spec():
        description = """Read/compute joint relative acceleration by calling the readers
            defined by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsJointRelativeAcceleration
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsJointRelativeAcceleration
        """
