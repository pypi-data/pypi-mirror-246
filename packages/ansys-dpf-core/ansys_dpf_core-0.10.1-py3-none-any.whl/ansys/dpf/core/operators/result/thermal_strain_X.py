...
class thermal_strain_X(Operator):
    """Read/compute element nodal component thermal strains XX normal
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal component thermal strains XX normal
