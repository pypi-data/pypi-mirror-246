...
class stress_principal_1(Operator):
    """Read/compute element nodal component stresses 1st principal component
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal component stresses 1st principal component
