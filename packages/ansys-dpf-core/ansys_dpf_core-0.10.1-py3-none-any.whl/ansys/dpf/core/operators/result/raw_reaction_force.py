...
class raw_reaction_force(Operator):
    """Read/compute F vector from the finite element problem KU=F by calling
    ...
    @staticmethod
    def _spec():
        description = """Read/compute F vector from the finite element problem KU=F by calling
            the readers defined by the datasources."""
        spec = Specification(
