...
class joint_relative_displacement(Operator):
    """Read/compute joint relative displacement by calling the readers
    ...
    @staticmethod
    def _spec():
        description = """Read/compute joint relative displacement by calling the readers
            defined by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsJointRelativeDisplacement
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsJointRelativeDisplacement
        """
