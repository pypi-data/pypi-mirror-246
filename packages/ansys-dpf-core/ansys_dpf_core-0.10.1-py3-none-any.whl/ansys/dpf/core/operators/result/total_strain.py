...
class total_strain(Operator):
    """Read/compute Total strain (LSDyna) by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute Total strain (LSDyna) by calling the readers defined by
            the datasources."""
        spec = Specification(
