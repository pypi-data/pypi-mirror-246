...
class tangential_contact_force(Operator):
    """Read/compute tangential contact force by calling the readers defined
    by the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute tangential contact force by calling the readers defined
            by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsTangentialContactForce
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsTangentialContactForce
        """
