...
class superficial_velocity(Operator):
    """Read Superficial Velocity by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Superficial Velocity by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsSuperficialVelocity
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsSuperficialVelocity
        """
