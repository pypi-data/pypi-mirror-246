...
class mean_static_pressure(Operator):
    """Read Mean Static Pressure by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Mean Static Pressure by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsMeanStaticPressure
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsMeanStaticPressure
        """
