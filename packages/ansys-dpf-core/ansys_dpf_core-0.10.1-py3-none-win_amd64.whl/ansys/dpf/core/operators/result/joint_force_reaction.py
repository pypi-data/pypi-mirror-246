...
class joint_force_reaction(Operator):
    """Read/compute joint force reaction by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute joint force reaction by calling the readers defined by
            the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsJointForceReaction
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsJointForceReaction
        """
