...
class static_pressure(Operator):
    """Read Static Pressure by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Static Pressure by calling the readers defined by the
            datasources."""
        spec = Specification(
