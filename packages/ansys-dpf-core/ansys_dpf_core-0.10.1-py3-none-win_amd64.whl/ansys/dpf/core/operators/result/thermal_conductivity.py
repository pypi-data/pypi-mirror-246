...
class thermal_conductivity(Operator):
    """Read Thermal Conductivity by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Thermal Conductivity by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsThermalConductivity
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsThermalConductivity
        """
