...
class part_momentum(Operator):
    """Read Part Momentum (LSDyna) by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Part Momentum (LSDyna) by calling the readers defined by the
            datasources."""
        spec = Specification(
