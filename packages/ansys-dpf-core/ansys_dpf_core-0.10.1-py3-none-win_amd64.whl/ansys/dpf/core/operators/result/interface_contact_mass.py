...
class interface_contact_mass(Operator):
    """Read Interface Contact Mass (LSDyna) by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Interface Contact Mass (LSDyna) by calling the readers defined by
            the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsInterfaceContactMass
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsInterfaceContactMass
        """
