...
class interface_contact_force(Operator):
    """Read Interface Contact Force (LSDyna) by calling the readers defined
    by the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Interface Contact Force (LSDyna) by calling the readers defined
            by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsInterfaceContactForce
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsInterfaceContactForce
        """
