...
class hydrostatic_pressure(Operator):
    """Read/compute element nodal hydrostatic pressure by calling the readers
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal hydrostatic pressure by calling the readers
