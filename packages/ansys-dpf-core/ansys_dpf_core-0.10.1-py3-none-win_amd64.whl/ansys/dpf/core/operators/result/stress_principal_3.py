...
class stress_principal_3(Operator):
    """Read/compute element nodal component stresses 3rd principal component
    by calling the readers defined by the datasources and computing
    its eigen values.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute element nodal component stresses 3rd principal component
            by calling the readers defined by the datasources and
