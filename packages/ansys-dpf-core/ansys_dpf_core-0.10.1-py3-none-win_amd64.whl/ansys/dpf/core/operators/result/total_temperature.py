...
class total_temperature(Operator):
    """Read Total Temperature by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Total Temperature by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsTotalTemperature
        """
