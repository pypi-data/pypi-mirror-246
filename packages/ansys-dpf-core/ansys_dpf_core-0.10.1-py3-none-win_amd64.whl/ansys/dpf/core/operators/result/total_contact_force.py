...
class total_contact_force(Operator):
    """Read/compute total contact force by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute total contact force by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsTotalContactForce
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsTotalContactForce
        """
