...
class global_external_work(Operator):
    """Read Global External Work (LSDyna) by calling the readers defined by
    the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read Global External Work (LSDyna) by calling the readers defined by
            the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsGlobalExternalWork
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsGlobalExternalWork
        """
