...
class joint_relative_angular_velocity(Operator):
    """Read/compute joint relative angular velocity by calling the readers
    ...
    @staticmethod
    def _spec():
        description = """Read/compute joint relative angular velocity by calling the readers
            defined by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsJointRelativeAngularVelocity
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsJointRelativeAngularVelocity
        """
