...
class rms_static_pressure(Operator):
    """Read RMS Static Pressure by calling the readers defined by the
    datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read RMS Static Pressure by calling the readers defined by the
            datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsRmsStaticPressure
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsRmsStaticPressure
        """
