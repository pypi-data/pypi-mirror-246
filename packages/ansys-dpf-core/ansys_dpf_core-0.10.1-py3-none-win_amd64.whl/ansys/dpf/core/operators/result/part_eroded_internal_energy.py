...
class part_eroded_internal_energy(Operator):
    """Read Part Eroded Internal Energy (LSDyna) by calling the readers
    ...
    @staticmethod
    def _spec():
        description = """Read Part Eroded Internal Energy (LSDyna) by calling the readers
            defined by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsPartErodedInternalEnergy
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsPartErodedInternalEnergy
        """
