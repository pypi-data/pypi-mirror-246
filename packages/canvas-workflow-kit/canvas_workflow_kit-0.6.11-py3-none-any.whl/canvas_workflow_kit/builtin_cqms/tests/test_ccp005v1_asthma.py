...
class TestCcp005v1(SDKBaseTest):
    ...
    def test_description(self):
        ...
        self.assertEqual(expected, Ccp005v1._meta.description)

    def test_information(self):
        expected = 'https://canvas-medical.zendesk.com/hc/en-us'
        self.assertEqual(expected, Ccp005v1._meta.information)

    def test_change_types(self):
        result = Ccp005v1._meta.compute_on_change_types
        expected = ['condition']
        self.assertEqual(expected, result)

    def test_version(self):
        self.assertTrue(hasattr(Ccp005v1._meta, 'version'))
    ...
    @patch(
        'canvas_workflow_kit.builtin_cqms.ccp005v1_asthma.Ccp005v1.date_of_diagnosis',
        new_callable=PropertyMock)
    @patch('canvas_workflow_kit.builtin_cqms.ccp005v1_asthma.Ccp005v1.in_numerator')
    @patch('canvas_workflow_kit.builtin_cqms.ccp005v1_asthma.Ccp005v1.in_denominator')
