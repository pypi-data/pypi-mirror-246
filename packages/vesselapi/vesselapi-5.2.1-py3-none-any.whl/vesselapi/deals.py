...
class Deals:
    ...
    def create(self, request: Optional[operations.PostCrmDealRequestBody]) -> operations.PostCrmDealResponse:
        r"""Create Deal
        Create a new Deal
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, Optional[operations.PostCrmDealRequestBody], "request", False, True, 'json')
    ...
    def search(self, request: operations.SearchCrmDealsRequest) -> operations.SearchCrmDealsResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, operations.SearchCrmDealsRequest, "request_body", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
    ...
    def update(self, request: Optional[operations.PutCrmDealRequestBody]) -> operations.PutCrmDealResponse:
        r"""Update Deal
        ...
        url = base_url + '/crm/deal'
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, Optional[operations.PutCrmDealRequestBody], "request", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
