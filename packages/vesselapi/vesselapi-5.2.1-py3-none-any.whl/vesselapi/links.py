...
class Links:
    ...
    def create(self, request: Optional[operations.PostLinkExchangeRequestBody], security: operations.PostLinkExchangeSecurity) -> operations.PostLinkExchangeResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, Optional[operations.PostLinkExchangeRequestBody], "request", False, True, 'json')
