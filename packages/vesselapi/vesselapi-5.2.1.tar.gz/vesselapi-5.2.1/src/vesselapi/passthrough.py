...
class Passthrough:
    ...
    def create(self, request: Optional[operations.PostCrmPassthroughRequestBody]) -> operations.PostCrmPassthroughResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, Optional[operations.PostCrmPassthroughRequestBody], "request", False, True, 'json')
