...
class UserPublicKeys(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Name of the user. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.79.1/docs/resources/user_public_keys#name UserPublicKeys#name}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing UserPublicKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.79.1/docs/resources/user_public_keys#import import section} in the documentation of this resource for the id to use
