...
class ScimIntegration(
    ...
    def __init__(
        ...
        *,
        ...
        :param scim_client: Specifies the client type for the scim integration. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.79.1/docs/resources/scim_integration#scim_client ScimIntegration#scim_client}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ScimIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.79.1/docs/resources/scim_integration#import import section} in the documentation of this resource for the id to use
