...
from ararpy.smp import samples
import ararpy as ap
...
class WritingWorkbook:
    ...
    def get_xls(self):
        ...
        spectra_set1_data = ap.calc.arr.transpose(self.sample.AgeSpectraPlot.set1.data) or [[]] * 3
        spectra_set2_data = ap.calc.arr.transpose(self.sample.AgeSpectraPlot.set2.data) or [[]] * 3
        ...
        set_data = [set1_data, set2_data, set3_data] = ap.calc.isochron.get_set_data(
        ...
        for row_index, figure in enumerate(['figure_2', 'figure_3', 'figure_4', 'figure_5', 'figure_6']):
            for col_index, set in enumerate(['set1', 'set2']):
                try:
                    _isochron_results = getattr(ap.smp.basic.get_component_byid(self.sample, figure), set)
                    _name = \
        ...
        for sht_name, [prop_name, sht_type, row, col, _, smp_attr_name, header_name] in self.template.sheet():
            if sht_type == "table":
                data = ap.calc.arr.transpose(getattr(self.sample, smp_attr_name, None).data)
                ...
                if "spectra" in prop_name.lower():
                    ...
                    axis_range = [
                        ap.smp.basic.get_component_byid(self.sample, 'figure_2').xaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_2').xaxis.max,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_2').yaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_2').yaxis.max,
                    ]
                    ...
                    axis_range = [
                        ap.smp.basic.get_component_byid(self.sample, 'figure_3').xaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_3').xaxis.max,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_3').yaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_3').yaxis.max,
                    ]
                    self.get_chart_isochron(xls, sht, data_area, axis_range,
                    ...
                    axis_range = [
                        ap.smp.basic.get_component_byid(self.sample, 'figure_4').xaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_4').xaxis.max,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_4').yaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_4').yaxis.max,
                    ]
                    self.get_chart_isochron(xls, sht, data_area, axis_range,
                    ...
                    axis_range = [
                        ap.smp.basic.get_component_byid(self.sample, 'figure_5').xaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_5').xaxis.max,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_5').yaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_5').yaxis.max,
                    ]
                    self.get_chart_isochron(xls, sht, data_area, axis_range,
                    ...
                    axis_range = [
                        ap.smp.basic.get_component_byid(self.sample, 'figure_6').xaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_6').xaxis.max,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_6').yaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_6').yaxis.max,
                    ]
                    self.get_chart_isochron(xls, sht, data_area, axis_range,
                    ...
                    axis_range = [
                        ap.smp.basic.get_component_byid(self.sample, 'figure_8').xaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_8').xaxis.max,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_8').yaxis.min,
                        ap.smp.basic.get_component_byid(self.sample, 'figure_8').yaxis.max,
                    ]
...
class CreateOriginGraph:
    ...
    def get_graphs(self):
        ...
        for index, each_col in enumerate(ap.calc.arr.transpose(
                [ap.calc.arr.transpose(self.isochron_data)[i] for i in self.sample.SelectedSequence1])):
            isochron_set1_ws.from_list(index, each_col)  # Normal, invers, K-Cl-Ar 1, K-Cl-Ar 2, K-Cl-Ar 3, 3D
        for index, each_col in enumerate(ap.calc.arr.transpose(
                [ap.calc.arr.transpose(self.isochron_data)[i] for i in self.sample.SelectedSequence2])):
            isochron_set2_ws.from_list(index, each_col)  # Normal, invers, K-Cl-Ar 1, K-Cl-Ar 2, K-Cl-Ar 3, 3D
        for index, each_col in enumerate(ap.calc.arr.transpose(
                [ap.calc.arr.transpose(self.isochron_data)[i] for i in self.sample.UnselectedSequence])):
...
class CreatePDF:
    ...
    def set_main_content(self):
        ...
        if self.figure.type == 'isochron':
            ...
            if not ap.calc.arr.is_empty(self.figure.line1.info):
                content += self._get_isochron_line(*self.figure.line1.data, width=1, color='1 0 0')
            if not ap.calc.arr.is_empty(self.figure.line2.info):
                content += self._get_isochron_line(*self.figure.line2.data, width=1, color='0 0 1')
            for point in ap.calc.arr.transpose(self.figure.data):
