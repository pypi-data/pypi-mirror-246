...
PermissionPaginatorTypeDef = TypedDict(
    "PermissionPaginatorTypeDef",
    {
...
PipelineOutputConfigPaginatorTypeDef = TypedDict(
    "PipelineOutputConfigPaginatorTypeDef",
    {
        "Bucket": NotRequired[str],
        "StorageClass": NotRequired[str],
        "Permissions": NotRequired[List[PermissionPaginatorTypeDef]],
    },
)
...
VideoParametersPaginatorTypeDef = TypedDict(
    "VideoParametersPaginatorTypeDef",
    {
        "Codec": NotRequired[str],
...
JobAlbumArtPaginatorTypeDef = TypedDict(
    "JobAlbumArtPaginatorTypeDef",
    {
...
CaptionsPaginatorTypeDef = TypedDict(
    "CaptionsPaginatorTypeDef",
    {
        "MergePolicy": NotRequired[str],
...
InputCaptionsPaginatorTypeDef = TypedDict(
    "InputCaptionsPaginatorTypeDef",
    {
        "MergePolicy": NotRequired[str],
        "CaptionSources": NotRequired[List[CaptionSourceTypeDef]],
...
PipelinePaginatorTypeDef = TypedDict(
    "PipelinePaginatorTypeDef",
    {
        "Id": NotRequired[str],
        "Arn": NotRequired[str],
        ...
        "ContentConfig": NotRequired[PipelineOutputConfigPaginatorTypeDef],
        "ThumbnailConfig": NotRequired[PipelineOutputConfigPaginatorTypeDef],
    },
)
...
PresetPaginatorTypeDef = TypedDict(
    "PresetPaginatorTypeDef",
    {
        ...
        "Video": NotRequired[VideoParametersPaginatorTypeDef],
...
JobOutputPaginatorTypeDef = TypedDict(
    "JobOutputPaginatorTypeDef",
    {
        "Id": NotRequired[str],
        "Key": NotRequired[str],
        ...
        "AlbumArt": NotRequired[JobAlbumArtPaginatorTypeDef],
        "Composition": NotRequired[List[ClipTypeDef]],
        "Captions": NotRequired[CaptionsPaginatorTypeDef],
        "Encryption": NotRequired[EncryptionTypeDef],
...
JobInputPaginatorTypeDef = TypedDict(
    "JobInputPaginatorTypeDef",
    {
        "Key": NotRequired[str],
        "FrameRate": NotRequired[str],
        ...
        "Encryption": NotRequired[EncryptionTypeDef],
        "TimeSpan": NotRequired[TimeSpanTypeDef],
        "InputCaptions": NotRequired[InputCaptionsPaginatorTypeDef],
...
ListPipelinesResponsePaginatorTypeDef = TypedDict(
    "ListPipelinesResponsePaginatorTypeDef",
    {
        "Pipelines": List[PipelinePaginatorTypeDef],
        "NextPageToken": str,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
...
JobPaginatorTypeDef = TypedDict(
    "JobPaginatorTypeDef",
    {
        ...
        "Input": NotRequired[JobInputPaginatorTypeDef],
        "Inputs": NotRequired[List[JobInputPaginatorTypeDef]],
        "Output": NotRequired[JobOutputPaginatorTypeDef],
        "Outputs": NotRequired[List[JobOutputPaginatorTypeDef]],
...
ListJobsByPipelineResponsePaginatorTypeDef = TypedDict(
    "ListJobsByPipelineResponsePaginatorTypeDef",
    {
...
ListJobsByStatusResponsePaginatorTypeDef = TypedDict(
    "ListJobsByStatusResponsePaginatorTypeDef",
    {
        "Jobs": List[JobPaginatorTypeDef],
        "NextPageToken": str,
