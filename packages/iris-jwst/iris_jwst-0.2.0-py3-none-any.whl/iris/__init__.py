...
from iris import moldata.setup_catalog as setup_catalog
import numpy as np
...
class slab:
    ...
    """
    def __init__(self, molecules, wlow, whigh):
        
        if not os.path.isdir('./HITRAN'):
            os.mkdir('./HITRAN')
            print('Downloading molecular data (first time running iris)')
            os.system('python ./Create_ir_model_files.py')
        
        path_to_hitran='./HITRAN'
