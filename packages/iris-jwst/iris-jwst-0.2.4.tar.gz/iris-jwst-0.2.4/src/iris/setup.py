...
#Code adapted from Nathan Hagen
...
def setup_linelists():
    ...
    mols = ["H2O", "CO2", "CO", "CH4", "SO2", "NH3", "OH", "H2CO", "N2", "HCN", "C2H2", "HCOOH", "HO2",
            "C2H4", "CH3OH", "CH3CN", "C4H2", "HC3N", "H2", "CS", "SO3"]
    basem = mols
    isot = [1 for m in mols]

    min_wave = 0.1 # micron
    max_wave = 30.0 # micron
    ...
    for mol, bm, iso in zip(mols, basem, isot):
        ...
        fh = open("./HITRAN/data_Hitran_2020_{:}.par".format(mol), 'w')
