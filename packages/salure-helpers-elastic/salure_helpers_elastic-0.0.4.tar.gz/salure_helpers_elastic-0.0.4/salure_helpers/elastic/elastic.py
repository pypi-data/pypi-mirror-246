...
class Elastic:
    ...
    def log_line(self, information: dict) -> requests.Response:
        ...
        self.create_data_view(space_name=self.space_name, view_name=f'logged_lines_{self.client_user}', name=f'Logged lines {self.client_user}', time_field='started_at')
    ...
    def log_error(self, information: dict) -> requests.Response:
        ...
        # creates the data view for the space and index if it does not exist yet
        self.create_data_view(space_name=self.space_name, view_name=f'logged_errors_{self.client_user}', name=f'Logged errors {self.client_user}', time_field='started_at')
