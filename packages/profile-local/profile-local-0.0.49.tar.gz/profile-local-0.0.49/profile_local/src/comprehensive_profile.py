    ...
    def insert(profile_json: str, lang_code: LangCode) -> int:
        ...
        if 'profile_metrics' in data:
            ...
            profile_metrics_data: Dict[str, any] = {
                'profile_id': profile_metrics_entry.get('profile_id'),
            ...
            profile_metrics_id = profile_metrics_obj.insert(
                profile_metrics_data)
            # profile_metrics_id = profile_metrics_obj.insert_profile_metrics(profile_id=profile_metrics_data['profile_id'],
            #                                                 profile_metrics_type=profile_metrics_data['profile_metrics_type'], value=profile_metrics_data['value'])
