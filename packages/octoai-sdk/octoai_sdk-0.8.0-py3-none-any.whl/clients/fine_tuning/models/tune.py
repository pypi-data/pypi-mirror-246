...
class Tune(BaseModel):
    """
    A tune base class.  # noqa: E501
    """
    created_at: datetime = Field(..., description="The time this LoRA tune was created.")
    ...
    output_lora_ids: conlist(StrictStr) = Field(..., description="The output LoRA IDs, if the task was successful.")
    status: TuneStatus = Field(...)
    ...
    tune_type: StrictStr = Field(..., description="The type of tune requested.")
    updated_at: datetime = Field(..., description="The time this LoRA tune was updated.")
    __properties = ["created_at", "deleted_at", "description", "details", "id", "name", "output_lora_ids", "status", "status_details", "succeeded_at", "tenant_id", "tune_type", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Tune:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.succeeded_at is None and "succeeded_at" in self.__fields_set__:
            _dict['succeeded_at'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> Tune:
        """Create an instance of Tune from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Tune.parse_obj(obj)
