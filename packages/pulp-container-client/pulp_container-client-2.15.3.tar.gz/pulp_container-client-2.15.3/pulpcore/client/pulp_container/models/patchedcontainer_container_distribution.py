...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, hidden=False, repository=None, base_path=None, content_guard=None, pulp_labels=None, name=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
