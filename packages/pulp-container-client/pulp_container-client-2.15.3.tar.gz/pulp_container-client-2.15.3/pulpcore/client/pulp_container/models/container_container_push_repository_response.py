...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, manifest_signing_service=None, description=None, pulp_href=None, versions_href=None, retain_repo_versions=None, pulp_labels=None, pulp_created=None, latest_version_href=None, name=None, local_vars_configuration=None):  # noqa: E501
