...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, manifest_signing_service=None, versions_href=None, description=None, latest_version_href=None, pulp_href=None, retain_repo_versions=None, pulp_created=None, name=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
