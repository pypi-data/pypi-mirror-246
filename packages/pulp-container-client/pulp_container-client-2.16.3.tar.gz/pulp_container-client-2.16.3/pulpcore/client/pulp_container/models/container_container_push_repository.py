...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, manifest_signing_service=None, description=None, retain_repo_versions=None, name=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
