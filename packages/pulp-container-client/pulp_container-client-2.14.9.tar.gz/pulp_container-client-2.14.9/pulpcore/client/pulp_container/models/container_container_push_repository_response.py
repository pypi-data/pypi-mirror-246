...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, manifest_signing_service=None, versions_href=None, pulp_created=None, latest_version_href=None, retain_repo_versions=None, name=None, pulp_labels=None, description=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
