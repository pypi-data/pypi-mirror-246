...
class MyScrollableWindow(wx.ScrolledWindow):
    ...
    def __do_layout(self):
        ...
        # テキストボックス
        self.sizer.Add(self.txtCtrl, flag=wx.ALIGN_LEFT | wx.ALL, border=5)
        # word, transボタン
        self.sizer_btn.Add(self.btn_word, flag=wx.ALIGN_LEFT | wx.TOP, border=5)
        self.sizer_btn.Add(self.btn_trans, flag=wx.ALIGN_LEFT | wx.TOP, border=5)
        # テキストボックスとボタンを結合
        self.sizer.Add(self.sizer_btn, flag=wx.ALIGN_LEFT | wx.ALL, border=0)
...
class SampleFrame(wx.Frame):
    def __init__(self, parent, ID, title):
        wx.Frame.__init__(self, parent, title=title, pos=(0, 0), size=(720, 480))
