...
from Testinventory_class import TestInventory
from Testinventory_rollback import Testrollback
from Testaccount_promotion import Testpromotion
from Testaccount_promotion1 import Testpromotion1
from test_members import Testmembers
