...
import src.customer.members
# import administer.account
# from administer.account import promotion
from src.customer.members import member
from src.customer.transactions import transaction
# from administer import account
from src.administer.account import promotion
from src.administer.account import eliminate

import importlib
# importlib.reload(account)
importlib.reload(src.customer.members)
