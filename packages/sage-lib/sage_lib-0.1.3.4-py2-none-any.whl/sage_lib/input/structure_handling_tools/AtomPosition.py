try:
    from sage_lib.input.structure_handling_tools.PeriodicSystem import PeriodicSystem
except ImportError as e:
    import sys
    sys.stderr.write(f"An error occurred while importing sage_lib.input.structure_handling_tools.PeriodicSystem: {str(e)}\n")
    del sys

try:
    from sage_lib.input.structure_handling_tools.NonPeriodicSystem import NonPeriodicSystem
except ImportError as e:
    import sys
    sys.stderr.write(f"An error occurred while importing sage_lib.input.structure_handling_tools.NonPeriodicSystem: {str(e)}\n")
    del sys
...
class AtomPosition(PeriodicSystem, NonPeriodicSystem):
