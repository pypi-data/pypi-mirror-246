...
Usage::
    ...
    ```python
    from mypy_boto3_efs.type_defs import PosixUserPaginatorTypeDef

    data: PosixUserPaginatorTypeDef = ...
    ```
"""
...
PosixUserPaginatorTypeDef = TypedDict(
    "PosixUserPaginatorTypeDef",
    {
        "Uid": int,
        "Gid": int,
...
AccessPointDescriptionPaginatorTypeDef = TypedDict(
    "AccessPointDescriptionPaginatorTypeDef",
    {
        ...
        "FileSystemId": NotRequired[str],
        "PosixUser": NotRequired[PosixUserPaginatorTypeDef],
...
DescribeAccessPointsResponsePaginatorTypeDef = TypedDict(
    "DescribeAccessPointsResponsePaginatorTypeDef",
    {
        "AccessPoints": List[AccessPointDescriptionPaginatorTypeDef],
        "NextToken": str,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
