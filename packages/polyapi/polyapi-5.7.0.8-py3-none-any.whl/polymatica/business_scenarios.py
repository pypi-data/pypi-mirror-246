...
class BusinessLogic:
    ...
    @timing
    def put_dim_filter_by_value(self, value: str, dim_id: str):
        self.execute_olap_command(command_name="filter", state="filter_all_flag", dimension=dim_id)
        ...
        command1 = self.olap_command.collect_command(
            "olap", "filter", "apply_data", dimension="03495c84", marks=[1])

        command2 = self.olap_command.collect_command("olap", "filter", "set", dimension="03495c84")
