...
dst = '/'+date+'GoldenGate'
shutil.copy2(paths.loc[0].at['opentrons_repo']+'/Golden_Gate/GoldenGate_nodigests_separatepcrruns.py', paths.loc[0].at['opentrons_repo']+'/Golden_Gate/'+date+'_GoldenGate/')

#now rename the script with the date
os.chdir(paths.loc[0].at['opentrons_repo']+'/Golden_Gate/'+date+'_GoldenGate')
os.rename('GoldenGate_nodigests_separatepcrruns.py', date+'_GoldenGate.py')
