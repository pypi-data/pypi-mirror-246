'''IVA Assembly with a one-pot PCR protocol

This script performs Homology dependent assembly (IVA) where all fragments for each assembly are amplified in one tube. This protocol has only been successfully validated with 2-fragment assemblies. 
...
#Now add DPNI for digestion
    ...
    tc_mod.set_block_temperature(37, hold_time_minutes=60, block_max_volume=50)
