'''Setup script for initial PCRs for error prone pcr library assembly with a destination plasmid with restriction sites
...
This script can also be called as a module by calling `AssemblyTron.Error_prone_PCR_Golden_Gate.1_Setup_STD_GoldenGate_digests_PCR`.
