...
class Rewriter(metaclass=ABCMeta):
    ...
    def match_and_rewrite(self, graph: OnnxGraph) -> OnnxGraph:
    ...
    def get_value(self, node: onnx.NodeProto):
    ...
    def __call__(self, graph: OnnxGraph) -> OnnxGraph:
        """Make rewriter a callable."""
        return self.match_and_rewrite(graph)
