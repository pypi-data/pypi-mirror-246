...
class ListProjectsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, arn: str = ..., PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterator[ListProjectsResultPaginatorTypeDef]:
        """
...
class ListRemoteAccessSessionsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, arn: str, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterator[ListRemoteAccessSessionsResultPaginatorTypeDef]:
        """
...
class ListRunsPaginator(AioPaginator):
    ...
    def paginate(
        self, *, arn: str, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> AsyncIterator[ListRunsResultPaginatorTypeDef]:
        """
