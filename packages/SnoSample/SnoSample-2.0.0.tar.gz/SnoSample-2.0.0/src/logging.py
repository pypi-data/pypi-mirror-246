...
class SnoLogger:
    ...
    def _create_message(self, message: str, level: str) -> str:
        """
        Create a logging message from the defined layout and message.
    ...
    def _write_message(self, message: str) -> None:
        """
        Write a logging message in the provided file.
    ...
    def message(self, message: str, level: str = 'info') -> None:
        """
        Create and show a logging message from the defined message and level.
