...
from dielectric.poly.polyutils2_oo import complex_perm_full2
...
class Colloid2:
    def __init__(self, c: Cell, e: Electrolyte2, part: list = None):
        self.c = c
        self.e = e
        self.part = part
        self.Cpol = None
...
if __name__ == "__main__":
    ...
    el = Electrolyte2.from_yaml(str(DATADIR / "Cell_1_KCl_1mM.yaml"))
    # print(f"kappa^2: {e.kappa2}")
    system = Colloid2(Cell_1, el)
    system.calc_omegas()
    ...
    K_e, EPS_e = complex_perm_full2(w, el, Cell_1)
