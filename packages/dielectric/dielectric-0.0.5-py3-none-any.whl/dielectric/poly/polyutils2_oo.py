...
from dielectric.classes.electrolytes import Electrolyte2
...
def complex_perm_below_omega_zero2(omega, e: Electrolyte2, c: Cell):
...
def complex_perm_full2(omega, e: Electrolyte2, c: Cell):
...
def complex_perm_full_alt2(omega, e: Electrolyte2, c: Cell):
    """# THEORY ANY FREQUENCY, not to be used when D1 = D2
...
def cond_part2(omega, e: Electrolyte2, p: Particle):
    """
...
if __name__ == "__main__":
    ...
    e2 = Electrolyte2.from_yaml(str(DATADIR / "Cell_1_KCl_1mM.yaml"))
    eigvals, eigvect = find_lambdas2(omega[0], e2)
    for ev in eigvals:
        print(ev)
