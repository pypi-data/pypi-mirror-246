...
def transaction(name: str | Callable[..., Any] | None = None) -> Callable[..., Any]:
    def _transaction(func: Callable[..., Any]) -> Callable[..., Any]:
        @wraps(func)
        def wrapper(*args: Any, **kwargs: Any) -> Callable[..., Any]:
            with TransactionFlow(func, *args, **kwargs) as transaction_flow:
...
class TransactionFlow:
    def __init__(self, func: Callable[..., Any], *args: Any, **kwargs: Any) -> None:
        ...
        self.context = TransactionContext(
            ...
            execution_location=os.path.abspath(inspect.getfile(func)),
    ...
    def __enter__(self) -> 'TransactionFlow':
        ...
        transaction_manager.begin(self.context)
        return self
