...
:mod:`plaquette.decoders`. A set of helper tools for visualising codes and simulation
results can be found in :mod:`plaquette.visualizer`. Finally, the underlying
