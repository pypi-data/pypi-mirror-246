...
class NodeDataTypes:
    props: Union[Activation, ActivityRegularization, Add, AdditiveAttention, AlphaDropout, Average, AveragePooling1D, 
                 ...
                 ConvLSTM2D, ConvLSTM3D, Cropping1D, Cropping2D, Cropping3D, Dense, DepthwiseConv1D, DepthwiseConv2D, 
                 Discretization, Dot, Dropout, ELU, Embedding, Flatten, GRU, GRUCell, GaussianDropout, GaussianNoise, 
                 GlobalAveragePooling1D, GlobalAveragePooling2D, GlobalAveragePooling3D, GlobalMaxPooling1D, 
                 GlobalMaxPooling2D, GlobalMaxPooling3D, GroupNormalization, Identity, IntegerLookup, LSTM, LSTMCell, 
                 LayerNormalization, LeakyReLU, LocallyConnected1D, LocallyConnected2D, Masking, MaxPooling1D, 
                 MaxPooling2D, MaxPooling3D, Maximum, Minimum, MultiHeadAttention, Multiply, Normalization, PReLU, 
                 Permute, RandomBrightness, RandomContrast, RandomCrop, RandomFlip, RandomHeight, RandomRotation, 
                 RandomTranslation, RandomWidth, RandomZoom, ReLU, RepeatVector, Reshape, Resizing, SeparableConv1D, 
                 SeparableConv2D, SimpleRNN, SimpleRNNCell, Softmax, SpatialDropout1D, SpatialDropout2D, 
                 SpatialDropout3D, SpectralNormalization, StringLookup, Subtract, TextVectorization, ThresholdedReLU, 
                 TimeDistributed, UnitNormalization, UpSampling1D, UpSampling2D, UpSampling3D, ZeroPadding1D, 
                 ZeroPadding2D, ZeroPadding3D, BinaryCrossentropy, BinaryFocalCrossentropy, CategoricalCrossentropy, 
                 CategoricalFocalCrossentropy, CategoricalHinge, CosineSimilarity, Hinge, Huber, KLDivergence, LogCosh, 
                 MeanAbsoluteError, MeanAbsolutePercentageError, MeanSquaredError, MeanSquaredLogarithmicError, Poisson, 
                 SquaredHinge, Adadelta, Adafactor, Adagrad, Adam, AdamW, Adamax, Ftrl, Lion, Nadam, RMSprop, SGD, 
                 OnnxLSTM, Dataset, Input, RepresentationBlock, GroundTruth, CustomLayer, CustomLoss, Visualizer, 
                 Metric, Lambda, TFOpLambda, SlicingOpLambda, Repeat, Variable, Gather, FixedDropout]
