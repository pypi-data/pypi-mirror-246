...
class TIDAndTimes:
    ...
    updated_at: Optional[Union[datetime.datetime, str]]
...
class TInsights:
    enabled: bool
    image: Optional[str]
    image_styles: Optional[str]
    indicator_properties: Optional[TIndicatorProperties]
...
@dataclass
class TBatteryState:
    state_of_health: Optional[TAtomicState]
    state_of_charge: Optional[TAtomicState]
    current: Optional[TAtomicState]
    voltage: Optional[TAtomicState]
    temperature: Optional[TAtomicState]
...
class TTreeProperties:
    ...
    children_topology: Optional[str]
...
class TAPIInfoEssentials:
    name: Optional[str]
    dbName: Optional[str]
    version: Optional[TVersion]
    description: Optional[str]
    dev_container_mode: Optional[str]
