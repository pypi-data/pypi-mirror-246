...
from e2enetworks.cloud.tir import Plans, client
...
from e2enetworks.constants import (BASE_GPU_URL, INSTANCE_TYPE, PAID_USAGE,
                                   headers)
...
class Notebooks:
    ...
    def create(self, name, plan_name, image_id, disk_size_in_gb=30, notebook_type="new", notebook_url=""):
        skus, skus_table = Plans().get_notebook_plans_list(image_id)
        payload = json.dumps({
            "name": name,
            "image_id": image_id,
