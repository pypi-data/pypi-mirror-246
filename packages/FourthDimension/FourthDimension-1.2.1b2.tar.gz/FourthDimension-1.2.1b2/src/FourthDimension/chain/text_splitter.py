...
.. 代码块::
     ...
     BaseDocumentTransformer --> TextSplitter --> <name>TextSplitter # 示例：CharacterTextSplitter
                                                  RecursiveCharacterTextSplitter --> <名称>TextSplitter

注意： **MarkdownHeaderTextSplitter** 和 **HTMLHeaderTextSplitter 不是从 TextSplitter 派生的。
