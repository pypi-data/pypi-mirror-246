...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, name=None, hidden=False, base_path=None, pulp_created=None, pulp_labels=None, content_guard=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
