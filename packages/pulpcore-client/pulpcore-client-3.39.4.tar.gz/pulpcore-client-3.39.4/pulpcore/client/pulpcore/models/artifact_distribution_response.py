...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, base_path=None, name=None, pulp_created=None, base_url=None, content_guard=None, pulp_labels=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
