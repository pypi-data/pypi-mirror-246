...
hyphenation patterns.
    ...
    >>> h = Hyphenator(__file__.rpartition("/")[0] + "/hyph_en_US.dic")
    >>> h.inserted("subterranean")
    'sub-ter-ranean'
    >>> h.wrap("investigatorial", 11)
    ('investiga-', 'torial')
    >>> list(h.iterate("Amsterdam"))
    [('Amster', 'dam'), ('Ams', 'terdam'), ('Am', 'sterdam')]
        ...
        with open(filename, "rb") as f:
            ...
            for pat in decoder(f):
                ...
                if "/" in pat:
                    ...
                    factory = int
                tag, values = zip(*[(s, factory(i or "0")) for i, s in parse(pat)])
