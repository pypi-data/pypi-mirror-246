...
@dataclass
class Assignment(TimeframeLike):
    ...
    #: Can you connect git to this assignment. Deprecated, use
    #: `webhook_configuration`\` instead.
    webhook_upload_enabled: "bool"
    #: Settings for the git connection to this assignment.
    webhook_configuration: "t.Union[WebhookConfigurationEnabledAsJSON, WebhookConfigurationDisabledAsJSON]"
            ...
            rqa.FixedMapping(
                ...
                rqa.RequiredArgument(
                    ...
                    doc=(
                        ...
                        " availability and grade\\_availability fields, it"
                        " will be removed in Q3 2023."
                    ),
                ),
                rqa.RequiredArgument(
                    "description",
                    ...
                    doc=(
                        "Description of the assignment. Deprecated, use"
                        " available routes to upload and retrieve a"
                        " description file instead. It will be removed in Q3"
                        " 2023."
                    ),
                ),
                rqa.RequiredArgument(
                ...
                rqa.RequiredArgument(
                    ...
                    doc=(
                        "The time the assignment will become available (i.e."
                        " the state will switch from 'hidden' to 'open'). If"
                        " the state is not 'hidden' this value has no meaning."
                        " If this value is not `None` you cannot change to"
                        " state to 'hidden' or 'open'. Deprecated: use"
                        " availability and grade\\_availability fields, it"
                        " will be removed in Q3 2023."
                    ),
                ),
                ...
                rqa.RequiredArgument(
                    ...
                    doc=(
                        "The fixed value for the maximum that can be achieved"
                        " in a rubric. This can be higher and lower than the"
                        " actual max. Will be `None` if unset."
                    ),
                ),
                rqa.RequiredArgument(
                    "max_grade",
                    ...
                    doc=(
                        "The maximum grade you can get for this assignment."
                        " This is based around the idea that a 10 is a"
                        " 'perfect' score. So if this value is 12 a user can"
                        " score 2 additional bonus points. If this value is"
                        " `None` it is unset and regarded as a 10."
                    ),
                ),
                rqa.RequiredArgument(
                    "grading",
                    ...
                    doc=(
                        "Settings that influence how the grade for a"
                        " submission can be determined. TODO: Should we also"
                        " move max\\_grade and/or"
                        " fixed\\_max\\_rubric\\_points to the grading object?"
                    ),
                ),
                rqa.RequiredArgument(
                    ...
                    doc=(
                        "The group set of this assignment. This is `None` if"
                ...
                rqa.RequiredArgument(
                    ...
                    doc=(
                        "The id of the AutoTest configuration connected to"
                        " this assignment. This will always be given if there"
                        " is a configuration connected to this assignment,"
                        " even if you do not have permission to see the"
                ...
                rqa.RequiredArgument(
                    ...
                    rqa.SimpleValue.bool,
                    doc=(
                        "Can you connect git to this assignment. Deprecated,"
                        " use `webhook_configuration`\\` instead."
                    ),
                ),
                rqa.RequiredArgument(
                ...
                rqa.RequiredArgument(
                    ...
                    rqa.Nullable(rqa.SimpleValue.int),
                    doc=(
                        "The maximum amount of submission a student may"
                        " create, inclusive. The value `null` indicates that"
                        " there is no limit."
                    ),
                ),
                rqa.RequiredArgument(
                ...
                rqa.RequiredArgument(
                    ...
                    doc=(
                        ...
                        " \\>= 0, if this value is 0 a user can submit an"
                ...
                rqa.RequiredArgument(
                    ...
                    doc=(
                        ...
                        " `None` if you don't have the permission to see this"
                        " or if it is unset."
                    ),
                ),
                rqa.RequiredArgument(
                ...
                rqa.RequiredArgument(
                    ...
                    doc=(
                        "The peer feedback settings for this assignment. If"
                        " `null` this assignment is not a peer feedback"
                        " assignment."
                    ),
                ),
                rqa.RequiredArgument(
                    ...
                    rqa.Nullable(rqa.SimpleValue.str),
                    doc=(
                        "The kind of reminder that will be sent. If you don't"
                        " have the permission to see this it will always be"
                        " `null`. If this is not set it will also be `null`."
                    ),
                ),
                rqa.RequiredArgument(
                    "done_email",
                    rqa.Nullable(rqa.SimpleValue.str),
                    doc=(
                        "The email where the done email will be sent to. This"
                        " will be `null` if you do not have permission to see"
                        " this information."
                    ),
                ),
                rqa.RequiredArgument(
                    ...
                    rqa.Nullable(rqa.SimpleValue.int),
                    doc=(
                        "The assignment id of the assignment that determines"
                        " the grader division of this assignment. This will be"
                        " `null` if you do not have permissions to see this"
                        " information, or if no such parent is set."
                    ),
                ),
                rqa.RequiredArgument(
                ...
                rqa.RequiredArgument(
                    ...
                    rqa.Nullable(rqa.SimpleValue.str),
                    doc=(
                        "Optionally a glob for a file that should be loaded"
                        " first in the file viewer. There is no guarantee that"
                        " any file actually matches this glob."
                    ),
                ),
                rqa.RequiredArgument(
                    "grade_availability",
