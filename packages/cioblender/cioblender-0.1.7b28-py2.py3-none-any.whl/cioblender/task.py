...
def get_task_template(**kwargs):
    ...
    cmd = "blender -b {} -P {} -E {} --render-output {}/{}_ -s {} -e {} -- render_device={} --machine_type={} {}".format(
       command_scene_path, script_path, render_software, output_folder, blender_filename, first, last, instance_type, machine_type, extra_args)

    return cmd

def get_render_file_old(kwargs):
    """
