...
model_urls = {
    'ssd300_vgg16_coco': model_path_name + 'ssd300_vgg16_coco-b556d3b4.pth',
}
...
backbone_urls = {
    ...
    'vgg16_features': model_path_name + 'vgg16_features-amdegroot.pth'
}
...
def _vgg_extractor(backbone_name: str, highres: bool, progress: bool, pretrained: bool, trainable_layers: int):
    if backbone_name in backbone_urls:
        ...
        if pretrained:
            ...
            state_dict = load_state_dict_from_url(backbone_urls[backbone_name])
