...
from mindtorch.torch.utils.data.datapipes._decorator import functional_datapipe
from mindtorch.torch.utils.data._utils.collate import default_collate
from mindtorch.torch.utils.data.datapipes.datapipe import IterDataPipe
from mindtorch.torch.utils.data.datapipes.utils.common import _check_lambda_fn
...
class CollatorIterDataPipe(MapperIterDataPipe):
    ...
    By default, it uses :func:`mindtorch.torch.utils.data.default_collate`.

    .. note::
        While writing a custom collate function, you can import :func:`mindtorch.torch.utils.data.default_collate` for the
    ...
    Example: Convert integer data to float Tensor
        >>> class MyIterDataPipe(mindtorch.torch.utils.data.IterDataPipe):
