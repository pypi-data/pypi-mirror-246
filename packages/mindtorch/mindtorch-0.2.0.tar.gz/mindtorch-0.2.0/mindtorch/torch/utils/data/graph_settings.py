...
# import mindtorch.torch.utils.data.graph
# from mindtorch.torch.utils.data.datapipes.iter import Shuffler
...
#     graph = mindtorch.torch.utils.data.graph.traverse(datapipe, only_datapipe=True)
