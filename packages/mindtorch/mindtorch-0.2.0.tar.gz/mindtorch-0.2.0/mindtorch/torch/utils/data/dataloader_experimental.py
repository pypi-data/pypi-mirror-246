...
#
# import mindtorch.torch.utils.data.backward_compatibility
#
# import mindtorch.torch.utils.data.graph_settings
# from mindtorch.torch.utils.data import DataLoader, IterDataPipe, communication
# from mindtorch.torch.utils.data.datapipes.iter import IterableWrapper
#
# __all__ = [
#     "DataLoader2",
# ]
...
#             mindtorch.torch.utils.data.graph_settings.apply_sharding(thread_localdatapipe, num_workers, worker_id)
#             thread.start()
...
#             datapipe = dataset
#             datapipe = mindtorch.torch.utils.data.graph_settings.apply_shuffle_settings(datapipe, shuffle=shuffle)
...
#                         collate_fn = mindtorch.torch.utils.data._utils.collate.default_collate
#
