...
from mindtorch.torchaudio._internal import module_utils as _mod_utils
...
def _init_audio_backend():
    ...
    if "sox_io" in backends:
        ...
        warnings.warn("No audio backend is available. "
                      "Please use 'pip install soundfile' to install soundfile, "
                      "and use the 'torchaudio.set_audio_backend('soundfile')' to set audio's backend. ")
