...
model_urls = {
    'fcn_resnet50_coco': model_path_name + 'fcn_resnet50_coco-1167a1af.pth',
    'fcn_resnet101_coco': model_path_name + 'fcn_resnet101_coco-7ecb50ca.pth',
    'deeplabv3_resnet50_coco': model_path_name + 'deeplabv3_resnet50_coco-cd0a2569.pth',
    'deeplabv3_resnet101_coco': model_path_name + 'deeplabv3_resnet101_coco-586e9e4e.pth',
    'deeplabv3_mobilenet_v3_large_coco':model_path_name + 'deeplabv3_mobilenet_v3_large-fc3c493d.pth',
    'lraspp_mobilenet_v3_large_coco': model_path_name + 'lraspp_mobilenet_v3_large-d234d4ea.pth',
}
