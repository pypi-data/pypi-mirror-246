...
import mindtorch.torch.nn.init as init
...
f = {
    'squeezenet1_0': model_path_name + 'squeezenet1_0-b66bff10.pth',
    'squeezenet1_1': model_path_name + 'squeezenet1_1-b8a52dc0.pth',
}
