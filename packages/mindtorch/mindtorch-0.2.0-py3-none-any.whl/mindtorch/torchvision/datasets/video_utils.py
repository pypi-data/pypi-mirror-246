...
from mindtorch.torchvision.io import (
...
class VideoClips:
    ...
    def _compute_frame_pts(self) -> None:
        ...
        dl: mindtorch.torch.utils.data.DataLoader = mindtorch.torch.utils.data.DataLoader(
    ...
    def get_clip(self, idx: int) -> Tuple[torch.Tensor, torch.Tensor, Dict[str, Any], int]:
        ...
        from mindtorch.torchvision import get_video_backend
