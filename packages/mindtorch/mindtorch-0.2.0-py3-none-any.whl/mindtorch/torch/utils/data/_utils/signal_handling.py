...
def _set_worker_pids():
    raise ValueError("'_set_worker_pids' is not currently supported.")

def _remove_worker_pids():
    raise ValueError("'_remove_worker_pids' is not currently supported.")

def _error_if_any_worker_fails():
    raise ValueError("'_error_if_any_worker_fails' is not currently supported.")

def _set_worker_signal_handlers():
    raise ValueError("'_set_worker_signal_handlers' is not currently supported.")
