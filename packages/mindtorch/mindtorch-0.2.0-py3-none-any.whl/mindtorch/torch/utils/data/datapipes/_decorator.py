...
from mindtorch.torch.utils.data.datapipes.datapipe import IterDataPipe, MapDataPipe
from mindtorch.torch.utils.data.datapipes._typing import _DataPipeMeta
