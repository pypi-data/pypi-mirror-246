...
from mindtorch.torch._register import register_utils as utils
from mindtorch.torch._register.getitem_impl import _tensor_getitem_by_tensor, _tensor_getitem_by_number, \
