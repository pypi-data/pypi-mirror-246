...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SpatialEntity']:
            return SpatialEntity

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SpatialEntity'], typing.List['SpatialEntity']],
    ...
    def __getitem__(self, i: int) -> 'SpatialEntity':
...
class ReferenceOrgans(BaseApi):
    ...
    def reference_organs(
        ...
        return self._reference_organs_oapg(
