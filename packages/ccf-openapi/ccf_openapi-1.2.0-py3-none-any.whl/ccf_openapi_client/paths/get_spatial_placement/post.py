...
# body param
SchemaForRequestBodyApplicationJson = GetSpatialPlacementRequest


request_body_get_spatial_placement_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FlatSpatialPlacement
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_spatial_placement_oapg(
        self,
    ...
    def _get_spatial_placement_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_get_spatial_placement_request.serialize(body, content_type)
...
class GetSpatialPlacement(BaseApi):
    ...
    def get_spatial_placement(
        ...
        return self._get_spatial_placement_oapg(
            body=body,
