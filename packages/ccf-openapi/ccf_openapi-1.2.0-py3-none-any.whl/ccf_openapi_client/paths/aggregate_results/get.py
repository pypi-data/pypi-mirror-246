...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AggregateCount']:
            return AggregateCount

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AggregateCount'], typing.List['AggregateCount']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'AggregateCount':
        return super().__getitem__(i)
...
class AggregateResults(BaseApi):
    ...
    def aggregate_results(
        ...
        return self._aggregate_results_oapg(
