...
class BiomarkerTermsSchema(
    ...
    def __getitem__(self, i: int) -> MetaOapg.items:
        return super().__getitem__(i)
OrganIriSchema = schemas.StrSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'organ-iri': typing.Union[OrganIriSchema, str, ],
    }
)
...
request_query_organ_iri = api_client.QueryParameter(
    name="organ-iri",
    style=api_client.ParameterStyle.FORM,
    schema=OrganIriSchema,
    required=True,
    explode=True,
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SpatialSceneNode']:
            return SpatialSceneNode

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SpatialSceneNode'], typing.List['SpatialSceneNode']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'SpatialSceneNode':
        return super().__getitem__(i)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _reference_organ_scene_oapg(
        self,
...
class ReferenceOrganScene(BaseApi):
    ...
    def reference_organ_scene(
        ...
        return self._reference_organ_scene_oapg(
