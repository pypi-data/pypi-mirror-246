...
SchemaFor200ResponseBodyApplicationJson = OntologyTree
...
class BaseApi(api_client.Api):
    @typing.overload
    def _biomarker_tree_model_oapg(
        self,
...
class BiomarkerTreeModel(BaseApi):
    ...
    def biomarker_tree_model(
        ...
        return self._biomarker_tree_model_oapg(
