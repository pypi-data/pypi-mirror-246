...
class TissueCommon(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["label", "link", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["label", "link", "description", ], str]):
