...
class TissueDataset(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["technology"], typing_extensions.Literal["thumbnail"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["technology"], typing_extensions.Literal["thumbnail"], str, ]):
