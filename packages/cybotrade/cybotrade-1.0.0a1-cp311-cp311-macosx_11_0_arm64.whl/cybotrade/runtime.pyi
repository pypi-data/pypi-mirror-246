...
class StrategyTrader:
    ...
    async def open(self, side: OrderSide, quantity: float, limit: float | None, take_profit: float | None, stop_loss: float | None) -> OrderResponse:
        """
    ...
    async def cancel(self, id: str) -> OrderResponse:
        ...
        """
    async def close(self, side: OrderSide, quantity: float):
        """
