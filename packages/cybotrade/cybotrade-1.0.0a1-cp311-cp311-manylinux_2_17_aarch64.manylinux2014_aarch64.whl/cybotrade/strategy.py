...
from .models import Candle, ClosedPnL, FloatWithTime, OpenedTrade, OrderUpdate, RuntimeMode, Interval
...
class Strategy:
    ...
    async def on_closed_pnl(self, strategy, closed_pnl: ClosedPnL):
        logging.info(f"[on_closed_pnl] Received closed trade: {closed_pnl.__repr__()}")
