...
class SocialLinks(models.Model):
    ...
    parent = models.ForeignKey(Company, on_delete=models.CASCADE, null=True, related_name="socialmedia")
...
class Poll(models.Model):
    dynamic_topic = models.ForeignKey(Content, on_delete=models.CASCADE)
    question = models.TextField(verbose_name=_('Questions'))
    option_one = models.CharField(max_length=30, verbose_name=_('Awnser 1'))
    option_two = models.CharField(max_length=30, verbose_name=_('Awnser 2'))
    option_three = models.CharField(max_length=30, verbose_name=_('Awnser 3'))
    option_four = models.CharField(max_length=30, verbose_name=_('Awnser 4'))
    option_five = models.CharField(max_length=30, verbose_name=_('Awnser 5'))
...
class SharePosts(models.Model):
    post = models.ForeignKey(Content, on_delete=models.CASCADE, related_name='shared', null=True)
    host = models.CharField(max_length=150, default="No title")
    created = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return self.post.title + str(' ') + str(self.host)
