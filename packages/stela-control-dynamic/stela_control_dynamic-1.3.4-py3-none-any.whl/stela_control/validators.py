...
from .models import (
    ...
    Booking, BookingServices, City
    
)
from .forms import (
    FAQForm, NewsletterForm, PolicyForm, UserForm, BillingForm, BillingDiscountForm, 
    ...
    ConsultingForm, BookingConsultingForm, RegistrationForm
)
form_mapping = {
