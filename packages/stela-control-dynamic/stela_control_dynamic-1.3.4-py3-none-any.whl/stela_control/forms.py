...
from .models import (
        ...
        SetFaq, Reviews, ProStelaExpert, LiteraryWork, Resource, BillFile, Booking, APIStelaClient
)
import re
...
class RegistrationForm(forms.ModelForm):
    ...
    class Meta:
        model = UserBase
        fields = [
            'email', 'username', 'full_name', 'phone_number', 'zip', 
            'country_profile', 'address', 'city_profile'
        ]
