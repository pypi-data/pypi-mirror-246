    ...
    if request.method == 'POST':
        ...
        if action == "checkCardContent":        
            ...
            if content:
                ...
                obj_data = render_to_string('stela_control/load-data/site_docs/update_forms/cardform.html', { 
                    'formset': formset,
                    'pk': author.pk   
                })
                response = JsonResponse({'content': obj_data})
                ...
                obj_data = render_to_string('stela_control/load-data/site_docs/forms/cardform.html', { 
                    'formset': get_formset(prefix='formset') 
                })
                response = JsonResponse({'empty': obj_data})
            return response
        ...
        if action == "checkImageBullet":  
            ...
            if uk:      
                ...
                obj_data = render_to_string('stela_control/load-data/site_docs/update_forms/imagebulletform.html', { 
                    'form': form,
                ...
                obj_data = render_to_string('stela_control/load-data/site_docs/forms/imagebulletform.html', { 
                    'form': form,
                    'formset': get_formset(prefix='formset')
                })
                response = JsonResponse({'empty': obj_data})
        ...
        if action == "checkBoxIconBulllets":        
            ...
            if content:
                ...
                obj_data = render_to_string('stela_control/load-data/site_docs/update_forms/box-info.html', { 
                    'formset': formset,
                    'pk': author.pk   
                })
                response = JsonResponse({'content': obj_data})
                ...
                obj_data = render_to_string('stela_control/load-data/site_docs/forms/box-info.html', { 
                    'formset': get_formset(prefix='formset') 
                })
                response = JsonResponse({'empty': obj_data})
            return response
        ...
        if form_id == "about-form":
            ...
            if pk:
                ...
                if formset.is_valid():
                    ...
                    print(formset.errors)
                    obj_data = render_to_string('stela_control/load-data/site_docs/error_forms/aboutform.html', { 
                        'formset': formset,
                        'errors': formset.errors,
                    })
                ...
                if formset.is_valid():
                    ...
                    print(formset.errors)
                    obj_data = render_to_string('stela_control/load-data/site_docs/error_empty_forms/aboutform.html', { 
                        'formset': formset,
                        'errors': formset.errors,
                    })
                    return JsonResponse({'alert': _('Process failed, please check the errors...'), 'formset_html': obj_data, 'about_cke':'content'})
        ...
        if form_id == "card-form":
            ...
            if pk:
                ...
                if formset.is_valid():
                    ...
                    print(formset.errors)
                    obj_data = render_to_string('stela_control/load-data/site_docs/error_forms/cardform.html', { 
                        'formset': formset,
                        'errors': formset.errors,
                    })
                    return JsonResponse({'alert': _('Process failed, please check the errors...'), 'formset_html': obj_data, 'about_cke':'content'})
                ...
                if formset.is_valid():
                    ...
                    print(formset.errors)
                    obj_data = render_to_string('stela_control/load-data/site_docs/error_empty_forms/cardform.html', { 
                        'formset': formset,
                        'errors': formset.errors,
                    })
                    return JsonResponse({'alert': _('Process failed, please check the errors...'), 'formset_html': obj_data, 'about_cke':'content'})
        ...
        if form_id == "boxicon-form":
            ...
            if pk:
                ...
                if formset.is_valid():
                    ...
                    print(formset.errors)
                    obj_data = render_to_string('stela_control/load-data/site_docs/error_forms/box-info.html', { 
                        'formset': formset,
                        'errors': formset.errors,
                    })
                    return JsonResponse({'alert': _('Process failed, please check the errors...'), 'formset_html': obj_data})
                ...
                if formset.is_valid():
                    ...
                    print(formset.errors)
                    obj_data = render_to_string('stela_control/load-data/site_docs/error_empty_forms/box-info.html', { 
                        'formset': formset,
                        'errors': formset.errors,
                    })
                    return JsonResponse({'alert': _('Process failed, please check the errors...'), 'formset_html': obj_data})
