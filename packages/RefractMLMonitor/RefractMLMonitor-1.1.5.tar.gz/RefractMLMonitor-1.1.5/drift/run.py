...
def main():
    ...
    if drift_type == DriftType.FEATURE_DRIFT:
        ...
        data_configuration = json.loads(os.getenv("data_configuration"))
        prediction_col = json.loads(os.getenv("prediction_col_name"))
        target_col = json.loads(os.getenv("target_col_name"))
        prob = False
        try:
        ...
        column_mapping.target = target_col[0]
        ...
        data_configuration = json.loads(os.getenv("data_configuration"))
        prediction_col = json.loads(os.getenv("prediction_col_name"))[0]
        column_mapping.prediction = prediction_col
        ...
        data_configuration = json.loads(os.getenv("data_configuration"))
        target_col = json.loads(os.getenv("target_col_name"))[0]
