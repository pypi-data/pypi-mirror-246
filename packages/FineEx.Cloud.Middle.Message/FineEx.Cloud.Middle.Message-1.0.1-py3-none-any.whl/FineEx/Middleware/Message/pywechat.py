...
if __name__ == '__main__':
    corpid = 'wwa959dc7c054aa040'
    corpsecret = 'LCfKkkekWb9w5rUxTOc4e6m--Xvzi1Sd5HqHOtq1MZY'
    agentid = 1000039
    ...
    message = f"""
        >**测试信息异常** 
        请尽快处理！
        查看详情，请点击：[FineEx](https://cloud.fineexlink.com/work/index)
        """
    workSender.send_markdown(subject + "\n" + message.strip())
    workSender.send_image(r"C:\Users\liuchunyang\Desktop\dist\addattachment.png", touser='91237')
    workSender.send_file(r"C:\Users\liuchunyang\Desktop\dist\dist.rar", touser='91237')
    workSender.send_video(r"C:\Users\liuchunyang\Desktop\dist\FlatFreehand3D.mp4", touser='91237')
    workSender.send_voice(r"C:\Users\liuchunyang\Desktop\dist\白月光与朱砂痣.amr", touser='91237')
