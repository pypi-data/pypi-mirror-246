...
setup(
    name='invoicing-fff',  # * Your package will have this name
    ...
    description='This package can be used to convert Excel invoices to PDF.',  # Short description of your library
    author='Ivo Simac',  # Your name
    author_email='i.simac.8@gmail.com',  # Your email
