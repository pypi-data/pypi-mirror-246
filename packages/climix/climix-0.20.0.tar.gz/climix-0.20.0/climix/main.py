...
from .dask_setup import setup_scheduler
...
def do_main(
    ...
    for index_no, index in enumerate(indices):
        ...
        save(
            ...
            iterative_storage,
            scheduler.client,
            conventions_override=(climix_config is not None),
        )
...
def main():
    ...
    index_catalog, climix_config = load_metadata(
