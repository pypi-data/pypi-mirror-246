...
from pih.tools import ParameterList, BitMask as BM, nl, if_else, js, j, b, n, nn, i
...
from MobileHelperService.client import MOBILE_HELPER as MIO
    ...
    def pih_handler(
        ...
        while True:
            try:
                ...
                if interruption.type == InteraptionTypes.NEW_COMMAND:
