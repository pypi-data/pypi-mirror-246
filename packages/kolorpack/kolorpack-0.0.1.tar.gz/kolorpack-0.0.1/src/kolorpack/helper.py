...
class finderror:
    ...
    def hsl(h: float, s: float, l: float):
        ...
        Example -> finderror.hsl(400, 100, 50) will raise a ValueError
    ...
    def hsv(h: float, s: float, v: float):
        ...
        Example -> finderror.hsv(400, 100, 100) will raise a ValueError
        As H is not in the range of numbers 0 to 360'''
    ...
    def hex(hex: str):
        ...
        Example -> finderror.hex('#GG8000') will raise a ValueError
        As it should only contain letters A to F But it Contains the letter G'''

        # Main

        if len(hex.lstrip('#')) not in 6 or 3:
    ...
    def cmyk(c: int, m: int, y: int, k: int):
        ...
        Example -> finderror.cmyk(0, 150, 100, 0) will raise a ValueError
    ...
    def rgb(r: int, g: int, b: int):
        ...
        Example -> finderror.rgb(300, 128, 0) will raise a ValueError
...
# Convert color models to RGB and back
