...
def create_openapi_info(
    config: Config,
    resource_class: type,
    *args: typing.Tuple[base.Action, base.ResourceType, typing.Optional[str]],
) -> typing.Dict[str, str]:
    ...
    for i, a in enumerate(args):
        ...
        docs[f"x-iam-resource-{i}"] = resource_class.generate_from_config(config, resource_type, resource_id).urn
