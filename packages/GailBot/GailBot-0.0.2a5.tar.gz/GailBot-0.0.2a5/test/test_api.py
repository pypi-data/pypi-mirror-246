...
# @Last Modified time: 2023-11-30 16:44:41
import pytest
...
def test_apply_setting_profile_to_source(
    ...
    """
    result = gb_with_2_sources.apply_setting_profile_to_source(
...
def test_get_source_profile_dict(
    ...
    """
    result = gb_with_sources_and_settings.get_source_profile_dict(source_name)
    if result == False:
        assert result == expected
    else:
...
def get_src_profile_name(
    ...
    """
    result = gb_with_sources_and_settings.get_src_profile_name(source_name)
    assert result == expected
...
def test_get_profile_dict(
    ...
    """
    result = gb_with_profile.get_profile_dict(profile_name)
    assert result == request.getfixturevalue(expected)
...
def test_get_all_profile_names(gb_with_profile: GailBot):
    result = gb_with_profile.get_all_profile_names()
    print(result)
...
def test_rename_profile(gb_with_profile, old_name, new_name, expected):
    print(gb_with_profile.get_all_profile_names())
...
def test_get_default_profile_setting_name(gb_with_2_sources: GailBot):
    result = gb_with_2_sources.get_default_profile_setting_name()
...
def test_delete_plugin_suite(gb_with_suite: GailBot, suite_name: str, expected: bool):
    result = gb_with_suite.delete_plugin_suite(suite_name)
    assert result == expected


def test_get_all_plugin_suites(gb_with_suite: GailBot):
    result = gb_with_suite.get_all_plugin_suites()
    assert list(result) == ["HiLabSuite",]
...
def test_get_suite_source_path(gb_with_suite: GailBot, suite_name: str):
    result = gb_with_suite.get_suite_source_path(suite_name)
    print(result)
...
def test_get_engine_setting_names(gb_with_all_engines: GailBot):
    result = gb_with_all_engines.get_engine_setting_names()
    print(result)
...
def test_remove_engine_setting(name: str, expected: bool, gb_with_all_engines: GailBot):
    result = gb_with_all_engines.remove_engine_setting(name)
    assert result == expected
...
def test_update_engine_setting(
    ...
    result = gb_with_all_engines.update_engine_setting(
...
def test_get_engine_setting_data(
    name: str, expected, gb_with_all_engines: GailBot, request
):
    result = gb_with_all_engines.get_engine_setting_data(name)
    if expected != False:
        assert result == request.getfixturevalue(expected)
    else:
        assert result == expected
...
def test_is_engine_setting(gb_with_all_engines: GailBot, name: str, expected: bool):
    result = gb_with_all_engines.is_engine_setting(name)
    assert result == expected


def test_get_default_engine_setting_name(gb_with_all_engines: GailBot):
    result = gb_with_all_engines.get_default_engine_setting_name()
    print(result)
