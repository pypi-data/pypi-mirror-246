...
# @Last Modified time: 2023-08-28 23:35:07
...
class SourceObject:
    ...
    def source_setting(self) -> SettingObject:
        """
    ...
    def setting_name(self) -> str:
        """
        Accesses the source's setting's name

        Returns:
            String name of the current source's setting
        """
    ...
    def add_progress_display(self, displayer: Callable) -> bool:
        """
