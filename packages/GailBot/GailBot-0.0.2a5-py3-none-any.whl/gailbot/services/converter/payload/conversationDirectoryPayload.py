...
# @Last Modified time: 2023-08-17 13:22:34
import os
...
def load_conversation_dir_payload(
    ...
    """
    Given a source object, convert it into a conversation directory payload
    ...
    Returns:
        ...
        conversion is successful, return false otherwise
    """
