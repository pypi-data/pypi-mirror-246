...
# @Last Modified time: 2023-12-05 16:45:14
from abc import ABC
...
class PayLoadObject(ABC):
    ...
    def __init__(self, source: SourceObject, workspace: WorkspaceManager) -> None:
        ...
        # HANNAH CHANGE: self.workspace in AnalysisResult
        self.analysis_result: AnalysisResult = AnalysisResult(self.workspace)
    ...
    def get_engine(self) -> str:
        ...
        """
        return str(self.setting.engine_setting.engine)
    ...
    def get_plugin_setting(self) -> Dict[str, Dict[str, List[str]]]:
        """
    ...
    def set_transcription_process_stats(self, stats: ProcessingStats) -> bool:
        """
    ...
    def set_analysis_process_stats(self, stats: ProcessingStats) -> bool:
        """
    ...
    def set_format_process_stats(self, stats: ProcessingStats) -> bool:
        """
