...
class RequestHandler:
	...
	def streaming_channel_status(self,request,**B):A={_B:_A,_E:0,'message':'test channel','channels':[{_E:0,'persisted_row_sequencer':1,'persisted_client_sequencer':1,'persisted_offset_token':'1'}]};return A
