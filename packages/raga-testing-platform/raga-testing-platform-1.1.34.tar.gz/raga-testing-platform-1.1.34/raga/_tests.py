...
def clustering(method:str, embedding_col:str, level:str, args=dict, interpolation:bool=False, test_session: Optional[TestSession]=None, dataset_name:Optional[str]=None, force:Optional[bool]=False):
