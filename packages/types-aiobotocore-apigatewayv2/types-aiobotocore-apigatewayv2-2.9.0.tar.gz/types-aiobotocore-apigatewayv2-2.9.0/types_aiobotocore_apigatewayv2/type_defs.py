...
JWTConfigurationPaginatorTypeDef = TypedDict(
    "JWTConfigurationPaginatorTypeDef",
    {
...
DomainNameConfigurationPaginatorTypeDef = TypedDict(
    "DomainNameConfigurationPaginatorTypeDef",
    {
...
ApiPaginatorTypeDef = TypedDict(
    "ApiPaginatorTypeDef",
    {
        ...
        "CorsConfiguration": NotRequired[CorsPaginatorTypeDef],
        "CreatedDate": NotRequired[datetime],
        "Description": NotRequired[str],
...
AuthorizerPaginatorTypeDef = TypedDict(
    "AuthorizerPaginatorTypeDef",
    {
        "Name": str,
        ...
        "JwtConfiguration": NotRequired[JWTConfigurationPaginatorTypeDef],
    },
)
...
DomainNamePaginatorTypeDef = TypedDict(
    "DomainNamePaginatorTypeDef",
    {
        ...
        "DomainNameConfigurations": NotRequired[List[DomainNameConfigurationPaginatorTypeDef]],
...
GetApisResponsePaginatorTypeDef = TypedDict(
    "GetApisResponsePaginatorTypeDef",
    {
...
GetAuthorizersResponsePaginatorTypeDef = TypedDict(
    "GetAuthorizersResponsePaginatorTypeDef",
    {
...
GetDomainNamesResponsePaginatorTypeDef = TypedDict(
    "GetDomainNamesResponsePaginatorTypeDef",
    {
