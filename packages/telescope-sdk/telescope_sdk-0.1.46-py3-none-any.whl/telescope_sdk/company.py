...
class GPTCompanyEnrichment(BaseModel):
    company_summary: Optional[str]
    industry_tags: Optional[List[str]]
    target_customer_industry_tags: Optional[List[str]]
    products_services_tags: Optional[List[str]]
    company_type_tags: Optional[List[str]]
    technology_tags: Optional[List[str]]
    business_model: Optional[List[str]]
    stage: Optional[List[str]]
    is_software_as_a_service: Optional[bool]
...
class Company(IngestedDataType):
    ...
    enrichment: Optional[CompanyEnrichment] = None  # TODO switch enrichment field to GPTCompanyEnrichment
    gpt_enrichment: Optional[GPTCompanyEnrichment] = None
