...
def heru_extract(data_name, num_works, cuda, lr, momentum):
    ...
    for task in range(num_works):
        ...
        if data_name == 'cifar100':
            ...
            snapshot_model = './val_outputs/Val_lifelong_scratch_cifar/2023-12-08_07:48:30/task_{0}'.format(task)
        if data_name == 'imagenet100':
            ...
            snapshot_model = './val_outputs//Val_lifelong_scratch_cifar_imagenet/task_{0}'.format(task)
