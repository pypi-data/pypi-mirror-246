...
class ComponentHelper(TableHelper, TreeHelper, ListviewHelper, ValueHelper):
    ...
    def initTextbox(self, parent: QWidget, info):
        ...
        if 'returnPressedCommand' in info and type(info["returnPressedCommand"]).__name__ == "str":
            ...
            commands = partial(self.commands[info["returnPressedCommand"]], info["returnPressedCommandParams"])
