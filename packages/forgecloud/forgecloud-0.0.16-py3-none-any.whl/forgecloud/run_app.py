...
from .post_process import extract_outputs
...
async def run_app(app_data: dict, api_key, results: Optional[list] = None):
    """
    ...
    try:
        ...
        if 'outputs_template' not in app_data or not isinstance(app_data['outputs_template'], dict):
            try:
                ...
                input_template, outputs_template, get_app_json = await get_app_templates(app_id, api_key)
