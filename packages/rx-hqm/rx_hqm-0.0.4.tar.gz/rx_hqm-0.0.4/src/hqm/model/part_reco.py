...
def get_part_reco(year="2018", trigger="ETOS", preffix=''):
    ...
    psi2SK_shape = get_KDE_shape(obs, "psi2", "high", "psi2SK", preffix=preffix, bandwidth=None)
    ...
    total_shape = zfit.pdf.SumPDF([psi2S_part_reco_shape, psi2SK_shape], [psi2S_ratio_param], obs=obs)
    return total_shape
