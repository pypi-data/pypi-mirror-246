...
class Payment(object):
    ...
    Attributes:
        ...
        bool force_acs_new_window: The forced display mode with the ACS page opening in a window despite the settings in Checkout Page
        str force_payment_method: The ID of the payment provider that is opened to customers by default.
        str language_code: The language in which the checkout page will be opened to the customer in ISO 639-1 alpha-2 format.
        ...
        bool redirect: A parameter that enables opening of the generated checkout page in a separate tab
        ...
        bool redirect_on_mobile: A parameter that enables opening of the generated checkout page in a separate tab on mobile devices only
        ...
        str target_element: The element in which the iframe of the checkout page is embedded in the web page of your project.
        int terminal_id: Unique ID of the Checkout Page template which you want to run despite the regional and A/B test settings
        str baseurl: Basic Checkout Page address that is used in case the Checkout Page domain differs from the domain used to connect libraries or if merchant.js is not connected via the <script> tag
