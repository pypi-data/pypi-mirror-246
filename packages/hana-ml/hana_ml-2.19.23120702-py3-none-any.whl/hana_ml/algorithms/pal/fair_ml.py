...
class _FairMLBase(PALBase):
    ...
    def _fit(self,
        ...
        if self.submodel_ is not None:
            ...
            self.submodel_.fit(data=data, key=key, features=features, label=label)
...
class FairMLClassification(_FairMLBase):
    ...
    **kwargs: keyword arguments
    ...
    Examples
    --------
    >>> fair_ml = FairMLClassification(fair_sensitive_variable='gender')
    >>> fair_ml.fit(data=df)
...
class FairMLRegression(_FairMLBase):
    ...
    **kwargs: keyword arguments
    ...
    Examples
    --------
    >>> fair_ml = FairMLRegression(fair_sensitive_variable='gender', fair_bound=0.5)
    >>> fair_ml.fit(data=df)
    >>> res = fair_ml.predict(data=df_predict)
    """
    def  __init__(self,
