...
@cli_command(
    ...
    short_help="&pack/&un&pack, unified interface for several archive formats",
    prolog=[
        HelpPart(
...
class invoker:
    ...
    def __init__(self, ctx: Context, archive: Path, file: Iterable[Path],  add: bool, move: bool, extract: bool, list: bool,  **kwargs):
