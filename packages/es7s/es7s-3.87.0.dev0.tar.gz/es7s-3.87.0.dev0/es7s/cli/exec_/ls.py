...
from es7s.shared import IFileIconRenderer, FileIconRendererFactory, IFile
...
class _Styles(BaseStyles):
    ...
    def _get_rvx_map_rgb(cls) -> dict:
        return {
            "user": cls._make_rwx("hi-red kalm", "yellow kalm", "hi-yellow kalm", FrozenStyle(bold=True)),
