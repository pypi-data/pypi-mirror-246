...
from es7s.cli._base_opts_params import CMDTYPE_BUILTIN, CMDTRAIT_NONE, HelpPart
from es7s.cli._decorators import cli_command, catch_and_log_and_exit, cli_option, cli_argument
...
class PathMap(dict[str, PathChains]):
    ...
    def _read_dir(self, path: Path) -> t.Iterable[tuple[str, PathChain]]:
...
class invoker:
    ...
    duplicate (i.e., conflict) names.
    """

    def __init__(self, mode: RepeatedMode, full_chain: bool, **kwargs):
    ...
    def _get_path(self) -> t.Iterable[str]:
