...
from ibm_watson_machine_learning.foundation_models.utils.utils import get_model_specs_with_prompt_tuning_support
    ...
    **Example**
    ...
    def prompt_tuner(self,
        ...
        **Examples**
        ...
        prompt_tuning_supported_models = [model_spec['model_id'] for model_spec in get_model_specs_with_prompt_tuning_support(
