...
from ibm_watson_machine_learning.wml_client_error import MissingValue, ValidationError, InvalidMultipleArguments
...
class TestPromptTemplate(unittest.TestCase):
    ...
    def test_00_create_prompt_template(self):
    ...
    def test_01a_store_prompt(self):
    ...
    def test_01b_store_prompt_template(self):
    ...
    def test_01c_store_langchain(self):
    ...
    def test_03_update_prompt(self):
    ...
    def test_04b_list_sorted_by_last_modified(self):
        df_prompts = self.prompt_mgr.list()
    ...
    def test_05_delete_prompt(self):
        template = ("Generate a random question"
                    " about {topic}: Question: ")
        langchain_prompt = LcPromptTemplate(input_variables=["topic"],
                                            template=template)
    ...
    def test_07_project_and_space_id(self):
