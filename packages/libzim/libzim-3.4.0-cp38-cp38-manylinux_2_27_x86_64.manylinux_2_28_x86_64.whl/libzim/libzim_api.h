...
static int import_libzim(void) {
  ...
  if (!module) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "obj_has_attribute", (void (**)(void))&__pyx_api_f_6libzim_obj_has_attribute, "bool (PyObject *, std::string)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "string_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_string_cy_call_fct, "std::string (PyObject *, std::string, std::string *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "blob_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_blob_cy_call_fct, "wrapper::Blob (PyObject *, std::string, std::string *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "contentprovider_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_contentprovider_cy_call_fct, "zim::writer::ContentProvider *(PyObject *, std::string, std::string *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "indexdata_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_indexdata_cy_call_fct, "zim::writer::IndexData *(PyObject *, std::string, std::string *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "bool_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_bool_cy_call_fct, "bool (PyObject *, std::string, std::string *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "uint64_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_uint64_cy_call_fct, "uint64_t (PyObject *, std::string, std::string *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "uint32_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_uint32_cy_call_fct, "uint32_t (PyObject *, std::string, std::string *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "geoposition_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_geoposition_cy_call_fct, "zim::writer::IndexData::GeoPosition (PyObject *, std::string, std::string *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "convertToCppHints", (void (**)(void))&__pyx_api_f_6libzim_convertToCppHints, "std::map<zim::writer::HintKeys,uint64_t>  (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_0_5(module, "hints_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_hints_cy_call_fct, "std::map<zim::writer::HintKeys,uint64_t>  (PyObject *, std::string, std::string *)") < 0) goto bad;
