...
def audit_log(**kwargs):
    ...
    csv_header = 'Severity,Type,Groups,IP-Address,Message,Actor,Time,Response,Id\n'
    ...
    while True:
        ...
        if kwargs['limit']:
            url = '/sys/v1/logs?size=' + str(min(1000,limit)) + '&range_from=' + str(start_time) + '&range_to=' + str(end_time)
        else:
            url = '/sys/v1/logs?size=1000&range_from=' + str(start_time) + '&range_to=' + str(end_time)
