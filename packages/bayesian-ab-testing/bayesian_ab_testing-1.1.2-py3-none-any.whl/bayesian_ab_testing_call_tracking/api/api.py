...
from bayesian_ab_testing_call_tracking.data_preperation import SqlHandler
from bayesian_ab_testing_call_tracking.data_preperation.schema import create_ORM
from bayesian_ab_testing_call_tracking.models.TS_Bernoulli import ThompsonAlgo, ThompsonArm
import bayesian_ab_testing_call_tracking
...
create_ORM(bayesian_ab_testing_call_tracking.db_path)
cnxn = sqlite3.connect(bayesian_ab_testing_call_tracking.db_path)
