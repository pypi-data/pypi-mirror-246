...
class UavFlightData(genpy.Message):
  _md5sum = "0523601c23507db14bf516c07b9a04b8"
...
"""
  ...
  __slots__ = ['header','agent_reg','flight_path','msg_type']
  _slot_types = ['std_msgs/Header','uint64','digitaleye_msgs/Flightpath','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,agent_reg,flight_path,msg_type
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.msg_type,) = _get_struct_I().unpack(str[start:end])
      return self
