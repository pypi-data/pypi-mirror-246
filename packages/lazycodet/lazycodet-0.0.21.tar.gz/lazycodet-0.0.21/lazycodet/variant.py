...
class Variant:
    ...
    @staticmethod
    def replace(word):
        return [l + c + r[1:] for l, r in Variant.split(word) if r for c in Variant.letter_v_normal]
    @staticmethod
    ...
    @staticmethod
    def create(w):
            #Vì đây là hàm tạo biến thể tiếng việt, nên nếu từ có chứa kí tự tiếng anh sẽ không cần phải tạo
            for c in w:
                if c in Variant.letter_e:
                    return set()
