...
class AWSCredentials(Credentials):
    ...
    @property
    def temp_credentials(self) -> bool:
    ...
    def temp_credentials(self, temp_credentials: bool):
        self.__temp_credentials = bool(temp_credentials)
