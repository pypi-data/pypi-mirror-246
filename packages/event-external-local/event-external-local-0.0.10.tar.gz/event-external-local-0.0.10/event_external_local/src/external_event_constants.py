...
class ExternalEventLocalConstants:
    ...
    EVENT_EXTERNAL_LOCAL_PYHTON_COMPONENT_NAME = 'event-external-local-python-package'  # noqa: E501
    ...
    # TODO In the case you use non-ML Table, please replace <entity> i.e. country  # noqa: E501
