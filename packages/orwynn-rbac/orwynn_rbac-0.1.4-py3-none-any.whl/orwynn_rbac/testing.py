...
DefaultRoles: list[DefaultRole] = [
    DefaultRole(
        ...
        permission_names=[
            ...
            "slimebones.orwynn-rbac.permission.permission.permissions:get",
            "slimebones.orwynn-rbac.testing.permission.item:update",
            "slimebones.orwynn-rbac.testing.permission.buy-item:do",
            "slimebones.orwynn-rbac.role.permission.role:get",
            ...
            "slimebones.orwynn-rbac.role.permission.role:delete",
