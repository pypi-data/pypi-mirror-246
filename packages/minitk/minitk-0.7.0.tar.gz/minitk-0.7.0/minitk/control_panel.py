...
class ControlPanel(tk.Frame):
    ...
    def create_button(self, name:str, callback:Optional[Callable[[],None]]=None, hotkey:str=None, column:int=0):
    ...
    def create_check_button(self, name:str, default:bool=False, callback:Optional[Callable[[bool],None]]=None, hotkey:str=None, column:int=0):
    ...
    def create_menu(self, name:str, choices:list[T], callback:Optional[Callable[[T],None]]=None, column:int=0):
    ...
    def create_scrollmenu(self, name:str, choices:list[T], callback:Optional[Callable[[T],None]]=None, column:int=0):

        self.__set_widget_position(tk.Label(self, text=name), column)

        self.widgets[name] = ttk.Combobox(self, textvariable=tk.StringVar(self))
    ...
    def create_slider(self, name:str, start:float=0.0, end:float=1.0, step:float=0.01, default:float=None, show_value:bool=True, callback:Optional[Callable[[float],None]]=None, column:int=0):
