...
class Deck(google.protobuf.message.Message):
    ...
    class Filtered(google.protobuf.message.Message):
        ...
        PREVIEW_AGAIN_MINS_FIELD_NUMBER: builtins.int
        PREVIEW_HARD_MINS_FIELD_NUMBER: builtins.int
        PREVIEW_GOOD_MINS_FIELD_NUMBER: builtins.int
        ...
        def delays(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]:
            """v1 scheduler only"""
        preview_again_mins: builtins.int
        """v2 scheduler only"""
        preview_hard_mins: builtins.int
        """recent v3 scheduler only; 0 means card will be returned"""
        preview_good_mins: builtins.int
        """recent v3 scheduler only; 0 means card will be returned"""
        def __init__(
            self,
            *,
        ...
        def ClearField(self, field_name: typing_extensions.Literal["delays", b"delays", "preview_again_mins", b"preview_again_mins", "preview_good_mins", b"preview_good_mins", "preview_hard_mins", b"preview_hard_mins", "reschedule", b"reschedule", "search_terms", b"search_terms"]) -> None: ...
