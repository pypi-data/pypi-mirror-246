...
translations = {
    "fr": {
        ...
        "Access to WIMS API Denied. Check if the bearer token is passed for Authorization or has expired.": "Accès à l'API WIMS refusé. Vérifiez si le jeton du porteur est passé pour l'autorisation ou a expiré.",
        ...
        "Welcome to WIMS API": "Bienvenue dans l'API WIMS",
    ...
    "zh-CN": {
        ...
        "Access to WIMS API Denied. Check if the bearer token is passed for Authorization or has expired.": "拒绝访问 N API。检查不记名令牌是否已通过授权或已过期。",
        "Authorization error": "授权错误",
        "Permission denied": "“没有权限",
        "Invalid application request passed": "通过了无效的应用程序请求",
        "Invalid Request Object Passed": "传递的请求对象无效",
        "Welcome to WIMS API": "欢迎使用 WIMS API",
    ...
    "bg": {
        ...
        "Access to WIMS API Denied. Check if the bearer token is passed for Authorization or has expired.": "Достъпът до API на WIMS е отказан. Проверете дали токенът на носител е предаден за оторизация или е изтекъл.",
        ...
        "Welcome to WIMS API": "Добре дошли в API на WIMS",
    ...
    "pt": {
        ...
        "Access to WIMS API Denied. Check if the bearer token is passed for Authorization or has expired.": "Acesso negado à API do WIMS. Verifique se o token do portador foi aprovado para autorização ou expirou.",
        ...
        "Welcome to WIMS API": "Bem-vindo à API do WIMS",
    ...
    "de": {
        ...
        "Access to WIMS API Denied. Check if the bearer token is passed for Authorization or has expired.": "Zugriff auf die wims-API verweigert. Überprüfen Sie, ob das Bearer-Token für die Autorisierung übergeben wurde oder abgelaufen ist.",
        ...
        "Welcome to WIMS API": "Willkommen bei der WIMS-API",
