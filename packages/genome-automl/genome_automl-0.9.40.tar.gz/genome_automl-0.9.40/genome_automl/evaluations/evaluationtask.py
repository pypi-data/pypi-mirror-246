...
from ..core.base_entity import BaseRef, CodeRef, DataRef, BaseMetric, TaskArtifact
...
class GenomeTask():
    ...
    def __init__(self, name=None, dataset=None, segment=None, proto=None, message=None):
        self.name = name
