...
from .evaluationstore import EvaluationArtifact
...
def task(name="", dataset=None, segment=None, message=None):
    """
    ...
    def deco_task(func):
        ...
        def wrapper_task(*args, **kwargs):
            ...
            task = GenomeTask(name=task_name, dataset=data, segment=segment, message=message)
