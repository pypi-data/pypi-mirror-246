...
parser.add_argument("-i", "--input", type=str, default=None, help="Input file to send to the API", widget="FileChooser")
parser.add_argument("-o", "--output", type=str, default=None, help="Output file to save the result", widget="FileChooser")

parser.add_argument("-f", "--folder", type=bool, default=False, help="Folder mode", widget="DirChooser")
