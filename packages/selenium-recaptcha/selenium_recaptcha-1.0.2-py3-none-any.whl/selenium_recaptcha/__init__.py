...
class Recaptcha_Solver:
    ...
    def click_checkbox(s):
        ...
        find_until_clicklable(s.d, By.ID, "recaptcha-anchor-label").click()
    ...
    def request_audio_version(s):
        ...
        find_until_clicklable(s.d, By.ID, "recaptcha-audio-button").click()
    ...
    def solve_audio_captcha(s):
        ...
        find_until_clicklable(s.d, By.ID, "recaptcha-verify-button").click()
    ...
    def check_blocking(s):
        try:
            ...
            s.d.switch_to.default_content()
            raise Exception('Unknown Error. Read the traceback above ^')
        s.d.switch_to.default_content()
