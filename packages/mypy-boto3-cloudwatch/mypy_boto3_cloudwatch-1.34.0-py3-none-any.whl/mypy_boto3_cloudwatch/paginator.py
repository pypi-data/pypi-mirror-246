...
class DescribeAlarmsPaginator(Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        ActionPrefix: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> _PageIterator[DescribeAlarmsOutputPaginatorTypeDef]:
        """
...
class DescribeAnomalyDetectorsPaginator(Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> _PageIterator[DescribeAnomalyDetectorsOutputPaginatorTypeDef]:
        """
...
class ListMetricsPaginator(Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        OwningAccount: str = ...,
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> _PageIterator[ListMetricsOutputPaginatorTypeDef]:
        """
