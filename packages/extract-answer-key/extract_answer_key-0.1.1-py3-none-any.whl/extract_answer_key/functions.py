...
# Usage example
filename = "main.tex"
item_dict = process_file(filename)
answer_key_dict = process_answer_key(item_dict)
contents = open(filename, "r").read()
second_dict = process_second_enumerate(contents)
generate_answer_key(answer_key_dict, second_dict)
