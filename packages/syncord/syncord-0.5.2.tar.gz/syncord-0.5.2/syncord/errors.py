...
class syncordException(Exception):
    """Base exception class for all syncord exceptions."""


class ConvertTimeError(syncordException):
    """Raised when a time conversion fails."""


class Blacklisted(syncordException):
