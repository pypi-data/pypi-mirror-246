...
class Bot(_main_bot):  # type: ignore
    """The syncord bot class. This is a subclass of :class:`discord.Bot` if you use Pycord.
    ...
    **kwargs:
    ...
    def add_help_command(
        ...
        *,
        ...
        if not DPY:
            self.load_extension("syncord.cogs.pyc.help_setup", package="syncord")
    ...
    def add_status_changer(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("syncord.cogs.pyc.status_changer_setup", package="syncord")
    ...
    def add_blacklist(
        ...
        *,
        ...
        SyConfig.blacklist = Blacklist(
            db_path,
            db_name,
            raise_error,
            owner_only,
        )
        SyConfig.admin_guilds = admin_server_ids

        self.enabled_extensions.append("blacklist")
        if not DPY:
            self.load_extension("syncord.cogs.pyc.blacklist_setup", package="syncord")
    ...
    async def setup_hook(self):
        ...
        for ext in self.enabled_extensions:
            await self.load_extension(f".cogs.dpy.{ext}_setup", package="syncord")
...
class PrefixBot(Bot, commands.Bot):
    ...
    This class can be used if you want to use syncord with prefix commands.
...
class BridgeBot(Bot, bridge.Bot):
    ...
    This class can be used if you want to use syncord with bridge commands.
    This is only needed for Pycord.
    """
