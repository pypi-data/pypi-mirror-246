...
def bm_trans(TFName,Method_name,Groundtruth,Infer_trans,filetype):
    import pandas as pd
    import numpy as np
...
# Display the plot in the notebook
    plt.savefig("trans_roc_curve"+TFName+".png", format='png', bbox_inches='tight')
    plt.show()
    plt.close()
...
# Calculate precision and recall values
    ...
    plt.savefig("trans_pr_curve"+TFName+".png", format='png', bbox_inches='tight')
    plt.show()
    plt.close()