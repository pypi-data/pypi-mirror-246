...
def bm_trans(TFName,Method_name,Groundtruth,Infer_trans,outdir):
    import pandas as pd
    import numpy as np
...
# Display the plot in the notebook
    plt.savefig(outdir+"trans_roc_curve"+TFName+".pdf", format='pdf', bbox_inches='tight')
    plt.show()
    plt.close()
...
# Calculate precision and recall values
    ...
    plt.savefig(outdir+"trans_pr_curve"+TFName+".pdf", format='pdf', bbox_inches='tight')
    plt.show()
    plt.close()
