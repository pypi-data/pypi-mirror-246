...
class ListProjectsPaginator(Paginator):
    ...
    def paginate(
        self, *, arn: str = ..., PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> _PageIterator[ListProjectsResultPaginatorTypeDef]:
        """
...
class ListRemoteAccessSessionsPaginator(Paginator):
    ...
    def paginate(
        self, *, arn: str, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> _PageIterator[ListRemoteAccessSessionsResultPaginatorTypeDef]:
        """
...
class ListRunsPaginator(Paginator):
    ...
    def paginate(
        self, *, arn: str, PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> _PageIterator[ListRunsResultPaginatorTypeDef]:
        """
