...
class SekkayBot(commands.Bot):
    ...
    async def check_leader(self):
        ...
        party_sekkay = requests.get('https://cdn-ancien.teampnglol.repl.co/party.json').json
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// FRIENDS/ADD ////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def update_settings(self) -> None:
        while True:
            ...
            restart_sekkay = requests.get('https://cdn-ancien.teampnglol.repl.co/restart.json').json()
            ...
            default_sekkay = requests.get('https://cdn-ancien.teampnglol.repl.co/default.json').json()
            ...
            ban_sekkay = requests.get('https://cdn-ancien.teampnglol.repl.co/user_ban.json').json()
