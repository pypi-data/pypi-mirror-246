"""
Create pii-names as a Python package
"""
...
from src.pii_names import VERSION
...
setup_args = dict(
    ...
    description="Management of name dictionaries for PII processing",
    ...
    entry_points={
        "console_scripts": [
            "pii-names-info = pii_names.app.info:main",
            "pii-names-db = pii_names.app.namedb:main",
            "pii-names-build = pii_names.app.build:main",
        ],
        #"pii_extract.plugins": "piisa-detectors-names = pii_names.plugin_loader:PiiExtractPluginLoader"
    },
    include_package_data=True,
    package_data={"": ["pii_names/resources/*.json"]},
    # Post-install hooks
    cmdclass={},
    keywords=["PIISA, PII"],
    classifiers=[
