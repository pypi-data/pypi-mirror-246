...
class DtFnAccessor(BaseFnAccessor):
    ...
    def strftime(self, fmt: str = 'YYYY-MM-DDTHH:MM:SS.SSS', *args: str) -> Column:
        ...
        Args:
            fmt (Optional[str]): the format to use when converting to string. Defaults to "YYYY-MM-DDTHH:MM:SS.SSS"
