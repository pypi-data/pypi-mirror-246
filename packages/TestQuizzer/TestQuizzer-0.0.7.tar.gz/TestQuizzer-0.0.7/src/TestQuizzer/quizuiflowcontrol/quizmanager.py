...
import datetime
import glob
from TestQuizzer.quizutils.quizparser import JSONQuizParser
...
class QuizManager:
    ...
    def _build_quiz_list(self):
        ...
        """
        pattern = os.path.join('TestQuizzer', self.quizfolder, '*.json')
    ...
    def save_results(self):
        ...
        path_cur = os.getcwd()
        path_result = os.path.join(path_cur, 'TestQuizzer', 'db_results', filename)
