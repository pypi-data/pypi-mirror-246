...
def makeRows(rows, cols, largestElementLength, rowLength, matrixToWorkOn, finalTable, color):
    ...
    for i in range(rows):
        ...
        for j in range(cols):
            ...
            if ((color != (300,300,300)) and (j == 0 or i == 0)):
...
def printTable(matrix, useFieldNames=False, color="None"):
    ...
    base_colours={"None":(300,300,300),"red":(255,0,0),"blue":(0,0,255),"orange":(255,165,0),"cyan":(0,100,100),"pink":(255,192,203),"green":(0,255,0),"yellow":(255,255,0),"white":(255,255,255)}
    color=base_colours[color]
