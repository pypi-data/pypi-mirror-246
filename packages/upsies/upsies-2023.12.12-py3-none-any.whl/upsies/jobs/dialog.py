...
class ChoiceJob(JobBase):
    ...
    def initialize(self, *, name, label, options, focused=None, autodetected=None,
    ...
    async def run(self):
        ...
        # Wait for make_choice() getting called. If it was already called,
        # finalization() will return immediately.
