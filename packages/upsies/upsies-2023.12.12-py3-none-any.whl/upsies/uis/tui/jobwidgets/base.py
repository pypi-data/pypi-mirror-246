...
from prompt_toolkit.layout.containers import ConditionalContainer, HSplit, Window, to_container
...
class JobWidgetBase(abc.ABC):
        ...
        main_widget = HSplit(
            children=[
                ...
                ConditionalContainer(
                    ...
                    content=self._runtime_widget or self._no_runtime_widget,
                ),
                # Result
                ConditionalContainer(
    ...
    def _runtime_widget(self):
        runtime_widget = self.runtime_widget
        if runtime_widget:
            container = to_container(runtime_widget)
