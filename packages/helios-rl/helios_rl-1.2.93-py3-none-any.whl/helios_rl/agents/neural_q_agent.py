...
# Hyper Parameters
TARGET_REPLACE_ITER = 10   # target update frequency #TODO: ADD TO CONFIG
...
class DQN:
    ...
    def choose_action(self, state_enc: Tensor, legal_actions: List[str]) -> str:
        ...
        if rng < self.epsilon:
            ...
            with torch.no_grad():
                ...
                print("\n --- ")
                print(max(list_value_legal_moves, key=lambda e: e[1]))
    ...
    def learn(self, batch_size: int = 1):
        #TODO: ADD batch_size TO CONFIG
        #TODO: FIX BATCH SIZE FOR > 1
