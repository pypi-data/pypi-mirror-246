...
class BuildDockerRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["auth_credentials", b"auth_credentials"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["auth_credentials", b"auth_credentials", "build_path", b"build_path", "code", b"code", "description", b"description", "labels", b"labels", "name", b"name", "project_id", b"project_id", "repository", b"repository", "tag", b"tag", "template_name", b"template_name"]) -> None: ...
...
class BuildDockerCredentials(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["password_secret_id", b"password_secret_id", "username", b"username"]) -> None: ...
...
class BuildDockerResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["docker_id", b"docker_id"]) -> None: ...
...
class BuildDockerLogsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["docker_id", b"docker_id", "page_token", b"page_token"]) -> None: ...
...
class BuildDockerLogsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["logs", b"logs", "page_token", b"page_token"]) -> None: ...
...
class CreateDockerRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["build_path", b"build_path", "code", b"code", "description", b"description", "labels", b"labels", "name", b"name", "project_id", b"project_id", "repository", b"repository", "tag", b"tag", "template_name", b"template_name"]) -> None: ...
...
class UpdateDockerStatusRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["docker_id", b"docker_id", "status", b"status"]) -> None: ...
...
class ActivateDockerRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["docker_id", b"docker_id", "project_id", b"project_id"]) -> None: ...
...
class GetDockerActivationStatusResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["status", b"status", "status_active", b"status_active", "status_inactive", b"status_inactive"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["status", b"status", "status_active", b"status_active", "status_inactive", b"status_inactive"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["status", b"status"]) -> typing_extensions.Literal["status_active", "status_inactive"] | None: ...
