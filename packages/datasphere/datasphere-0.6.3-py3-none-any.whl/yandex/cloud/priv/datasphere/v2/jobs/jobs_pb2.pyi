...
class JobParameters(google.protobuf.message.Message):
    ...
    CLOUD_INSTANCE_TYPE_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def cloud_instance_type(self) -> global___CloudInstanceType: ...
    def __init__(
        self,
        *,
        ...
        attach_project_disk: builtins.bool = ...,
        cloud_instance_type: global___CloudInstanceType | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["cloud_instance_type", b"cloud_instance_type", "env", b"env"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attach_project_disk", b"attach_project_disk", "cloud_instance_type", b"cloud_instance_type", "cmd", b"cmd", "dataset_ids", b"dataset_ids", "env", b"env", "input_files", b"input_files", "output_files", b"output_files", "s3_mount_ids", b"s3_mount_ids"]) -> None: ...
...
class File(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["desc", b"desc", "sha256", b"sha256", "size_bytes", b"size_bytes"]) -> None: ...
...
class Environment(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["docker_image", b"docker_image", "docker_image_resource_id", b"docker_image_resource_id", "docker_image_spec", b"docker_image_spec", "python_env", b"python_env"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["docker_image", b"docker_image", "docker_image_resource_id", b"docker_image_resource_id", "docker_image_spec", b"docker_image_spec", "python_env", b"python_env", "vars", b"vars"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["docker_image", b"docker_image"]) -> typing_extensions.Literal["docker_image_resource_id", "docker_image_spec"] | None: ...
...
class Job(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "data_expires_at", b"data_expires_at", "finished_at", b"finished_at", "job_parameters", b"job_parameters"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["config", b"config", "created_at", b"created_at", "created_by_id", b"created_by_id", "data_cleared", b"data_cleared", "data_expires_at", b"data_expires_at", "data_size_bytes", b"data_size_bytes", "description", b"description", "diagnostic_files", b"diagnostic_files", "finished_at", b"finished_at", "id", b"id", "job_parameters", b"job_parameters", "log_files", b"log_files", "name", b"name", "output_files", b"output_files", "project_id", b"project_id", "status", b"status"]) -> None: ...
