...
class CreateProjectRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["community_id", b"community_id", "description", b"description", "labels", b"labels", "limits", b"limits", "name", b"name", "settings", b"settings"]) -> None: ...
...
class OpenProjectResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["project_url", b"project_url", "session_token", b"session_token"]) -> None: ...
