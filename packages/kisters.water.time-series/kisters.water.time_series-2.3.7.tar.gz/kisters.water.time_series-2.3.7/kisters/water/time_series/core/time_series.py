...
from .schema import CommentSupport, EnsembleMember, TimeSeriesColumn, TimeSeriesComment, TimeSeriesMetadata
...
class TimeSeries:
    ...
    def __init__(
        ...
        if isinstance(metadata, TimeSeriesMetadata):
            ...
            self._metadata = TimeSeriesMetadata.parse_obj(metadata)
        self._client = client
        self._coverages: dict[EnsembleMember, tuple[datetime.datetime, datetime.datetime]] = {}
    ...
    def metadata(self) -> dict[str, Any]:
        ...
        """
        return self._metadata.dict(by_alias=True)
    ...
    @property
    def columns(self) -> list[TimeSeriesColumn]:
    ...
    def update_metadata(self, metadata: dict[str, Any] | TimeSeriesMetadata) -> None:
        ...
        """
        self._client.run_sync(self._client.update_time_series, path=self.path, metadata=metadata)
        self._metadata = self._client.run_sync(self._client.read_time_series, path=self.path)._metadata
