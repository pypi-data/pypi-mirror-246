...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_ARESUBACCOUNTSLIQUIDATABLEREQUEST'].fields_by_name['subaccount_ids']._options = None
  _globals['_ARESUBACCOUNTSLIQUIDATABLEREQUEST'].fields_by_name['subaccount_ids']._serialized_options = b'\310\336\037\000'
  _globals['_ARESUBACCOUNTSLIQUIDATABLERESPONSE_RESULT'].fields_by_name['subaccount_id']._options = None
  _globals['_ARESUBACCOUNTSLIQUIDATABLERESPONSE_RESULT'].fields_by_name['subaccount_id']._serialized_options = b'\310\336\037\000'
  _globals['_ARESUBACCOUNTSLIQUIDATABLERESPONSE'].fields_by_name['results']._options = None
  _globals['_ARESUBACCOUNTSLIQUIDATABLERESPONSE'].fields_by_name['results']._serialized_options = b'\310\336\037\000'
