...
from ..._tools import PRICING_DATETIME_PATTERN, cached_property, create_repr, convert_df_columns_to_datetime_re
...
class Stream(StreamOpenWithUpdatesMixin):
    ...
    def add_instruments(self, instruments):
        ...
        """
        instruments = _init_universe(instruments, self._session)
    ...
    def __getitem__(self, item) -> "UniverseStreamFacade":
        return self._stream.__getitem__(get_valid_symbol(item, self._uuid))
