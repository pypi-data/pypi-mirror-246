...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only materials from that model can be picked.
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only materials from that model can be selected.
            If the argument is a Flag then only materials that
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        redraw : boolean
            If model should be redrawn or not after the materials are sketched.
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        model : Model
            Model that all materials will be unblanked in
        redraw : boolean
            If model should be redrawn or not after the materials are unsketched.
...
# Instance methods
    ...
    def Keyword(self, index=Oasys.gRPC.defaultArg):
        ...
        ----------
        index : integer
            If this argument is not given then the material keyword is returned as normal.
    ...
    def KeywordCards(self, index=Oasys.gRPC.defaultArg):
        ...
        ----------
        index : integer
            If this argument is not given then the material keyword cards are returned as normal.
            However if the material also has \*MAT_ADD_xxxx cards defined for it (e.g. \*MAT_ADD_EROSION) then the index can be
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the material is sketched.
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the material is unsketched.
