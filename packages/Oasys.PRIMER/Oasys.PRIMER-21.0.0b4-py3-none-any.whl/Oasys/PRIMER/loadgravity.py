...
# Constructor
    def __init__(self, model, type, pid, dof, lc, accel, lcdr, stga=Oasys.gRPC.defaultArg, stgr=Oasys.gRPC.defaultArg):
        ...
        stga : integer
            Construction Stage ID at which part is added (optional)
        stgr : integer
            Construction Stage ID at which part is removed (optional)
...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only load gravitys from that model can be picked.
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only load gravitys from that model can be selected.
            If the argument is a Flag then only load gravitys that
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        redraw : boolean
            If model should be redrawn or not after the load gravitys are sketched.
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        model : Model
            Model that all load gravitys will be unblanked in
        redraw : boolean
            If model should be redrawn or not after the load gravitys are unsketched.
...
# Instance methods
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the load gravity is sketched.
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the load gravity is unsketched.
