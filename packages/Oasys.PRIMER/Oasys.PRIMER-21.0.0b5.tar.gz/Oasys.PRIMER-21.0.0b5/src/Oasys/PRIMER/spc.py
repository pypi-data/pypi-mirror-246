...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only boundary SPCs from that model can be picked.
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only boundary SPCs from that model can be selected.
            If the argument is a Flag then only boundary SPCs that
...
# Instance methods
    ...
    def Sketch(self, type, redraw=Oasys.gRPC.defaultArg):
        ...
        type : constant
            ...
            Spc.ROTATIONAL
        redraw : boolean
            If set to true (or omitted) the plot will be redrawn each time.
