...
# Static methods
    ...
    def Read(filename, filetype=Oasys.gRPC.defaultArg, number=Oasys.gRPC.defaultArg):
        ...
        filetype : constant
            Filetype you want to read. Can be Model.LSDYNA,
            Model.ABAQUS,
            Model.NASTRAN,
            Model.RADIOSS or
            Model.IGES.
...
# Instance methods
    ...
    def Check(self, filename, detailed=Oasys.gRPC.defaultArg, json=Oasys.gRPC.defaultArg, include=Oasys.gRPC.defaultArg):
        ...
        json : boolean
            If set, output in filename will be written in JSON format. If omitted json will be set to false.
        ...
        include : boolean
            If set, error messages will be written in include by include layout. 
    ...
    def Copy(self, update=Oasys.gRPC.defaultArg):
        ...
        ----------
        update : boolean
            If the graphics should be updated after the model is copied.
    ...
    def DeleteFlagged(self, flag, recursive=Oasys.gRPC.defaultArg):
        ...
        recursive : boolean
            If deletion is recursive (for example, if a shell is deleted with recursion on the shell nodes will be deleted if possible).
    ...
    def DeleteInclude(self, _py_class_include__label, method=Oasys.gRPC.defaultArg, force=Oasys.gRPC.defaultArg):
        ...
        force : boolean
            Forcible deletion option (for example, a node is deleted even when it is referenced by a shell
    ...
    def RenumberFlagged(self, flag, start, mode=Oasys.gRPC.defaultArg):
        ...
        start : integer
            Start point for renumbering
        mode : constant
            Renumber mode. Can be Model.IGNORE_CLASH,
            Model.MOVE_CLASH_UP,
    ...
    def UnsketchAll(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the items are unsketched.
    ...
    def Write(self, filename, options=Oasys.gRPC.defaultArg):
        ...
        options : dict
            Options specifying how the file should be written out. If omitted the default values below will be used.
