...
# Constructor
    def __init__(self, model, eid, pid, n1, n2, n3, n4, n5=Oasys.gRPC.defaultArg, n6=Oasys.gRPC.defaultArg, n7=Oasys.gRPC.defaultArg, n8=Oasys.gRPC.defaultArg, n9=Oasys.gRPC.defaultArg, n10=Oasys.gRPC.defaultArg, n11=Oasys.gRPC.defaultArg, n12=Oasys.gRPC.defaultArg, n13=Oasys.gRPC.defaultArg, n14=Oasys.gRPC.defaultArg, n15=Oasys.gRPC.defaultArg, n16=Oasys.gRPC.defaultArg, n17=Oasys.gRPC.defaultArg, n18=Oasys.gRPC.defaultArg, n19=Oasys.gRPC.defaultArg, n20=Oasys.gRPC.defaultArg, n21=Oasys.gRPC.defaultArg, n22=Oasys.gRPC.defaultArg, n23=Oasys.gRPC.defaultArg, n24=Oasys.gRPC.defaultArg, n25=Oasys.gRPC.defaultArg, n26=Oasys.gRPC.defaultArg, n27=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, eid, pid, n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16, n17, n18, n19, n20, n21, n22, n23, n24, n25, n26, n27)
        Oasys.gRPC.OasysItem.__init__(self, self.__class__.__name__, handle)
        """
        Create a new Solid object. Use either 4, 6, 8 or 10 nodes when
...
# Static methods
    def BlankAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        redraw : boolean
            If model should be redrawn or not.
    ...
    def Create(model, modal=Oasys.gRPC.defaultArg):
        ...
        modal : boolean
            If this window is modal (blocks the user from doing anything else in PRIMER
    ...
    def FindSolidInBox(model, xmin, xmax, ymin, ymax, zmin, zmax, flag=Oasys.gRPC.defaultArg, excl=Oasys.gRPC.defaultArg, vis_only=Oasys.gRPC.defaultArg):
        ...
        excl : integer
            Optional flag ( 0) Apply inclusive selection
    ...
    def FirstFreeLabel(model, layer=Oasys.gRPC.defaultArg):
        ...
        layer : Include number
            Include file (0 for the main file) to search for labels in (Equivalent to
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only solids from that model can be picked.
            If the argument is a Flag then only solids that
            are flagged with limit can be selected.
            If omitted, or None, any solids from any model can be selected.
            from any model
        modal : boolean
            If picking is modal (blocks the user from doing anything else in PRIMER
            until this window is dismissed). If omitted the pick will be modal
        button_text : string
            By default the window with the prompt will have a button labelled 'Cancel'
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only solids from that model can be selected.
            If the argument is a Flag then only solids that
            are flagged with limit can be selected (limit should be different to flag).
            If omitted, or None, any solids can be selected.
            from any model
        modal : boolean
            If selection is modal (blocks the user from doing anything else in PRIMER
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        redraw : boolean
            If model should be redrawn or not after the solids are sketched.
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        model : Model
            Model that all solids will be unblanked in
        redraw : boolean
            If model should be redrawn or not after the solids are unsketched.
...
# Instance methods
    ...
    def Copy(self, range=Oasys.gRPC.defaultArg):
        ...
        ----------
        range : boolean
            If you want to keep the copied item in the range specified for the current include. Default value is false.
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the solid is sketched.
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the solid is unsketched.
