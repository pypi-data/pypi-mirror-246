...
# Static methods
    def BlankAll(model, type=Oasys.gRPC.defaultArg, redraw=Oasys.gRPC.defaultArg):
        ...
        type : constant
            Type of sets to blank. Can be Set.BEAM,
            Set.BOX,
            Set.DISCRETE,
            Set.MM_GROUP,
            Set.NODE,
    ...
    def Pick(type, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only sets from that model can be picked.
    ...
    def RenumberAll(model, start, type=Oasys.gRPC.defaultArg):
        ...
        type : constant
            Type of sets to renumber. Can be Set.BEAM,
            Set.BOX
            Set.DISCRETE,
            Set.MM_GROUP,
            Set.MODE,
    ...
    def Select(type, flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only sets from that model can be selected.
            If the argument is a Flag then only sets that
    ...
    def SketchFlagged(model, flag, type=Oasys.gRPC.defaultArg, redraw=Oasys.gRPC.defaultArg):
        ...
        type : constant
            Type of sets to sketch. Can be Set.BEAM,
            Set.BOX
            Set.DISCRETE,
            Set.MM_GROUP,
            Set.NODE,
    ...
    def UnblankAll(model, type=Oasys.gRPC.defaultArg, redraw=Oasys.gRPC.defaultArg):
        ...
        type : constant
            Type of sets to unblank. Can be Set.BEAM,
            Set.BOX
            Set.DISCRETE,
            Set.MM_GROUP,
            Set.NODE,
    ...
    def UnsketchAll(model, type=Oasys.gRPC.defaultArg, redraw=Oasys.gRPC.defaultArg):
        ...
        type : constant
            Type of sets to unsketch. Can be Set.BEAM,
            Set.BOX
            Set.DISCRETE,
            Set.MM_GROUP,
            Set.NODE,
        ...
        redraw : boolean
            If model should be redrawn or not after the sets are unsketched.
...
# Instance methods
    ...
    def Copy(self, range=Oasys.gRPC.defaultArg):
        ...
        ----------
        range : boolean
            If you want to keep the copied item in the range specified for the current include. 
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the set is sketched.
    ...
    def StartSpool(self, raw=Oasys.gRPC.defaultArg):
        ...
        ----------
        raw : boolean
            If true then the raw data from _GENERATE, _ADD and _INTERSECT sets will be returned instead of expanding the
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the set is unsketched.
