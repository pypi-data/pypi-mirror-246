...
# Constructor
    def __init__(self, model, format, lcid, nid, dof, coeff, cid):
...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only constrained linears from that model can be picked.
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only constrained linears from that model can be selected.
            If the argument is a Flag then only constrained linears that
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        redraw : boolean
            If model should be redrawn or not after the constrained linears are sketched.
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        model : Model
            Model that all constrained linears will be unblanked in
        redraw : boolean
            If model should be redrawn or not after the constrained linears are unsketched.
...
# Instance methods
    def AddRowData(self, nid, dof, coeff, cid):
        """
    ...
    def SetRowData(self, row_index, nid, dof, coeff, cid):
        """
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the constrained linear is sketched.
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the constrained linear is unsketched.
