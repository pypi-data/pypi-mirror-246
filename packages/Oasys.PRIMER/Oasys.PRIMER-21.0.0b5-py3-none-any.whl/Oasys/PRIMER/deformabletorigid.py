...
# Constructor
    def __init__(self, model, type, pid=Oasys.gRPC.defaultArg, lrb=Oasys.gRPC.defaultArg, ptype=Oasys.gRPC.defaultArg):
        ...
        pid : integer
            Part  or Part set  ID which is switched to a rigid material. 
            Depends on value of ptype. 
            Used only for DeformableToRigid.SIMPLE or 
            DeformableToRigid.INERTIA
        lrb : integer
            Part ID of the lead rigid body to which the part is merged. 
            Used only for DeformableToRigid.SIMPLE
        ptype : integer
            Type of PID. Valid values are: 
...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only deformable to rigids from that model can be picked.
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only deformable to rigids from that model can be selected.
            If the argument is a Flag then only deformable to rigids that
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        redraw : boolean
            If model should be redrawn or not after the deformable to rigids are sketched.
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        model : Model
            Model that all deformable to rigids will be unblanked in
        redraw : boolean
            If model should be redrawn or not after the deformable to rigids are unsketched.
...
# Instance methods
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the deformable to rigid is sketched.
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the deformable to rigid is unsketched.
