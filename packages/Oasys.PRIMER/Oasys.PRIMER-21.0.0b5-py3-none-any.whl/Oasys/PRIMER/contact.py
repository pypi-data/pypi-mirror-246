...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only contacts from that model can be picked.
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only contacts from that model can be selected.
            If the argument is a Flag then only contacts that
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        redraw : boolean
            If model should be redrawn or not after the contacts are sketched.
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        model : Model
            Model that all contacts will be unblanked in
        redraw : boolean
            If model should be redrawn or not after the contacts are unsketched.
...
# Instance methods
    ...
    def Interactions(self, type=Oasys.gRPC.defaultArg):
        ...
        ----------
        type : constant
            What type of interactions to return. Can be bitwise code of Contact.PENETRATIONS
    ...
    def PenCheckEdit(self, modal=Oasys.gRPC.defaultArg, check_mode=Oasys.gRPC.defaultArg, mpp_threshold=Oasys.gRPC.defaultArg, report_crossed_3d_elems=Oasys.gRPC.defaultArg, contact_penchk_dup_shells=Oasys.gRPC.defaultArg):
        ...
        modal : boolean
            ...
            until this window is dismissed). If omitted the window will be modal
        check_mode : constant
            Check mode. Can be Model.MPP_MODE or
            Model.SMP_MODE.
        ...
        contact_penchk_dup_shells : constant
            Duplicate shell treatment Can be Model.SHELL_AUTO,
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the contact is sketched.
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the contact is unsketched.
