...
# Static methods
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only transformations from that model can be selected.
...
# Instance methods
    def AddRow(self, data, row=Oasys.gRPC.defaultArg):
        ...
        row : integer
            The row you want to add the data at. Existing transforms will be shifted.
