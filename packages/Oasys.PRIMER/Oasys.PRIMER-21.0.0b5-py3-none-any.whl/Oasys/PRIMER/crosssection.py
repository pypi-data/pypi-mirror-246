...
# Constructor
    def __init__(self, model, option, nsid, hsid, bsid, ssid, tsid, dsid, id=Oasys.gRPC.defaultArg, itype=Oasys.gRPC.defaultArg, csid=Oasys.gRPC.defaultArg, heading=Oasys.gRPC.defaultArg):
        ...
        dsid : integer
            Discrete set number
        id : integer
            Rigid part or accelerometer or
...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only cross sections from that model can be picked.
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only cross sections from that model can be selected.
            If the argument is a Flag then only cross sections that
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        redraw : boolean
            If model should be redrawn or not after the cross sections are sketched.
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        model : Model
            Model that all cross sections will be unblanked in
        redraw : boolean
            If model should be redrawn or not after the cross sections are unsketched.
...
# Instance methods
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the cross section is sketched.
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the cross section is unsketched.
