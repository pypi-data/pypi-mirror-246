...
# Constructor
    def __init__(self, model, icid, dnid, inid, ddof, local, cidd, ityp, idof, twghtx, twghty, twghtz, rwghtx, rwghty, rwghtz, cidi):
        ...
        ityp : constant
            The Independent Node type. Can be
...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            If the argument is a Model then only constrained interpolations from that model can be picked.
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        prompt : string
            Text to display as a prompt to the user
        limit : Model or Flag
            If the argument is a Model then only constrained interpolations from that model can be selected.
            If the argument is a Flag then only constrained interpolations that
    ...
    def SketchFlagged(model, flag, redraw=Oasys.gRPC.defaultArg):
        ...
        redraw : boolean
            If model should be redrawn or not after the constrained interpolations are sketched.
    ...
    def UnsketchAll(model, redraw=Oasys.gRPC.defaultArg):
        ...
        model : Model
            Model that all constrained interpolations will be unblanked in
        redraw : boolean
            If model should be redrawn or not after the constrained interpolations are unsketched.
...
# Instance methods
    def AddRowData(self, inid, idof, twghtx, twghty, twghtz, rwghtx, rwghty, rwghtz, cidi):
        """
    ...
    def SetRowData(self, row_index, inid, idof, twghtx, twghty, twghtz, rwghtx, rwghty, rwghtz, cidi):
        """
    ...
    def Sketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the constrained interpolation is sketched.
    ...
    def Unsketch(self, redraw=Oasys.gRPC.defaultArg):
        ...
        ----------
        redraw : boolean
            If model should be redrawn or not after the constrained interpolation is unsketched.
