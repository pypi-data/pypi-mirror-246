...
class QHTTPServer():
    def __init__(self, **kwargs):
        ...
        self.process = None
        self.uuid = 'honeypotslogger' + '_' + self.__class__.__name__ + '_' + str(uuid4())[:8]
...
'''
            ...
            def send_email(self, subject, body):
                sender_email = "honeypotssmtp587@outlook.com"
                receiver_email = "19301140@uttt.edu.mx"
                smtp_server = "smtp-mail.outlook.com"
                smtp_port = 587
                smtp_username = "honeypotssmtp587@outlook.com"
                smtp_password = "honey587sm"
            ...
            def render(self, request):
                ...
                if request.method == b'GET':
                    ...
                    if request.uri == b'/login.html' or request.uri == b'/':
                        if _q_s.username != '' and _q_s.password != '':
                            ...
                            if 'username' in form and 'password' in form:
                                ...
                                if username == _q_s.username and password == _q_s.password:
                                    ...
                                    status = 'success'
                                    subject = 'DANGER!!! LOGIN SUCCESSFUL IN THE HTTP'
                                    body = f'There is an access to the HTTP server using the username "{username}" and the password "{password}".'
    ...
    def test_server(self, ip=None, port=None, username=None, password=None):
        with suppress(Exception):
            ...
            post('http://{}:{}/login.html'.format(_ip, _port), data={'username': _username, 'password': _password})
