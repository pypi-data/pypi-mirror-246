...
class PiotrFeatureExtractor(ConfigReader,
    ...
    def run(self):
        ...
        for file_cnt, file_path in enumerate(self.outlier_corrected_paths):
            ...
            data_df = read_df(file_path=file_path, file_type=self.file_type).head(100)
            ...
            if self.plot:
                GeometryPlotter(config_path=self.config_path, geometries=[white_animal_polygons, black_animal_polygons])
