...
static PyMethodDef DNJutilsMethods[] = {
        {"build", py_build, METH_VARARGS, "build"},
        {NULL, NULL,        0, NULL}
};

static struct PyModuleDef dnjutilsmodule = {
        PyModuleDef_HEAD_INIT,
        "dnjutils",           /* name of module */
        "A dnjutils module",  /* Doc string (may be NULL) */
        -1,                    /* Size of per-interpreter state or -1 */
        DNJutilsMethods       /* Method table */
};

PyMODINIT_FUNC PyInit_dnjutils(void) {
    return PyModule_Create(&dnjutilsmodule);
}