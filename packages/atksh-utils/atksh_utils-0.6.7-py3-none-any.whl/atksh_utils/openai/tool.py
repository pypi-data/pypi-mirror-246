...
def make_chunk(text: str, max_length: int, overlap_ratio: float = 0.1) -> list[str]:
    for i in range(0, len(text), int(max_length * (1 - overlap_ratio))):
    ...
    def visit_page(query_text: str, url: str) -> str:
        ...
        try:
            ...
            if "application/pdf" in content_type:
                ...
                links = (" - " + "\n - ".join(links))[: visit_page_max_context_length - len(body)]
                text = body + "\n====LINKS====\n" + links
