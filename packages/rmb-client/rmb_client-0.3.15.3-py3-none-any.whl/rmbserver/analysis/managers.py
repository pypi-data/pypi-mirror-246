...
from rmbserver.ai.prompts import PROMPT_FORMAT_AGENT_FINAL_ANSWER
...
class ChatManager:
    ...
    def answer_question(self, question: str):
        ...
        # _structure_queries = answer_json.get('structure_queries')
        # if isinstance(_structure_queries, str):
        #     answer_json['structure_queries'] = [_structure_queries]
        log.debug(f"answer_json: {answer_json}")
        answer = BIAnswer.load_from_dict(answer_json)
        log.debug(f"Loaded answer: {answer}")
