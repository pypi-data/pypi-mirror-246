...
class AbstractBrowser:
    ...
    def initiate_browser_window(self,window_name="Browser_Window",title="Abstract Browser",extra_buttons=[],section=None,event_handlers=[],exit_events=[]):
        ...
        self.window_name = self.window_mgr.add_window(window_name=window_name,title=title,layout=self.get_scan_browser_layout(section=section,extra_buttons=extra_buttons),exit_events=exit_events,**expandable())
