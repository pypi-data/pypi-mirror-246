...
async def weixin_login(app_id: str, token: str, user_profile: WxUserProfile):
    """
    小程序登录
    :param app_id: 小程序 App id
    :param token: Token值
    ...
    :return: token
    """
    return response_tools.create_json_response(weixin_mp_service.decrypt_userinfo(app_id, token, user_profile))
