    ...
    """
{
    ...
    "license": "Apache-2.0",
    "url": "https://github.com/yicr/aws-waf-ip-rate-limit-rule-group.git",
    ...
    "project_urls": {
        "Source": "https://github.com/yicr/aws-waf-ip-rate-limit-rule-group.git"
    },
    "package_dir": {
        "": "src"
    },
    ...
    "package_data": {
        "gammarer.aws_waf_ip_rate_limit_rule_group._jsii": [
            "aws-waf-ip-rate-limit-rule-group@0.3.85.jsii.tgz"
        ],
        "gammarer.aws_waf_ip_rate_limit_rule_group": [
            "py.typed"
        ]
