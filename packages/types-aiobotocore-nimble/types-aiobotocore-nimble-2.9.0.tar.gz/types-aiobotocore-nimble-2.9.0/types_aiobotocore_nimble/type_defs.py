...
ActiveDirectoryConfigurationPaginatorTypeDef = TypedDict(
    "ActiveDirectoryConfigurationPaginatorTypeDef",
    {
...
StreamConfigurationSessionStoragePaginatorTypeDef = TypedDict(
    "StreamConfigurationSessionStoragePaginatorTypeDef",
    {
...
StudioComponentConfigurationPaginatorTypeDef = TypedDict(
    "StudioComponentConfigurationPaginatorTypeDef",
    {
        "activeDirectoryConfiguration": NotRequired[ActiveDirectoryConfigurationPaginatorTypeDef],
...
StreamConfigurationPaginatorTypeDef = TypedDict(
    "StreamConfigurationPaginatorTypeDef",
    {
        ...
        "sessionPersistenceMode": NotRequired[SessionPersistenceModeType],
        "sessionStorage": NotRequired[StreamConfigurationSessionStoragePaginatorTypeDef],
        "volumeConfiguration": NotRequired[VolumeConfigurationTypeDef],
    },
)
...
StudioComponentPaginatorTypeDef = TypedDict(
    "StudioComponentPaginatorTypeDef",
    {
        "arn": NotRequired[str],
        "configuration": NotRequired[StudioComponentConfigurationPaginatorTypeDef],
        "createdAt": NotRequired[datetime],
        "createdBy": NotRequired[str],
        "description": NotRequired[str],
        "ec2SecurityGroupIds": NotRequired[List[str]],
...
LaunchProfilePaginatorTypeDef = TypedDict(
    "LaunchProfilePaginatorTypeDef",
    {
        "arn": NotRequired[str],
        "createdAt": NotRequired[datetime],
        ...
        "statusMessage": NotRequired[str],
        "streamConfiguration": NotRequired[StreamConfigurationPaginatorTypeDef],
...
ListStudioComponentsResponsePaginatorTypeDef = TypedDict(
    "ListStudioComponentsResponsePaginatorTypeDef",
    {
        "nextToken": str,
...
ListLaunchProfilesResponsePaginatorTypeDef = TypedDict(
    "ListLaunchProfilesResponsePaginatorTypeDef",
    {
