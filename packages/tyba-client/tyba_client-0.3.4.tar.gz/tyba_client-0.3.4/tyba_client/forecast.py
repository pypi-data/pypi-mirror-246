...
class Forecast(object):
    ...
    def by_vintage(self, object_name: str, product: str, vintage_start_time: datetime, vintage_end_time: datetime, forecast_type=None):
        return self.get("forecasts_by_vintage",
                        params={
                            "object_name": object_name,
                            "product": product,
