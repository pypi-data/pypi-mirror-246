...
class TransactionManifest:
    ...
    def analyze_execution(self, transaction_receipt: bytes) -> ExecutionAnalysis: ...
...
class _UniffiConverterMapStringMapTypeNonFungibleLocalIdBytes(
    _UniffiConverterRustBuffer
):
    @classmethod
    def write(cls, items, buf) -> None: ...
...
class _UniffiConverterMapTypeNonFungibleLocalIdBytes(_UniffiConverterRustBuffer):
    @classmethod
    def write(cls, items, buf) -> None: ...
    @classmethod
    def read(cls, buf): ...
