...
def test(exchangeName="", params={}):
    ...
    if "createOrder" in params and params["createOrder"]:
        ...
        try:
            resp = ttxtExchange.create_order(symbol=tickerToTest, type="limit", amount=0.001, side="buy", price=42033.08)
...
if __name__ == "__main__":
    ...
    testingParams = {"ticker": False, "balance": True, "createOrder": False, "fetchOrder": False, 
                     "cancelOrder": False, "fetchOpenOrders": False, "setLeverage": False}
