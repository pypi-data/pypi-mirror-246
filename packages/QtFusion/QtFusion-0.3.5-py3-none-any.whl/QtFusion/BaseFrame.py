...
from .QfConfig import QF_Config
...
def loadYamlSettings(window, yaml_file, base_path="./"):
    """
    Load settings for a QMainWindow from a YAML file and apply them to the specified window.

    Args:
        window (QMainWindow): The main window where the settings will be applied.
