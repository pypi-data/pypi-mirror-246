    ...
    def update_messages_with_identifier_key(cls, df, item_id):
        try:
            ...
            for identifier_data in identifiers:
                ...
                # if identifier_data.gnb_cu_ue_f1ap_id != 'nan' and identifier_data.gnb_du_ue_f1ap_id == 'nan':
                # filter_conditions |= (filtered_df['f1ap.GNB_DU_UE_F1AP_ID'] == identifier_data.gnb_du_ue_f1ap_id) &
                # ( filtered_df['f1ap.GNB_CU_UE_F1AP_ID'].isna())

                updated_messages = filtered_df[filter_conditions].copy()
