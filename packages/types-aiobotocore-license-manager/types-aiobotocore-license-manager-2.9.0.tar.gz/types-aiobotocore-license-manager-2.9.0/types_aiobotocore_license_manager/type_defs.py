...
ProductInformationFilterPaginatorTypeDef = TypedDict(
    "ProductInformationFilterPaginatorTypeDef",
    {
...
ProductInformationPaginatorTypeDef = TypedDict(
    "ProductInformationPaginatorTypeDef",
    {
        "ResourceType": str,
...
LicenseConfigurationPaginatorTypeDef = TypedDict(
    "LicenseConfigurationPaginatorTypeDef",
    {
        ...
        "ProductInformationList": NotRequired[List[ProductInformationPaginatorTypeDef]],
...
ListLicenseConfigurationsResponsePaginatorTypeDef = TypedDict(
    "ListLicenseConfigurationsResponsePaginatorTypeDef",
    {
