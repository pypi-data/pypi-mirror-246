...
def get_target_str(hook_config: dict) -> Union[str, None]:
...
def get_target(target_str: Union[str, None]) -> tuple[int, int]:
    if target_str is None:
...
def pdm_build_initialize(context: Context, target_str: Union[str, None]) -> None:
