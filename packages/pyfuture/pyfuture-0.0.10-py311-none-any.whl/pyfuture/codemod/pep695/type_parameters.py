...
class TransformTypeParametersCommand(VisitorBasedCodemodCommand):
    ...
    def remove_type_parameters(
        self, node: __TransformTypeParametersCommand_remove_type_parameters_T, prefix: str = "", suffix: str = ""
    ) -> tuple[list[SimpleStatementLine], __TransformTypeParametersCommand_remove_type_parameters_T]:
