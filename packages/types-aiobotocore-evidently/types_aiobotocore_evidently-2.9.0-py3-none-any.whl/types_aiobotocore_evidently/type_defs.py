...
SegmentOverridePaginatorTypeDef = TypedDict(
    "SegmentOverridePaginatorTypeDef",
    {
        "evaluationOrder": int,
        "segment": str,
...
ScheduledSplitTypeDef = TypedDict(
    "ScheduledSplitTypeDef",
    {
        ...
        "segmentOverrides": NotRequired[List[SegmentOverrideTypeDef]],
    },
)
ScheduledSplitPaginatorTypeDef = TypedDict(
    "ScheduledSplitPaginatorTypeDef",
    {
        "startTime": datetime,
        "groupWeights": NotRequired[Dict[str, int]],
        "segmentOverrides": NotRequired[List[SegmentOverridePaginatorTypeDef]],
    },
)
...
ScheduledSplitsLaunchDefinitionPaginatorTypeDef = TypedDict(
    "ScheduledSplitsLaunchDefinitionPaginatorTypeDef",
    {
        "steps": NotRequired[List[ScheduledSplitPaginatorTypeDef]],
    },
)
...
LaunchPaginatorTypeDef = TypedDict(
    "LaunchPaginatorTypeDef",
    {
        "arn": str,
        "createdTime": datetime,
        ...
        "project": NotRequired[str],
        "randomizationSalt": NotRequired[str],
        "scheduledSplitsDefinition": NotRequired[ScheduledSplitsLaunchDefinitionPaginatorTypeDef],
        "statusReason": NotRequired[str],
        "tags": NotRequired[Dict[str, str]],
    },
)
...
ListLaunchesResponsePaginatorTypeDef = TypedDict(
    "ListLaunchesResponsePaginatorTypeDef",
    {
