...
import { ControlPanelModel, LeftPanelWidget, RightPanelWidget, jcLightIcon, addCommands, CommandIDs } from '@jupytercad/base';
import { IAnnotationToken, IJupyterCadDocTracker } from '@jupytercad/schema';
...
const plugin = {
    ...
    activate: (app, tracker, mainMenu, translator) => {
