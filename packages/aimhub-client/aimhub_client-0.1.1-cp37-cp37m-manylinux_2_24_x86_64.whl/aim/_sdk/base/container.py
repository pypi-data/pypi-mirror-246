...
from aim._sdk.base.collections import ContainerQueryProxy, ContainerSequenceCollection
...
class Container(ABCContainer):
    ...
    @classmethod
    def from_storage(cls, storage: 'StorageEngine', meta_tree: 'TreeView', *, hash_: str):
        """
