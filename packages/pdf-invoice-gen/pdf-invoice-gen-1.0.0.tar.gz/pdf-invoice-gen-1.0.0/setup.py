...
setup(
  name = 'pdf-invoice-gen',         #* Your package will have this name
  ...
  author = 'Vinit Gohil',                   # Your name
  author_email = 'vgohil@mac.com',  # Your email
  url = 'https://github.com/vinitgohil',              # Homepage of your library (e.g. github or your website)
