"""
Methods to deal with json records

- loads: load json record in dict
- dumps: dump dict to json record
- load: load json record from file and put to dict
- dump: dump dict in json file
