...
class ExtendedSetupManager:
    ...
    def init_script_file(self) -> TextIO:
        return open(os.path.join(self.sources_dir, self.root_module_name, '__init__.py'), 'rt', encoding='utf-8')
...
''')
    ...
    def tests_directory(self) -> str:
        return os.path.abspath(os.path.join(self.root_dir, 'tests'))
    ...
    def html_test_runner(self) -> TextTestRunner:
        ...
        template = os.path.join(self.tests_directory, 'report-template.html')
    ...
    def make_setup_kwargs(self, *, short_description: str, min_python_version: Optional[Version], namespace_packages: List[str] = _MISSING, category: str = _MISSING, **kwargs):
...
__copyright__ = 'Copyright 2021-2023 Peter Zaitcev'
__version__ = '0.1.9'
