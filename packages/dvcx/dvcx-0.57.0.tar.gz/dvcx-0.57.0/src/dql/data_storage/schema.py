...
from dql.sql.types import JSON, Boolean, DateTime, Int, Int64, SQLType, String
...
def parse_columns(columns: Iterable[Dict[str, str]]) -> List[sa.Column]:
    """
    ...
    return [sa.Column(column["name"], type_map[column["type"]]) for column in columns]
