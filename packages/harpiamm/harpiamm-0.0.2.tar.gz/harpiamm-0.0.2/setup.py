...
setuptools.setup(
    ...
    data_files=[('scripts/harpiamm', [
        'scripts/analyze_beam_overlap.py',
        'scripts/install-harpiamm.bat',
        'scripts/reinstall-harpiamm.bat',
        'scripts/reinstall-harpiamm.bat',
        'scripts/run_cam_focus_test.py',
        'scripts/run_delay_line_alignment.py'
        ])],
    python_requires='>=3.6',
)