...
class Filing:
    ...
    def __rich__(self):
        ...
        #links_table.add_row("\U0001F3E0 Home", self.homepage_url)
        #links_table.add_row("\U0001F4C4 Document", self.document.url)
        #links_table.add_row("\U0001F4D2 Full Text", self.text_url)
