...
class MemoryCache:
    ...
    def Set(self, key:str, value=None, valueGenerator:_Callable=None, TTL:int=None):
        """
        ...
        :param TTL: seconds until cache expires, leave null for permanent
        """

        cacheObj = {
            "Value": value,
            "ValueTime": perf_counter(),
        }
        if(TTL is not None):
            cacheObj["TTL"] = TTL
