...
from fecloudsdkcore.auth.cache import AuthCache
from fecloudsdkcore.auth.internal import Iam, Metadata
from fecloudsdkcore.exceptions.exceptions import ApiValueError, ServiceResponseException, SdkException
from fecloudsdkcore.signer.algorithm import SigningAlgorithm
from fecloudsdkcore.signer.signer import Signer, SM3Signer, DerivationAKSKSigner, P256SHA256Signer, SM2SM3Signer
from fecloudsdkcore.utils import time_utils, six_utils
...
class DerivedCredentials(six_utils.get_abstract_meta_class()):
    _DEFAULT_ENDPOINT_REG = "^[a-z][a-z0-9-]+(\\.[a-z]{2,}-[a-z]+-\\d{1,2})?\\.(my)?(fecloud|myhwclouds).(com|cn)"
...
class GlobalCredentials(Credentials):
    ...
    def __init__(self, ak=None, sk=None, domain_id=None):
        ...
        :param ak: The access key ID for your account
        :param sk: The secret access key for your account
        :param domain_id: The account ID of FE Cloud
        """
