...
from fecloudsdkcore.auth.credentials import BasicCredentials, DerivedCredentials
from fecloudsdkcore.auth.provider import CredentialProviderChain
from fecloudsdkcore.exceptions.exceptions import HostUnreachableException
from fecloudsdkcore.exceptions.exception_handler import ExceptionHandler, DefaultExceptionHandler
from fecloudsdkcore.http import progress
from fecloudsdkcore.http.formdata import FormFile
from fecloudsdkcore.http.http_client import HttpClient
from fecloudsdkcore.http.http_config import HttpConfig
from fecloudsdkcore.http.http_handler import HttpHandler
from fecloudsdkcore.http.primitive_types import NATIVE_TYPES_MAPPING
from fecloudsdkcore.http.primitive_types import PRIMITIVE_TYPES
from fecloudsdkcore.sdk_request import SdkRequest
from fecloudsdkcore.sdk_response import FutureSdkResponse, SdkResponse
from fecloudsdkcore.sdk_stream_response import SdkStreamResponse
from fecloudsdkcore.utils import http_utils, core_utils
from fecloudsdkcore.utils.filepath_utils import ensure_file_in_rb_mode
from fecloudsdkcore.utils.xml_utils import XmlTransfer
...
class ClientBuilder(Generic[T]):
    ...
    def with_http_config(self, config):
        ...
        :type config: :class:`fecloudsdkcore.http.http_config.HttpConfig`
        """
        self._config = config
        return self
    ...
    def with_credentials(self, credentials):
        ...
        :type credentials: :class:`fecloudsdkcore.auth.credentials.Credentials`
        """
    ...
    def with_region(self, region):
        ...
        :type region: :class:`fecloudsdkcore.region.region.Region`
        """
        self._region = region
        return self
    ...
    def with_exception_handler(self, exception_handler):
        ...
        :type exception_handler: :class:`fecloudsdkcore.exceptions.exception_handler.ExceptionHandler`
        """
    ...
    def with_http_handler(self, http_handler):
        ...
        :type http_handler: :class:`fecloudsdkcore.http.http_handler.HttpHandler`
        """
...
class Client(object):
    ...
    def __init__(self):
        self.preset_headers = {}
        self._agent = {"User-Agent": "fecloud-usdk-python/3.0"}
    ...
    def _init_logger(cls):
        logger_name = 'FECloud-SDK-%s' % cls.__name__
