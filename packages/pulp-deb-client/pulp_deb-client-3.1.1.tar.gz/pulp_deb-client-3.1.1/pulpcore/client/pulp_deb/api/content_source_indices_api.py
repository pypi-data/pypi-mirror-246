...
class ContentSourceIndicesApi(object):
    ...
    def create(self, deb_source_index,  **kwargs):  # noqa: E501
        """Create a source index  # noqa: E501

        A SourceIndex represents the source indices of a single component.  Associated artifacts: Exactly one 'Sources' file. May optionally include one or more of 'Sources.gz', 'Sources.xz', 'Release'. If included, the 'Release' file is a legacy per-component-and-architecture Release file (with architecture always being 'source').  Note: The verbatim publisher will republish all associated artifacts, while the APT publisher (both simple and structured mode) will generate any 'Sources' files it needs when creating the publication. It does not make use of SourceIndex content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(deb_source_index, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param DebSourceIndex deb_source_index: (required)
        ...
        return self.create_with_http_info(deb_source_index,  **kwargs)  # noqa: E501

    def create_with_http_info(self, deb_source_index,  **kwargs):  # noqa: E501
        """Create a source index  # noqa: E501

        A SourceIndex represents the source indices of a single component.  Associated artifacts: Exactly one 'Sources' file. May optionally include one or more of 'Sources.gz', 'Sources.xz', 'Release'. If included, the 'Release' file is a legacy per-component-and-architecture Release file (with architecture always being 'source').  Note: The verbatim publisher will republish all associated artifacts, while the APT publisher (both simple and structured mode) will generate any 'Sources' files it needs when creating the publication. It does not make use of SourceIndex content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(deb_source_index, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DebSourceIndexResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('deb_source_index' not in local_var_params or  # noqa: E501
                                                        local_var_params['deb_source_index'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deb_source_index` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'deb_source_index' in local_var_params:
            body_params = local_var_params['deb_source_index']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/deb/source_indices/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='DebSourceIndexResponse',  # noqa: E501
    ...
    def list_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginateddebSourceIndexResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/deb/source_indices/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PaginateddebSourceIndexResponseList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def read(self, deb_source_index_href,  **kwargs):  # noqa: E501
        """Inspect a source index  # noqa: E501

        A SourceIndex represents the source indices of a single component.  Associated artifacts: Exactly one 'Sources' file. May optionally include one or more of 'Sources.gz', 'Sources.xz', 'Release'. If included, the 'Release' file is a legacy per-component-and-architecture Release file (with architecture always being 'source').  Note: The verbatim publisher will republish all associated artifacts, while the APT publisher (both simple and structured mode) will generate any 'Sources' files it needs when creating the publication. It does not make use of SourceIndex content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(deb_source_index_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str deb_source_index_href: (required)
        :param list[str] fields: A list of fields to include in the response.
        :param list[str] exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(deb_source_index_href,  **kwargs)  # noqa: E501

    def read_with_http_info(self, deb_source_index_href,  **kwargs):  # noqa: E501
        """Inspect a source index  # noqa: E501

        A SourceIndex represents the source indices of a single component.  Associated artifacts: Exactly one 'Sources' file. May optionally include one or more of 'Sources.gz', 'Sources.xz', 'Release'. If included, the 'Release' file is a legacy per-component-and-architecture Release file (with architecture always being 'source').  Note: The verbatim publisher will republish all associated artifacts, while the APT publisher (both simple and structured mode) will generate any 'Sources' files it needs when creating the publication. It does not make use of SourceIndex content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(deb_source_index_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('deb_source_index_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['deb_source_index_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deb_source_index_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'deb_source_index_href' in local_var_params:
            path_params['deb_source_index_href'] = local_var_params['deb_source_index_href']  # noqa: E501
