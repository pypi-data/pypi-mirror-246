        ...
        if include_optional :
            return DatasetModel(
                ...
                snapshot_builder_settings = data_repo_client.models.snapshot_builder_settings.SnapshotBuilderSettings(
                    domain_options = [
                        data_repo_client.models.snapshot_builder_domain_option.SnapshotBuilderDomainOption(
                            id = 56, 
                            category = '0', 
                            concept_count = 56, 
                    ...
                    program_data_options = [
                        data_repo_client.models.snapshot_builder_program_data_option.SnapshotBuilderProgramDataOption(
                            id = 56, 
                            name = '0', 
                            table_name = '0', 
                            column_name = '0', 
