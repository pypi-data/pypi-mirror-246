...
name = 'm9s_calendar'
download_url = 'https://gitlab.com/m9s/calendar.git'
requires = ['vobject', 'python-dateutil', 'python-sql', 'pytz']
...
setup(name=name,
    version=version,
    description='Tryton Calendar Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/calendar.git',
        },
    keywords='',
    package_dir={'trytond.modules.calendar': '.'},
    packages=(
        ['trytond.modules.calendar']
        + ['trytond.modules.calendar.%s' % p
