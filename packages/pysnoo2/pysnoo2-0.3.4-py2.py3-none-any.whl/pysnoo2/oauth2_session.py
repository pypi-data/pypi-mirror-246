...
- Fixed some implementation errors of the original (e.g. missing awaits)
...
class OAuth2Session(aiohttp.ClientSession):
    ...
    async def fetch_token(
            ...
            post_payload_modifier=lambda x: x,  # proxies=None,
            **kwargs):
        ...
        :param post_payload_modifier: Allow to modify the payload to post (e.g. for JSON)
