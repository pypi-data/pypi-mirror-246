Readme for PDKMaster based IHP SG13G2 PDK to be written.
This is a pre-alpha version of the PDK, if it breaks you need to keep the pieces.

This development is done in a development branch without a main branch as we will use directly
latest version of c4m-flexcell. When this development is done it will be released as version 0.0.1.
