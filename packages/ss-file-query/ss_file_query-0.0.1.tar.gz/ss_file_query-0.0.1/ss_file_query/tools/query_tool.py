...
@tool
def query_doc(connection: CustomConnection, query: str) -> str:
...
def create_llm_config(connection: CustomConnection):
    ...
    llm = AzureOpenAI(
        ...
        deployment_name = connection.deployment_name, # AZURE_OPENAI_API_DEPLOYMENT_NAME
