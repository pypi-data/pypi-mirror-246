...
class ResamplingOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_resolution", b"_resolution", "resolution", b"resolution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_resolution", b"_resolution", "resolution", b"resolution"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_resolution", b"_resolution"]) -> typing_extensions.Literal["resolution"] | None: ...
...
class IncludeOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_bounds", b"_bounds", "_states", b"_states", "bounds", b"bounds", "states", b"states"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_bounds", b"_bounds", "_states", b"_states", "bounds", b"bounds", "states", b"states"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_bounds", b"_bounds"]) -> typing_extensions.Literal["bounds"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_states", b"_states"]) -> typing_extensions.Literal["states"] | None: ...
...
class AggregationConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["aggregation_formula", b"aggregation_formula", "metric", b"metric", "microgrid_id", b"microgrid_id"]) -> None: ...

global___AggregationConfig = AggregationConfig

@typing_extensions.final
class SimpleAggregatedMetricSample(google.protobuf.message.Message):
    ...
    def sampled_at(self) -> google.protobuf.timestamp_pb2.Timestamp:
        ...
        """
    @property
    def sample(self) -> frequenz.api.common.v1.metrics.metric_sample_pb2.SimpleMetricSample:
    ...
    def __init__(
        ...
        *,
        ...
        sample: frequenz.api.common.v1.metrics.metric_sample_pb2.SimpleMetricSample | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["sample", b"sample", "sampled_at", b"sampled_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["sample", b"sample", "sampled_at", b"sampled_at"]) -> None: ...

global___SimpleAggregatedMetricSample = SimpleAggregatedMetricSample
...
class ListMicrogridComponentsDataRequest(google.protobuf.message.Message):
    ...
    class ListFilter(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["include_options", b"include_options", "resampling_options", b"resampling_options", "time_filter", b"time_filter"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["include_options", b"include_options", "resampling_options", b"resampling_options", "time_filter", b"time_filter"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["filter", b"filter", "pagination_params", b"pagination_params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["filter", b"filter", "metrics", b"metrics", "microgrid_components", b"microgrid_components", "pagination_params", b"pagination_params"]) -> None: ...
...
class ListMicrogridComponentsDataResponse(google.protobuf.message.Message):
    ...
    class MicrogridData(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["components", b"components", "microgrid_id", b"microgrid_id"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["microgrids", b"microgrids", "pagination_info", b"pagination_info"]) -> None: ...
...
class ReceiveMicrogridComponentsDataStreamRequest(google.protobuf.message.Message):
    ...
    class StreamFilter(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["include_options", b"include_options", "resampling_options", b"resampling_options"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["include_options", b"include_options", "resampling_options", b"resampling_options"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter", b"filter", "metrics", b"metrics", "microgrid_components", b"microgrid_components"]) -> None: ...
...
class ListAggregatedMicrogridComponentsDataRequest(google.protobuf.message.Message):
    ...
    class AggregationListFilter(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["resampling_options", b"resampling_options", "time_filter", b"time_filter"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["resampling_options", b"resampling_options", "time_filter", b"time_filter"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["filter", b"filter", "pagination_params", b"pagination_params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aggregation_configs", b"aggregation_configs", "filter", b"filter", "pagination_params", b"pagination_params"]) -> None: ...
...
class ListAggregatedMicrogridComponentsDataResponse(google.protobuf.message.Message):
    ...
    class AggregatedResult(google.protobuf.message.Message):
        ...
        @property
        def samples(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SimpleAggregatedMetricSample]:
            """A list of aggregated metrics."""
        def __init__(
            self,
            *,
            aggregation_config: global___AggregationConfig | None = ...,
            samples: collections.abc.Iterable[global___SimpleAggregatedMetricSample] | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["aggregation_config", b"aggregation_config"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["aggregation_config", b"aggregation_config", "samples", b"samples"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["pagination_info", b"pagination_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pagination_info", b"pagination_info", "results", b"results"]) -> None: ...
...
class ReceiveAggregatedMicrogridComponentsDataStreamRequest(google.protobuf.message.Message):
    ...
    class AggregationStreamFilter(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["resampling_options", b"resampling_options"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["resampling_options", b"resampling_options"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["filter", b"filter"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aggregation_configs", b"aggregation_configs", "filter", b"filter"]) -> None: ...
...
class ReceiveAggregatedMicrogridComponentsDataStreamResponse(google.protobuf.message.Message):
    ...
    @property
    def sample(self) -> global___SimpleAggregatedMetricSample:
        """Aggregated sample value and corresponding UTC timestamp when it was sampled."""
    def __init__(
        self,
        *,
        aggregation_config: global___AggregationConfig | None = ...,
        sample: global___SimpleAggregatedMetricSample | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["aggregation_config", b"aggregation_config", "sample", b"sample"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aggregation_config", b"aggregation_config", "sample", b"sample"]) -> None: ...
