...
class ReportingStub:
    ...
    ListMicrogridComponentsData: grpc.UnaryUnaryMultiCallable[
        frequenz.api.reporting.v1.reporting_pb2.ListMicrogridComponentsDataRequest,
        frequenz.api.reporting.v1.reporting_pb2.ListMicrogridComponentsDataResponse,
    ]
    ...
    !!! note
        ...
        to get a result.
    """
    ListAggregatedMicrogridComponentsData: grpc.UnaryUnaryMultiCallable[
        frequenz.api.reporting.v1.reporting_pb2.ListAggregatedMicrogridComponentsDataRequest,
        frequenz.api.reporting.v1.reporting_pb2.ListAggregatedMicrogridComponentsDataResponse,
    ]
...
class ReportingAsyncStub:
    ...
    ListMicrogridComponentsData: grpc.aio.UnaryUnaryMultiCallable[
        frequenz.api.reporting.v1.reporting_pb2.ListMicrogridComponentsDataRequest,
        frequenz.api.reporting.v1.reporting_pb2.ListMicrogridComponentsDataResponse,
    ]
    """Fetches historical metrics for a list of microgrid components.
    ...
    !!! note
        ...
        to get a result.
    """
    ListAggregatedMicrogridComponentsData: grpc.aio.UnaryUnaryMultiCallable[
        frequenz.api.reporting.v1.reporting_pb2.ListAggregatedMicrogridComponentsDataRequest,
        frequenz.api.reporting.v1.reporting_pb2.ListAggregatedMicrogridComponentsDataResponse,
    ]
    """Fetches aggregated historical metrics based on user-defined formulas for a list of
...
class ReportingServicer(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def ListMicrogridComponentsData(
        self,
        request: frequenz.api.reporting.v1.reporting_pb2.ListMicrogridComponentsDataRequest,
        context: _ServicerContext,
    ) -> typing.Union[frequenz.api.reporting.v1.reporting_pb2.ListMicrogridComponentsDataResponse, collections.abc.Awaitable[frequenz.api.reporting.v1.reporting_pb2.ListMicrogridComponentsDataResponse]]:
        """Fetches historical metrics for a list of microgrid components.
    ...
    def ReceiveMicrogridComponentsDataStream(
        ...
        """
    @abc.abstractmethod
    def ListAggregatedMicrogridComponentsData(
        self,
        request: frequenz.api.reporting.v1.reporting_pb2.ListAggregatedMicrogridComponentsDataRequest,
        context: _ServicerContext,
    ) -> typing.Union[frequenz.api.reporting.v1.reporting_pb2.ListAggregatedMicrogridComponentsDataResponse, collections.abc.Awaitable[frequenz.api.reporting.v1.reporting_pb2.ListAggregatedMicrogridComponentsDataResponse]]:
        """Fetches aggregated historical metrics based on user-defined formulas for a list of
        microgrid components.
