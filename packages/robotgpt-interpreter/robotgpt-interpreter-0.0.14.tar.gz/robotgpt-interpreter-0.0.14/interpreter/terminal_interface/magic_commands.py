...
from .count_tokens import count_messages_tokens
...
def handle_count_tokens(self, prompt):
    ...
    outputs.append(
        f"**Note**: This functionality is currently experimental and may not be accurate. Please report any issues you find to the [RobotGPT Interpreter GitHub repository](https://src.cloudminds.com/ai-api/robotgpt-interpreter)."
    )
