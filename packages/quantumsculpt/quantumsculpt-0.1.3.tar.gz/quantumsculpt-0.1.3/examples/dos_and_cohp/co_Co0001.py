...
qs.plot_averaged_cohp(ax[0,2],
                      ...
                      ylim=(-25,5),
                      icohp=True,
                      title='Averaged COHP CO$_{\\text{(g)}}$',
                      legend=True,
...
qs.plot_gathered_cohp(ax[0,3],
                      ...
                      grid=True,
                      bins=bins,
                      title='$\sigma / \pi$-COHP CO$_{\\text{(g)}}$',
                      ylim=(-25,5),
                      legend=True,
                      legendloc='lower right')
...
qs.plot_gathered_dos(ax[1,1], 
                     ...
                     addspins=True,
                     bins=bins,
                     title='$\sigma / \pi$-DOS CO$_{\\text{ads}}$',
                     legendloc='lower right')
...
qs.plot_averaged_cohp(ax[1,2], 
                      ...
                      ylim=(-25,5),
                      icohp=True,
                      title='Averaged COHP CO$_{\\text{ads}}$',
                      legend=True,
                      legendloc='upper left')
...
qs.plot_gathered_cohp(ax[1,3],
                      ...
                      grid=True,
                      bins=bins,
                      title='$\sigma / \pi$-COHP CO$_{\\text{ads}}$',
                      ylim=(-25,5),
                      legend=True)
