...
class AzureContainer(AzureStorageAccount):
    ...
    def get_container_blob_names(self, blob_name: str) -> list[str]:
        sub_blobs_name: list[str] = self.container_client.list_blob_names(name_starts_with=blob_name)
        return sub_blobs_name
