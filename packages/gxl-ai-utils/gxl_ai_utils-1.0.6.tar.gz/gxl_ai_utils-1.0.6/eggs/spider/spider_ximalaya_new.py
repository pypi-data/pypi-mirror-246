...
class GxlSpider(object):
    ...
    def handle_category_fenye(self):
        ...
        """
        category_info = utils_file.load_json_file(os.path.join(self.output_root, 'category.json'))
    ...
    def handle_album(self, category, album_id):
        ...
        for i in range(1, total_page + 1):
            ...
            utils_file.write_dictlist_to_jsonl(res, os.path.join(self.output_root, 'audio_info', category,
