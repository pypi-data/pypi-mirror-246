...
class GxlSpider:
    ...
    def handle_category_index_fenye(self):
        category_dict = utils_file.load_json_file(self.output_dir + 'root_category.json')
        for title, href in category_dict.items():
            logger.info(f'开始处理{title}类别')
            ...
            for i in range(1, 76):
                ...
                try:
                    ...
                    logger.info(f'开始处理的页的地址:{temp_href}')
    ...
    def handle_ibum_index_fenye(self, ):
        ...
        for album_list_path in category_s_album_list:
            ...
            for album_href in album_list:
                ...
                res_list = []
                logger.info(f'开始处理专辑, url:{album_href}')
                try:
    ...
    def get_wav_info(self):
        ...
        for album_path in album_path_list:
            ...
            logger.info(f'album_path: {album_path}')
            ...
            for wav_path in wav_path_list:
                ...
                logger.info(f'开始处理{wav_id},专辑{album_id}')
    ...
    def login(self, user_id='13937825104', password='Gxl2236035.'):
        ...
        if response.status_code == 200:
            ...
            if errorno == 0:
                ...
                logger.info('Login failed', '登录失败')
                print(errormsg)
        self.print_token()

    def print_token(self):
        logger.info(self.access_token)
        logger.info(self.qingting_id)
