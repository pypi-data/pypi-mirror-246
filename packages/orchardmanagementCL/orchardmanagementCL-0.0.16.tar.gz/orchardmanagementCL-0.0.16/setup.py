...
setup(
    ...
    package_data={
        'orchardmanagementpackage.production': ['*.csv'],
        'orchardmanagementpackage.management': ['*.csv'],
        'test.management_test': ['*.csv'],
        'test.management_production_test': ['*.csv'],
        'unittest_modules.management_testing_files': ['*.csv'],
        'unittest_modules.production_file_test': ['*.csv'],
