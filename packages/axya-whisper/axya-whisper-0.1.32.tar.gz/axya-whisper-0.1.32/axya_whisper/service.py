        ...
        while True:
            try:
                if "--status" in sys.argv:
                    ...
                    try:
                        servicemanager.LogInfoMsg("Syncing routing has started... Next run in 1 minute.")
                        service()
                    except Exception as e:
                        servicemanager.LogErrorMsg(f"Error running main: {e}")
...
if __name__ == '__main__':
    # Use this block for testing the service as a standalone script
