...
class OrderFoodProductRelationRefundStatus:
    NO = 0
    READY = 1
    COMPLETE = 2


ORDER_FOOD_PRODUCT_RELATION_REFUND_STATUS = (
    (OrderFoodProductRelationRefundStatus.NO, '기본'),
    (OrderFoodProductRelationRefundStatus.READY, '환불예정'),
    (OrderFoodProductRelationRefundStatus.COMPLETE, '환불완료'),
)
