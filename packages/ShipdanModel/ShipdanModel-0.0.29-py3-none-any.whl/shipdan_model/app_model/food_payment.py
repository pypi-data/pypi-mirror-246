...
from shipdan_model.app_model.constant import FOOD_ORDER_STATUS, FoodOrderStatus, \
    ORDER_FOOD_PRODUCT_RELATION_REFUND_STATUS, OrderFoodProductRelationRefundStatus
...
class OrderFoodProductRelation(models.Model):
    ...
    refund_status = models.IntegerField(
        choices=ORDER_FOOD_PRODUCT_RELATION_REFUND_STATUS,
        default=OrderFoodProductRelationRefundStatus.NO,
    )
