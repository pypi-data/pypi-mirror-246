...
def plot(arr, format, legend):
    ...
    plt.legend(loc='upper right', frameon=False, prop={'style':'italic','size':'small'}, alignment='left', title=legend, title_fontproperties={'size':'small'})
    ...
    plt.tick_params(axis='both', which='minor', color='gray')
    plt.legend(loc='upper left', frameon=False, prop={'style':'italic','size':'small'}, alignment='left', title=legend, title_fontproperties={'size':'small'})
