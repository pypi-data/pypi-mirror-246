...
class ProfileContext (GenericCRUD, object):
    ...
    def save_chosen_options(self, question_asked: str, variable_id: int, chosen_numbers_list: list, list_of_options: list):
        ...
        if len(list_of_options) == 0:
            logger.critical(message='list_of_options is empty', object={'question_asked': question_asked, 'variable_id': variable_id, 'chosen_numbers_list': chosen_numbers_list, 'list_of_options': list_of_options})
    ...
    def get_variable_value_by_variable_name(self, variable_name: str) -> str:
        ...
        variable_value = self.get_variable_value_by_variable_id(self.variables.get_variable_id(variable_name))
        logger.end(object={'variable_value': variable_value})
        return variable_value
    ...
    def set(self, variable_id: int, variable_value: str):
        ...
        data_to_insert = {
            ...
            'variable_value_new': variable_value
        }
        self.insert(table_name='logger_table',data_json=data_to_insert)
        logger.end()
