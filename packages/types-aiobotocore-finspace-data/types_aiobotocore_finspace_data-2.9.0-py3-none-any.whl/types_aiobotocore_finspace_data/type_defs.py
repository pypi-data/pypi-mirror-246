...
DataViewDestinationTypeParamsPaginatorTypeDef = TypedDict(
    "DataViewDestinationTypeParamsPaginatorTypeDef",
    {
        "destinationType": str,
        "s3DestinationExportFileFormat": NotRequired[ExportFileFormatType],
...
SchemaDefinitionPaginatorTypeDef = TypedDict(
    "SchemaDefinitionPaginatorTypeDef",
    {
...
DataViewSummaryPaginatorTypeDef = TypedDict(
    "DataViewSummaryPaginatorTypeDef",
    {
        ...
        "destinationTypeProperties": NotRequired[DataViewDestinationTypeParamsPaginatorTypeDef],
        "autoUpdate": NotRequired[bool],
        "createTime": NotRequired[int],
        "lastModifiedTime": NotRequired[int],
    },
...
SchemaUnionPaginatorTypeDef = TypedDict(
    "SchemaUnionPaginatorTypeDef",
    {
        "tabularSchemaConfig": NotRequired[SchemaDefinitionPaginatorTypeDef],
    },
)
...
ListDataViewsResponsePaginatorTypeDef = TypedDict(
    "ListDataViewsResponsePaginatorTypeDef",
    {
        "nextToken": str,
...
DatasetPaginatorTypeDef = TypedDict(
    "DatasetPaginatorTypeDef",
    {
        ...
        "createTime": NotRequired[int],
        "lastModifiedTime": NotRequired[int],
        "schemaDefinition": NotRequired[SchemaUnionPaginatorTypeDef],
