...
def get_provider_info():
    return {
        ...
        "suspended": False,
        "source-date-epoch": 1701983364,
        "versions": ["2.4.0", "2.3.0", "2.2.0", "2.1.1", "2.1.0", "2.0.1", "2.0.0", "1.1.0", "1.0.0"],
        "dependencies": ["apache-airflow>=2.6.0", "atlassian-python-api>=1.14.2"],
        "integrations": [
            {
