...
class GeographicArea:
    def __init__(self, print_url=False):
        ...
        self.TABLE_NAME = "GEOGRAPHIC_AREA"
    ...
    def summarize_geographic_area_data_by_epa_region(self, print_to_console=True, multi_threads=False):
        return self.sdwis_table.summarize_data_by_epa_region(table_name=self.TABLE_NAME, print_to_console=print_to_console,
                                                      multi_threads=multi_threads)
                                                      
    def get_geographic_area_by_epa_region(self, epa_region=1, print_to_console=True, only_count=False):
    ...
    def get_geographic_area_data_by_conditions(self, condition1="", condition2="", condition3="", print_to_console=True,
                                          only_count=False):
