...
# TODO: Need to rationalise here... there are multiple calls for same data, to get account for authenticate, then get it again for user details.
# TODO: For endpoints can have one authentication that throws (any failure) or returns user creds for use in endpoint - minimise round trips
# TODO: Test with Barking
