...
#     a = np.array(os.listdir("E:/Doktorat/Dane/SimData/New"))[np.array(list(map(lambda x: x.endswith(".txt"), os.listdir("E:/Doktorat/Dane/SimData/New"))))]
#     for i in a:
#         cloneDist("E:/Doktorat/Dane/SimData/New/" + i, i.rstrip("muller_plot_matrix_data.txt"))
        # mullerPlotPyFish("E:/Doktorat/Dane/SimData/New/" + i, i.rstrip("muller_plot_matrix_data.txt") + "zoomed_", 0.975)
