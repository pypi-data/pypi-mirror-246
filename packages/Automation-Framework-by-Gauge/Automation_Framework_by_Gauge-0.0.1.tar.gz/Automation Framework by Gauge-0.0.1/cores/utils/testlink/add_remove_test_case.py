...
from cores.const.common import StringFormat
...
class AddRemoveTestCase:
    ...
    def add_all_test_cases_to_test_plan(self, test_case_external_ids):
        ...
        for external_id in test_case_external_ids:
            output_string = StringUtil.format_string_with_re(re_format=StringFormat.FORMAT_AB_123_PATTERN,
                                                             repl=StringFormat.FORMAT_AB_123_REPL,
                                                             value=external_id)
