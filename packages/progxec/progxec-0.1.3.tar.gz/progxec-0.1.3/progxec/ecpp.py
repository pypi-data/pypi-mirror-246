...
def compile_cpp(file_path):
    ...
    try:
        ...
        # You can choose to raise the error if you want to handle it at a higher level
        # raise e
...
def exec_exe_file(exe_path):
    ...
    try:
        ...
        # If you want to print the error and return None instead of raising an exception,
