...
<script type="text/babel"
    ...
    data-type="module"
    data-presets="react" src="{{{{ url_for('static', filename='js/functions.js') }}}}"></script>

<script type="text/babel"
    data-plugins="transform-modules-umd"
    data-type="module"
    data-presets="react" src="{{{{ url_for('static', filename='js/App.js') }}}}"></script>

<script type="text/babel"
    data-plugins="transform-modules-umd"
    data-type="module"
    data-presets="react" src="{{{{ url_for('static', filename='js/index.js') }}}}"></script>
...
Author: Daniel Rodriguez Castillo
Company: Dnart.tech
*/
{imports}
