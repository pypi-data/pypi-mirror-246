...
poetry build
twine check dist/blender_asset_tracer-1.17.tar.gz dist/blender_asset_tracer-1.17-*.whl
twine upload -r bat dist/blender_asset_tracer-1.17.tar.gz dist/blender_asset_tracer-1.17-*.whl
```
