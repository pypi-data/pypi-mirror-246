...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = KernelServiceApi()
        api_instance.kernel_service_create_kernel  # this is an instance of the class Endpoint
        api_instance.kernel_service_create_kernel()  # this invokes api_instance.kernel_service_create_kernel.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.kernel_service_create_kernel.callable or self.callable in this class
