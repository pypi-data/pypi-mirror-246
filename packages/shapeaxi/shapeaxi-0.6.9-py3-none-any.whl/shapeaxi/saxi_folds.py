...
def cml():
    ...
    split_group.add_argument('--csv', type=str, help='CSV with columns surf,class', required=True)
    ...
    train_group.add_argument('--csv_train', type=str, help='CSV with column surf')
    train_group.add_argument('--csv_valid', type=str, help='CSV with column surf')
    train_group.add_argument('--csv_test', type=str, help='CSV with column surf')
    ...
    train_group.add_argument('--mean', type=float, default=0, help='Mean (default: 0)')
    train_group.add_argument('--std', type=float, default=0.005, help='Standard deviation (default: 0.005)')
