...
def main(args):
    ...
    if args.model is None:
        ...
        model = saxi_nets.DentalModelSeg(custom_model=args.model)
...
def get_argparse():
    ...
    input_group.add_argument('--vtk', type=str, help='Path to your vtk file', default=None)
    input_group.add_argument('--csv', type=str, help='Path to your csv file', default=None)
    input_group.add_argument('--stl', type=str, help='Path to your stl file', default=None)
