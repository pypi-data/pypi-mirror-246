...
class FeatureStoreConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["airflow_connection_id", b"airflow_connection_id", "is_user_code_execution_allowed", b"is_user_code_execution_allowed", "redis_address", b"redis_address"]) -> None: ...
