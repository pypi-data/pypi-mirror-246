...
class Build(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audit", b"audit", "branchId", b"branchId", "buildConfig", b"buildConfig", "buildId", b"buildId", "build_configuration_message", b"build_configuration_message", "build_destined_image", b"build_destined_image", "build_status", b"build_status", "commitId", b"commitId", "end_date", b"end_date", "environment_id", b"environment_id", "image_name_tag", b"image_name_tag", "metrics", b"metrics", "model_schema", b"model_schema", "model_uuid", b"model_uuid", "params", b"params", "sdk_version", b"sdk_version", "steps", b"steps", "tags", b"tags"]) -> None: ...
...
class PretrainedModelsSpec(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    build_id: builtins.str
    @property
    def pretrained_model(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PretrainedModel]: ...
    def __init__(
        self,
        *,
        build_id: builtins.str = ...,
        pretrained_model: collections.abc.Iterable[global___PretrainedModel] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["build_id", b"build_id", "pretrained_model", b"pretrained_model"]) -> None: ...

global___PretrainedModelsSpec = PretrainedModelsSpec

class PretrainedModel(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    HUGGINGFACE_PRETRAINED_MODEL_FIELD_NUMBER: builtins.int
    @property
    def huggingface_pretrained_model(self) -> global___HuggingFacePretrainedModel: ...
    def __init__(
        self,
        *,
        huggingface_pretrained_model: global___HuggingFacePretrainedModel | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["huggingface_pretrained_model", b"huggingface_pretrained_model", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["huggingface_pretrained_model", b"huggingface_pretrained_model", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type", b"type"]) -> typing_extensions.Literal["huggingface_pretrained_model"] | None: ...

global___PretrainedModel = PretrainedModel

class HuggingFacePretrainedModel(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    VERSION_FIELD_NUMBER: builtins.int
    REPOSITORY_FIELD_NUMBER: builtins.int
    PRETRAINED_MODEL_NAME_FIELD_NUMBER: builtins.int
    version: builtins.str
    repository: builtins.str
    pretrained_model_name: builtins.str
    def __init__(
        self,
        *,
        version: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["pretrained_model_name", b"pretrained_model_name", "repository", b"repository", "version", b"version"]) -> None: ...

global___HuggingFacePretrainedModel = HuggingFacePretrainedModel
