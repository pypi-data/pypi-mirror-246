        ...
        for i in range(0, len(fna_files)):
            ...
            with open(csv_file, newline='') as csvfile:
                ...
                for row in reader:
                    ...
                    q_vs_s_score_list_final.extend(blast_driver("./executables/makeblastdb", "./executables/blastn", row_seq_file, os.path.join(row_seq_file,"subject.fasta"),  os.path.join(row_seq_file,"query.fasta"), []))
