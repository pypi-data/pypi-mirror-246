...
from ionoscloud_container_registry.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'ionos-cloud-sdk-python/1.1.0'
