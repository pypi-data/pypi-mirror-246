...
class _TCO(Consumer):
    ...
    class _Machines(Consumer):
        ...
        class _Catalogs(Consumer):
            ...
            @returns.json
            @http_get("calculators/tco/machines/catalogs/{uid}")
            def get(self, uid: str):
                """This call will return the specified TCO cost model for the specified machine catalog uid."""
    ...
    class _Maintenance(Consumer):
        ...
        def list(
            self, machine_catalog_uid: Query(type=str) = None,
        ):
