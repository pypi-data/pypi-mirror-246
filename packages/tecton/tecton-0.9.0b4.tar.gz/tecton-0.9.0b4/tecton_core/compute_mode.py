...
def offline_retrieval_compute_mode(function_override: Optional[ComputeMode]) -> ComputeMode:
    ...
    return function_override if function_override is not None else default
