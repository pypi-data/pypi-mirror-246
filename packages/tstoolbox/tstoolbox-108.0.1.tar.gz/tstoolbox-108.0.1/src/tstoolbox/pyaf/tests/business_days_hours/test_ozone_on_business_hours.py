...
df[b1.mTimeVar + "_BusinessHourly"] = pd.bdate_range(
    "2000-1-1", periods=df.shape[0], freq="2BH"
)
...
timevar = b1.mTimeVar + "_BusinessHourly"
...
lEngine.standardPlots("outputs/my_ozone_bhour")
