...
df = pd.read_csv(
    "https://raw.githubusercontent.com/antoinecarme/TimeSeriesData/master/fpp2/insurance.csv"
)
...
lEngine.mOptions.set_active_autoregressions(["SVRX"])

lExogenousData = (df_exog, [lExogVar])
lEngine.train(df_sig, lTimeVar, lSigVar, H, lExogenousData)

lEngine.getModelInfo()
lEngine.standardPlots(name="outputs/insurance_svrx")
