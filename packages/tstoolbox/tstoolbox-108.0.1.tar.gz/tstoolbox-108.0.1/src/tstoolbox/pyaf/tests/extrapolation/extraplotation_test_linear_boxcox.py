...
df_train["Signal_Linear"] = np.arange(N) / (N - 1.0)
df_train["Signal_Square"] = df_train["Signal_Linear"] * df_train["Signal_Linear"]
...
lSignal = "Signal_Linear"
# lEngine.mOptions.enable_slow_mode();
lEngine.mOptions.set_active_transformations(["BoxCox"])
...
lEngine.standardPlots("outputs/extrapol_boxcox_" + lSignal)
