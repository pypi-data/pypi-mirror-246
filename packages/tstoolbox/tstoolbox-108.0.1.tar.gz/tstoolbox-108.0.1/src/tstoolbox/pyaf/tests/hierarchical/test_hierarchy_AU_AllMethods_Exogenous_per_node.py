...
def create_exog_data(b1):
    ...
    lDate2 = b1.mFutureData[
        "Date"
    ]  # not needed. exogfenous data are missing when not available.
...
lEngine.train(
    df, b1.mTimeVar, b1.mSignalVar, H, b1.mHierarchy, iExogenousData=lExogenousData
)
