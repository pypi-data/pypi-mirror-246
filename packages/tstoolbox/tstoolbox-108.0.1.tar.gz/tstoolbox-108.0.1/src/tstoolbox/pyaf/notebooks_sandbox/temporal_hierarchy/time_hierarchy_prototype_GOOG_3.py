...
goog_dataframe["Date"] = goog_dataframe["Date"].apply(
...
lSignalHierarchy = lEngine.plot_Hierarchy(
    goog_dataframe, "Date", "Close", 14, lHierarchy, None
)
...
lSignalHierarchy = lEngine.train(
    train_df, lDateColumn, lSignalVar, 14, lHierarchy, None
)
