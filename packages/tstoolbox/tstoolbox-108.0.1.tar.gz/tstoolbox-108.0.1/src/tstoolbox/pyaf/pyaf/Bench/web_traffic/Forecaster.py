...
class cProjectForecaster:
    ...
    def forecast(self, projects, iLastDate, iHorizon):
        ...
        for project in projects:
            ...
            forecasts = self.mBackend.forecast_all_signals(
                project_data, iLastDate, iHorizon
            )
            for col in sorted(forecasts.keys()):
                ...
                for k in sorted(fcst_dict.keys()):
                    ...
                    logger.info(
                        "FORECASTING_WIKIPEDIA_PROJECT_DETAIL "
                        + " "
                        + str(col)
                        + " "
                        + str(k)
            ...
            logger.info(
                "FORECASTING_WIKIPEDIA_PROJECT_END_TIME_IN_SECONDS "
                + project
                + " "
