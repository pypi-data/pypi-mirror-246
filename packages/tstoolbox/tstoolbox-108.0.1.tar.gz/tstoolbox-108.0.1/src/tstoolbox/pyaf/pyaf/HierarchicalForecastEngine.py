...
class cHierarchicalForecastEngine:
    ...
    def train(
        ...
        try:
            self.train_HierarchicalModel(
                iInputDS, iTime, iSignal, iHorizon, iHierarchy, iExogenousData
            )
    ...
    def create_signal_hierarchy(
        self, iInputDS, iTime, iSignal, iHorizon, iHierarchy, iExogenousData=None
    ):
    ...
    def plot_Hierarchy(
        ...
        lSignalHierarchy = self.create_signal_hierarchy(
            iInputDS, iTime, iSignal, iHorizon, iHierarchy, iExogenousData
        )
