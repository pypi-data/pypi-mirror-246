...
class ContainerTree:
    ...
    def add_node(self, container: s.Container) -> None:
        ...
        This method assumes that the containers come in order, like parent first then
        children
        """
        ...
        # populate size to parents because the container holds bytes_sum and files_cnt
        # only of files that are in that particular container
        current = parent_node
        while current:
