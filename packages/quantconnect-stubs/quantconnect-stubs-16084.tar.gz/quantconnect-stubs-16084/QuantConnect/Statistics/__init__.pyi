...
class PortfolioStatistics(System.Object):
    ...
    @overload
    def __init__(self, profitLoss: System.Collections.Generic.SortedDictionary[datetime.datetime, float], equity: System.Collections.Generic.SortedDictionary[datetime.datetime, float], portfolioTurnover: System.Collections.Generic.SortedDictionary[datetime.datetime, float], listPerformance: System.Collections.Generic.List[float], listBenchmark: System.Collections.Generic.List[float], startingCapital: float, riskFreeInterestRateModel: QuantConnect.Data.IRiskFreeInterestRateModel, tradingDaysPerYear: int = 252, winCount: typing.Optional[int] = None, lossCount: typing.Optional[int] = None) -> None:
        """
...
class AlgorithmPerformance(System.Object):
    ...
    @overload
    def __init__(self, trades: System.Collections.Generic.List[QuantConnect.Statistics.Trade], profitLoss: System.Collections.Generic.SortedDictionary[datetime.datetime, float], equity: System.Collections.Generic.SortedDictionary[datetime.datetime, float], portfolioTurnover: System.Collections.Generic.SortedDictionary[datetime.datetime, float], listPerformance: System.Collections.Generic.List[float], listBenchmark: System.Collections.Generic.List[float], startingCapital: float, winningTransactions: int, losingTransactions: int, riskFreeInterestRateModel: QuantConnect.Data.IRiskFreeInterestRateModel) -> None:
        """
...
class Statistics(System.Object):
    ...
    @staticmethod
    def AnnualDownsideStandardDeviation(performance: System.Collections.Generic.List[float], tradingDaysPerYear: float = 252, minimumAcceptableReturn: float = 0) -> float:
        """
    ...
    @staticmethod
    def AnnualDownsideVariance(performance: System.Collections.Generic.List[float], tradingDaysPerYear: float = 252, minimumAcceptableReturn: float = 0) -> float:
        """
        Annualized variance statistic calculation using the daily performance variance and trading days per year.
    ...
    @staticmethod
    @overload
    def SharpeRatio(algoPerformance: System.Collections.Generic.List[float], riskFreeRate: float, tradingDaysPerYear: float = 252) -> float:
        """
        Sharpe ratio with respect to risk free rate: measures excess of return per unit of risk.
    ...
    @staticmethod
    def SortinoRatio(algoPerformance: System.Collections.Generic.List[float], riskFreeRate: float, tradingDaysPerYear: float = 252, minimumAcceptableReturn: float = 0) -> float:
        """
        Sortino ratio with respect to risk free rate: measures excess of return per unit of downside risk.
