...
class SidecordException(Exception):
    """Base exception class for all Sidecord exceptions."""


class ConvertTimeError(SidecordException):
    """Raised when a time conversion fails."""


class Blacklisted(SidecordException):
