...
Python package for positional CSV data processing. Positional CSV is being generated by [SkyHub](https://www.sphengineering.com/integrated-systems/skyhub) - an onboard computer which logs data from drone-based sensors, such as methane detectors, wind sensors, magnetometers, echo sounders and other with scalar georeferenced readings.   
