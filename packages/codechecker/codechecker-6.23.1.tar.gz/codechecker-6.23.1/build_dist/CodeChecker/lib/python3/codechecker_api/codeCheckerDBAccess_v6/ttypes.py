...
class ReportFilter(object):
    ...
    def write(self, oprot):
        ...
        if self.checkerMsg is not None:
            ...
            for iter191 in self.checkerMsg:
        ...
        if self.checkerName is not None:
            ...
            for iter192 in self.checkerName:
        ...
        if self.reportHash is not None:
            ...
            for iter193 in self.reportHash:
        ...
        if self.reviewStatus is not None:
            ...
            for iter195 in self.reviewStatus:
        ...
        if self.detectionStatus is not None:
            ...
            for iter196 in self.detectionStatus:
        ...
        if self.runHistoryTag is not None:
            ...
            for iter197 in self.runHistoryTag:
        ...
        if self.componentNames is not None:
            ...
            for iter200 in self.componentNames:
        ...
        if self.analyzerNames is not None:
            ...
            for iter201 in self.analyzerNames:
        ...
        if self.cleanupPlanNames is not None:
            ...
            for iter202 in self.cleanupPlanNames:
        ...
        if self.annotations is not None:
            ...
            for iter203 in self.annotations:
                iter203.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i214 in range(_size210):
                        _elem215 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.names.append(_elem215)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
...
class LinesInFilesRequested(object):
    ...
    def write(self, oprot):
        ...
        if self.lines is not None:
            ...
            for iter238 in self.lines:
                oprot.writeI64(iter238)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ExportData(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i243 in range(_size239):
                        ...
                        for _i250 in range(_size246):
                            _elem251 = CommentData()
                            _elem251.read(iprot)
                            _val245.append(_elem251)
                        iprot.readListEnd()
                        self.comments[_key244] = _val245
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i256 in range(_size252):
                        ...
                        _val258 = ReviewData()
                        _val258.read(iprot)
                        self.reviewData[_key257] = _val258
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.comments is not None:
            ...
            for kiter259, viter260 in self.comments.items():
        ...
        if self.reviewData is not None:
            ...
            for kiter262, viter263 in self.reviewData.items():
...
class CleanupPlan(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i284 in range(_size280):
                        ...
                        self.reportHashes.append(_elem285)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter286 in self.reportHashes:
