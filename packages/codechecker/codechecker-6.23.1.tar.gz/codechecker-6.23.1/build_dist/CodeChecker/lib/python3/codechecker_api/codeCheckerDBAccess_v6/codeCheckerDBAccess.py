...
class Client(Iface):
    ...
    def getReportAnnotations(self, key):
        ...
        Parameters:
         - key
        """
        self.send_getReportAnnotations(key)
        return self.recv_getReportAnnotations()

    def send_getReportAnnotations(self, key):
...
class Processor(Iface, TProcessor):
    ...
    def process_getReportAnnotations(self, seqid, iprot, oprot):
        ...
        result = getReportAnnotations_result()
        try:
            result.success = self._handler.getReportAnnotations(args.key)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
...
class getDiffResultsHash_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i346 in range(_size342):
                        ...
                        self.reportHashes.append(_elem347)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i352 in range(_size348):
                        ...
                        self.skipDetectionStatuses.append(_elem353)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter361 in self.reportHashes:
        ...
        if self.skipDetectionStatuses is not None:
            ...
            for iter362 in self.skipDetectionStatuses:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i396 in range(_size392):
                        _elem397 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i454 in range(_size450):
                        _elem455 = LinesInFilesRequested()
                        _elem455.read(iprot)
                        self.linesInFilesRequested.append(_elem455)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter456 in self.linesInFilesRequested:
                iter456.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter471, viter472 in self.success.items():
                oprot.writeI64(kiter471)
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter472))
                for kiter473, viter474 in viter472.items():
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i479 in range(_size475):
                        _elem480 = ReviewStatusRule()
                        _elem480.read(iprot)
                        self.success.append(_elem480)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i500 in range(_size496):
                        ...
                        for _i506 in range(_size502):
                            _elem507 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                            _elem501.append(_elem507)
                        iprot.readListEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter508 in self.success:
                oprot.writeListBegin(TType.STRING, len(iter508))
                for iter509 in iter508:
                    oprot.writeString(iter509.encode('utf-8') if sys.version_info[0] == 2 else iter509)
                oprot.writeListEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class getCheckerMsgCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter546 in self.runIds:
                oprot.writeI64(iter546)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i551 in range(_size547):
                        _key552 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class getReviewStatusCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter562 in self.runIds:
                oprot.writeI64(iter562)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
...
class getReviewStatusCounts_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.I32, TType.I64, len(self.success))
            for kiter570, viter571 in self.success.items():
                oprot.writeI32(kiter570)
                oprot.writeI64(viter571)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getDetectionStatusCounts_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.I32, TType.I64, len(self.success))
            for kiter586, viter587 in self.success.items():
                oprot.writeI32(kiter586)
                oprot.writeI64(viter587)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getFileCounts_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.I64, len(self.success))
            for kiter602, viter603 in self.success.items():
                oprot.writeString(kiter602.encode('utf-8') if sys.version_info[0] == 2 else kiter602)
                oprot.writeI64(viter603)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getCheckerCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter610 in self.runIds:
                oprot.writeI64(iter610)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
...
class getRunHistoryTagCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter624 in self.runIds:
                oprot.writeI64(iter624)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i643 in range(_size639):
                        _key644 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter646, viter647 in self.success.items():
                oprot.writeString(kiter646.encode('utf-8') if sys.version_info[0] == 2 else kiter646)
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i652 in range(_size648):
                        _elem653 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.sourceComponentFilter.append(_elem653)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter654 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i666 in range(_size662):
                        ...
                        self.fileHashes.append(_elem667)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter668 in self.fileHashes:
...
class getMissingContentHashesForBlameInfo_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i680 in range(_size676):
                        ...
                        self.fileHashes.append(_elem681)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            oprot.writeFieldBegin('fileHashes', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.fileHashes))
            for iter682 in self.fileHashes:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i687 in range(_size683):
                        _elem688 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter689 in self.success:
                oprot.writeString(iter689.encode('utf-8') if sys.version_info[0] == 2 else iter689)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i694 in range(_size690):
                        _elem695 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.trimPathPrefixes.append(_elem695)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter696 in self.trimPathPrefixes:
                oprot.writeString(iter696.encode('utf-8') if sys.version_info[0] == 2 else iter696)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.description is not None:
...
class getAnalysisStatisticsLimits_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.I32, TType.I64, len(self.success))
            for kiter704, viter705 in self.success.items():
                oprot.writeI32(kiter704)
                oprot.writeI64(viter705)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class setCleanupPlan_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i726 in range(_size722):
                        _elem727 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.reportHashes.append(_elem727)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            oprot.writeFieldBegin('reportHashes', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter728 in self.reportHashes:
...
class unsetCleanupPlan_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i733 in range(_size729):
                        _elem734 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.reportHashes.append(_elem734)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            oprot.writeFieldBegin('reportHashes', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter735 in self.reportHashes:
