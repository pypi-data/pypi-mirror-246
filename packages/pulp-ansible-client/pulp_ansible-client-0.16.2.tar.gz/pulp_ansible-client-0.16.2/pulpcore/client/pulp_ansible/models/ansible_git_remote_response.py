...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_connect_timeout=None, name=None, total_timeout=None, ca_cert=None, pulp_last_updated=None, headers=None, pulp_created=None, proxy_url=None, connect_timeout=None, sock_read_timeout=None, download_concurrency=None, pulp_href=None, max_retries=None, hidden_fields=None, tls_validation=None, url=None, client_cert=None, rate_limit=None, pulp_labels=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
