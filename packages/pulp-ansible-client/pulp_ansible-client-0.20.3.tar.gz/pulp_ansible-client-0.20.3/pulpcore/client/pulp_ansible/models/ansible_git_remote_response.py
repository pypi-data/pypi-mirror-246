...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, url=None, pulp_created=None, rate_limit=None, pulp_last_updated=None, pulp_href=None, client_cert=None, headers=None, sock_read_timeout=None, proxy_url=None, tls_validation=None, total_timeout=None, sock_connect_timeout=None, pulp_labels=None, name=None, connect_timeout=None, download_concurrency=None, ca_cert=None, hidden_fields=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
