...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, sock_connect_timeout=None, name=None, total_timeout=None, ca_cert=None, headers=None, proxy_url=None, client_key=None, connect_timeout=None, sock_read_timeout=None, download_concurrency=None, username=None, password=None, max_retries=None, proxy_password=None, tls_validation=None, url=None, client_cert=None, rate_limit=None, pulp_labels=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
