...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_key=None, max_retries=None, url=None, rate_limit=None, proxy_password=None, client_cert=None, headers=None, proxy_username=None, sock_read_timeout=None, proxy_url=None, tls_validation=None, total_timeout=None, sock_connect_timeout=None, pulp_labels=None, name=None, connect_timeout=None, download_concurrency=None, ca_cert=None, password=None, username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
