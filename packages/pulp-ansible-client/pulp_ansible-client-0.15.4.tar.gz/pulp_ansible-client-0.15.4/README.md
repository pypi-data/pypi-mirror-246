...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List collections
        api_response = api_instance.list(limit=limit, name=name, namespace=namespace, offset=offset, ordering=ordering, pulp_href__in=pulp_href__in, pulp_id__in=pulp_id__in, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
