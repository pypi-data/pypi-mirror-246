...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, sock_read_timeout=None, ca_cert=None, client_cert=None, connect_timeout=None, pulp_created=None, max_retries=None, hidden_fields=None, total_timeout=None, rate_limit=None, sock_connect_timeout=None, pulp_href=None, pulp_last_updated=None, headers=None, url=None, download_concurrency=None, tls_validation=None, name=None, pulp_labels=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
