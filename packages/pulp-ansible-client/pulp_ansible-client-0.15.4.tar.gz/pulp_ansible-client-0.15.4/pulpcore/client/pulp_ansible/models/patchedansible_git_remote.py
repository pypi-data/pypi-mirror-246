...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_url=None, sock_read_timeout=None, ca_cert=None, client_cert=None, connect_timeout=None, proxy_username=None, max_retries=None, client_key=None, username=None, total_timeout=None, password=None, rate_limit=None, sock_connect_timeout=None, proxy_password=None, headers=None, url=None, download_concurrency=None, tls_validation=None, name=None, pulp_labels=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
