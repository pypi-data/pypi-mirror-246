...
class AnsibleGitRemote(object):
    ...
    def __init__(self, tls_validation=None, password=None, proxy_url=None, sock_connect_timeout=None, username=None, pulp_labels=None, headers=None, sock_read_timeout=None, proxy_username=None, client_key=None, client_cert=None, max_retries=None, proxy_password=None, url=None, download_concurrency=None, ca_cert=None, connect_timeout=None, rate_limit=None, total_timeout=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
