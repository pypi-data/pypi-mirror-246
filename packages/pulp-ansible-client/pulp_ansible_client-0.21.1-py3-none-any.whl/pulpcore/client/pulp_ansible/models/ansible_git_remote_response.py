...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, tls_validation=None, proxy_url=None, sock_connect_timeout=None, hidden_fields=None, pulp_labels=None, pulp_created=None, headers=None, sock_read_timeout=None, client_cert=None, max_retries=None, url=None, download_concurrency=None, ca_cert=None, pulp_href=None, connect_timeout=None, rate_limit=None, total_timeout=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
