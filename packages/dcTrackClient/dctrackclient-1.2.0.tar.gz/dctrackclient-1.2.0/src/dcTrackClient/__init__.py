...
class Client:
    """Sunbird dcTrack API client version 1.2.0 in Python"""
    ...
    def updateActualReadingsByPortBulk(self, itemId: int, portName: str, portId: int, payload: dict):
        ...
        return self.__request('PUT', '/api/v2/items/' + str(itemId) + '/actualReadings/' + str(portName) + '/' + str(portId) + '/?', payload)

    def getActualReadingsByPortBulk(self, itemId: int, portName: str, portId: int):
        ...
        return self.__request('GET', '/api/v2/items/' + str(itemId) + '/actualReadings/' + str(portName) + '/' + str(portId) + '/?')
