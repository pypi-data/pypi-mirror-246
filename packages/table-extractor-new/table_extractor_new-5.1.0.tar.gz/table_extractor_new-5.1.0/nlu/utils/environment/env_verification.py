"""
Verify all dependencies for NLU are requried
...
# TODO
def verify_pyspark_installed(): pass

def verify_spark_nlp_installed(): pass

def verify_java8_installed_and_default(correct=''): pass

def verify_python_version(correct=''): pass