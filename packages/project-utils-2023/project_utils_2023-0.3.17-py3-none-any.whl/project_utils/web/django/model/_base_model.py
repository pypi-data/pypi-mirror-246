...
class BaseModel(Model):
    ...
    id: CharField = CharField(max_length=34, verbose_name="ID", blank=True, primary_key=True,
                              default=IDModel.create_id(table_id))
    is_delete: BooleanField = BooleanField(verbose_name="删除标记", blank=True, default=False)
