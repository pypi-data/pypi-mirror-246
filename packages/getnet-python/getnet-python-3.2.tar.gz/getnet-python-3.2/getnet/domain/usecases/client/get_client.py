...
class Client(object):
    ...
    def create_pix_transaction(self, amount, customer_id, order_id, currency="BRL", qr_code_expiration_time=180) -> payments.credit.Service:
        return self.payment_pix_service().create(amount, customer_id, order_id, currency, qr_code_expiration_time)