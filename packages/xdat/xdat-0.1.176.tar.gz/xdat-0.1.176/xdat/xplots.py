...
def plot_corr_heatmap(df, title='Correlation Heatmap', fontsize=12, pad=12, cmap='BrBG', figsize=(15,15), show=True, as_xpptx=None, half=True):
    """
...
def plot_dispersion_summary(df, cols=None, kind='cv'):
    if cols is None:
        cols = df.columns
