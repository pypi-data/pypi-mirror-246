...
import os
import importlib
from Scripts.video_to_jpeg_frames import video_to_jpeg_frames  


from main import function_handler
from Scripts.pic2vid import pic_2_vid_main
from Scripts.cut_video_into_pieces import cut_video_into_pieces
...
def batch_content_create_infinte_gifs(directory_path, amount_of_vids_to_process, offset):
    ...
    count=offset
    input("from this line original content get's changed back up before you lose original content press enter what")
