{
  ...
  "You can rearrange the resources by dragging them using the arrow icon. Drag the resource to the right and place it to the desired location on the list. When you are done, click the \"Save order\" -button.": [
    null,
    "You can rearrange the resources by dragging them using the arrow icon. Drag the resource to the right and place it in the desired location on the list. When you are done, click the \"Save order\" -button."
  ],
  "error loading view": [
    null,
    "error loading view"
