...
class FileIdalessUploadRequest(object):
    ...
    def __init__(self, filedata=None):  # noqa: E501
        """FileIdalessUploadRequest - a model defined in Swagger"""  # noqa: E501
        self._filedata = None
    ...
    @property
    def filedata(self):
        """Gets the filedata of this FileIdalessUploadRequest.  # noqa: E501


        :return: The filedata of this FileIdalessUploadRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def filedata(self, filedata):
        """Sets the filedata of this FileIdalessUploadRequest.


        :param filedata: The filedata of this FileIdalessUploadRequest.  # noqa: E501
        :type: str
        """
        if filedata is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileIdalessUploadRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileIdalessUploadRequest):
            return False
