...
class FileProcedureResponse(object):
    ...
    def __init__(self, hard_hash=None, example_start_ea=None, example_end_ea=None, is_library=None, example_procedure=None, example_procedure_id=None, status=None, example_block_eas=None, block_counts=None, instr_counts=None, byte_counts=None, occurrence_counts=None, name_counts=None, procedure_names=None, coverage=None, signature=None, signature_count=None, example_procedure_count=None):  # noqa: E501
