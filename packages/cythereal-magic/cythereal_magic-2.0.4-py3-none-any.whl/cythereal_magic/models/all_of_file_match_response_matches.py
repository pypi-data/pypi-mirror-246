...
import six
from cythereal_magic.models.file_matches_id_list import FileMatchesIdList  # noqa: F401,E501

class AllOfFileMatchResponseMatches(FileMatchesIdList):
    ...
    if hasattr(FileMatchesIdList, "swagger_types"):
        swagger_types.update(FileMatchesIdList.swagger_types)

    attribute_map = {
    }
    if hasattr(FileMatchesIdList, "attribute_map"):
        attribute_map.update(FileMatchesIdList.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileMatchResponseMatches - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileMatchesIdList.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileMatchResponseMatches, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileMatchResponseMatches):
            return False
