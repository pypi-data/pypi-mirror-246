...
import six
from cythereal_magic.models.condition_enum import ConditionEnum  # noqa: F401,E501

class AllOfYaraProcedureRequestCondition(ConditionEnum):
    ...
    if hasattr(ConditionEnum, "swagger_types"):
        swagger_types.update(ConditionEnum.swagger_types)

    attribute_map = {
    }
    if hasattr(ConditionEnum, "attribute_map"):
        attribute_map.update(ConditionEnum.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfYaraProcedureRequestCondition - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        ConditionEnum.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfYaraProcedureRequestCondition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfYaraProcedureRequestCondition):
            return False
