...
class ExtendedProcedureResponse(object):
    ...
    def __init__(self, procedure_name=None, tags=None, notes=None, hard_hash=None, variant_hash=None, binary_id=None, start_ea=None, end_ea=None, procedure_segment=None, is_libary=None, is_thunk=None, strings=None, api_calls=None, version=None, procedure_id=None, proc_hash=None, blocks=None, block_count=None, code_count=None, semantics_count=None, cfg=None, status=None, occurrence_count=None):  # noqa: E501
