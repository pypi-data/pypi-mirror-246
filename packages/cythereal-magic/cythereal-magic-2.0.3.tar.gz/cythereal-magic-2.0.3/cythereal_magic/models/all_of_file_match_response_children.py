...
import six
from cythereal_magic.models.child_response_id_list import ChildResponseIdList  # noqa: F401,E501

class AllOfFileMatchResponseChildren(ChildResponseIdList):
    ...
    if hasattr(ChildResponseIdList, "swagger_types"):
        swagger_types.update(ChildResponseIdList.swagger_types)

    attribute_map = {
    }
    if hasattr(ChildResponseIdList, "attribute_map"):
        attribute_map.update(ChildResponseIdList.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileMatchResponseChildren - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        ChildResponseIdList.__init__(self, *args, **kwargs)
