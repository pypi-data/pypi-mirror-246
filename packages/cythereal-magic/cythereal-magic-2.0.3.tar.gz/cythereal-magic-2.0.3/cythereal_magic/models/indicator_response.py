...
class IndicatorResponse(object):
    ...
    def __init__(self, tags=None, notes=None, value=None, ioc_type=None, file_children=None, related_iocs=None, parents=None, malicious=None, upload_date=None, last_seen=None):  # noqa: E501
