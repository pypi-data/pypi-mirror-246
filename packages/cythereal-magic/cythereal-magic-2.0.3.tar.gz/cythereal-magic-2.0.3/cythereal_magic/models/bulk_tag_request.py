...
class BulkTagRequest(object):
    ...
    def __init__(self, color='#329db6', ids=None):  # noqa: E501
        """BulkTagRequest - a model defined in Swagger"""  # noqa: E501
        self._color = None
        self._ids = None
    ...
    @property
    def color(self):
        """Gets the color of this BulkTagRequest.  # noqa: E501


        :return: The color of this BulkTagRequest.  # noqa: E501
        :rtype: str
        """
        return self._color
    ...
    def color(self, color):
        """Sets the color of this BulkTagRequest.


        :param color: The color of this BulkTagRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ids(self):
        """Gets the ids of this BulkTagRequest.  # noqa: E501


        :return: The ids of this BulkTagRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this BulkTagRequest.


        :param ids: The ids of this BulkTagRequest.  # noqa: E501
        :type: list[str]
        """
        if ids is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkTagRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkTagRequest):
            return False
