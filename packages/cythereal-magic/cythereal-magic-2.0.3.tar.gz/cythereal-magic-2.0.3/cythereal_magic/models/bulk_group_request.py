...
class BulkGroupRequest(object):
    ...
    def __init__(self, ids=None):  # noqa: E501
        """BulkGroupRequest - a model defined in Swagger"""  # noqa: E501
        self._ids = None
    ...
    @property
    def ids(self):
        """Gets the ids of this BulkGroupRequest.  # noqa: E501


        :return: The ids of this BulkGroupRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this BulkGroupRequest.


        :param ids: The ids of this BulkGroupRequest.  # noqa: E501
        :type: list[str]
        """
        if ids is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkGroupRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkGroupRequest):
            return False
