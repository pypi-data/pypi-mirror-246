...
class FileUploadResponse(object):
    ...
    def __init__(self, _self=None, sha1=None, filename=None, filesize=None, filetype=None, job_id=None, message=None, mimetype=None, object_class=None, status=None):  # noqa: E501
