...
import six
from cythereal_magic.models.mini_user_id_list import MiniUserIdList  # noqa: F401,E501

class AllOfGroupReducedResponseMembers(MiniUserIdList):
    ...
    if hasattr(MiniUserIdList, "swagger_types"):
        swagger_types.update(MiniUserIdList.swagger_types)

    attribute_map = {
    }
    if hasattr(MiniUserIdList, "attribute_map"):
        attribute_map.update(MiniUserIdList.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfGroupReducedResponseMembers - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        MiniUserIdList.__init__(self, *args, **kwargs)
