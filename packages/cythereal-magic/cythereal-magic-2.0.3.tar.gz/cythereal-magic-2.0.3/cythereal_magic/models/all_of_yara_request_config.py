...
import six
from cythereal_magic.models.config_enum import ConfigEnum  # noqa: F401,E501

class AllOfYaraRequestConfig(ConfigEnum):
    ...
    if hasattr(ConfigEnum, "swagger_types"):
        swagger_types.update(ConfigEnum.swagger_types)

    attribute_map = {
    }
    if hasattr(ConfigEnum, "attribute_map"):
        attribute_map.update(ConfigEnum.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfYaraRequestConfig - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        ConfigEnum.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfYaraRequestConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfYaraRequestConfig):
            return False
