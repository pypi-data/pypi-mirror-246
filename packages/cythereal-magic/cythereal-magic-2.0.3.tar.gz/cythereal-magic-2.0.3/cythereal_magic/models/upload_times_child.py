...
class UploadTimesChild(object):
    ...
    def __init__(self, time=None, user=None, name=None):  # noqa: E501
        """UploadTimesChild - a model defined in Swagger"""  # noqa: E501
        self._time = None
        self._user = None
        self._name = None
    ...
    @property
    def time(self):
        """Gets the time of this UploadTimesChild.  # noqa: E501


        :return: The time of this UploadTimesChild.  # noqa: E501
        :rtype: date
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this UploadTimesChild.


        :param time: The time of this UploadTimesChild.  # noqa: E501
        :type: date
        """
    ...
    @property
    def user(self):
        """Gets the user of this UploadTimesChild.  # noqa: E501


        :return: The user of this UploadTimesChild.  # noqa: E501
        :rtype: str
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this UploadTimesChild.


        :param user: The user of this UploadTimesChild.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this UploadTimesChild.  # noqa: E501


        :return: The name of this UploadTimesChild.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UploadTimesChild.


        :param name: The name of this UploadTimesChild.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UploadTimesChild, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadTimesChild):
            return False
