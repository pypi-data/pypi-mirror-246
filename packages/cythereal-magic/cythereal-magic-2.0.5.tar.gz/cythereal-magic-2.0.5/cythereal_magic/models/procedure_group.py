...
class ProcedureGroup(object):
    ...
    def __init__(self, hard_hash=None, status=None, is_library=None, yara_likely=None, version=None, names=None, occurrence_count=None, block_counts=None, instruction_counts=None, byte_counts=None, signature=None, tags=None, notes=None):  # noqa: E501
        """ProcedureGroup - a model defined in Swagger"""  # noqa: E501
        self._hard_hash = None
        self._status = None
        self._is_library = None
        self._yara_likely = None
        self._version = None
        self._names = None
        self._occurrence_count = None
        self._block_counts = None
        self._instruction_counts = None
        ...
        if yara_likely is not None:
            self.yara_likely = yara_likely
    ...
    @property
    def hard_hash(self):
        """Gets the hard_hash of this ProcedureGroup.  # noqa: E501


        :return: The hard_hash of this ProcedureGroup.  # noqa: E501
        :rtype: str
        """
    ...
    def hard_hash(self, hard_hash):
        """Sets the hard_hash of this ProcedureGroup.


        :param hard_hash: The hard_hash of this ProcedureGroup.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this ProcedureGroup.  # noqa: E501


        :return: The status of this ProcedureGroup.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ProcedureGroup.


        :param status: The status of this ProcedureGroup.  # noqa: E501
        :type: str
        """
    ...
    @property
    def is_library(self):
        """Gets the is_library of this ProcedureGroup.  # noqa: E501


        :return: The is_library of this ProcedureGroup.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_library(self, is_library):
        """Sets the is_library of this ProcedureGroup.


        :param is_library: The is_library of this ProcedureGroup.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def yara_likely(self):
        """Gets the yara_likely of this ProcedureGroup.  # noqa: E501


        :return: The yara_likely of this ProcedureGroup.  # noqa: E501
        :rtype: bool
        """
        return self._yara_likely

    @yara_likely.setter
    def yara_likely(self, yara_likely):
        """Sets the yara_likely of this ProcedureGroup.


        :param yara_likely: The yara_likely of this ProcedureGroup.  # noqa: E501
        :type: bool
        """

        self._yara_likely = yara_likely

    @property
    def version(self):
        """Gets the version of this ProcedureGroup.  # noqa: E501


        :return: The version of this ProcedureGroup.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this ProcedureGroup.


        :param version: The version of this ProcedureGroup.  # noqa: E501
        :type: str
        """
    ...
    @property
    def names(self):
        """Gets the names of this ProcedureGroup.  # noqa: E501


        :return: The names of this ProcedureGroup.  # noqa: E501
        :rtype: list[str]
        """
        return self._names
    ...
    def names(self, names):
        """Sets the names of this ProcedureGroup.


        :param names: The names of this ProcedureGroup.  # noqa: E501
        :type: list[str]
        """
    ...
    def occurrence_count(self):
        """Gets the occurrence_count of this ProcedureGroup.  # noqa: E501


        :return: The occurrence_count of this ProcedureGroup.  # noqa: E501
        :rtype: int
        """
    ...
    def occurrence_count(self, occurrence_count):
        """Sets the occurrence_count of this ProcedureGroup.


        :param occurrence_count: The occurrence_count of this ProcedureGroup.  # noqa: E501
        :type: int
        """
    ...
    def block_counts(self):
        """Gets the block_counts of this ProcedureGroup.  # noqa: E501


        :return: The block_counts of this ProcedureGroup.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def block_counts(self, block_counts):
        """Sets the block_counts of this ProcedureGroup.


        :param block_counts: The block_counts of this ProcedureGroup.  # noqa: E501
        :type: list[int]
        """
        if block_counts is None:
            raise ValueError("Invalid value for `block_counts`, must not be `None`")  # noqa: E501

        self._block_counts = block_counts

    @property
    def instruction_counts(self):
        """Gets the instruction_counts of this ProcedureGroup.  # noqa: E501


        :return: The instruction_counts of this ProcedureGroup.  # noqa: E501
        :rtype: list[int]
        """
        return self._instruction_counts

    @instruction_counts.setter
    def instruction_counts(self, instruction_counts):
        """Sets the instruction_counts of this ProcedureGroup.


        :param instruction_counts: The instruction_counts of this ProcedureGroup.  # noqa: E501
        :type: list[int]
        """
        if instruction_counts is None:
            raise ValueError("Invalid value for `instruction_counts`, must not be `None`")  # noqa: E501

        self._instruction_counts = instruction_counts

    @property
    def byte_counts(self):
        """Gets the byte_counts of this ProcedureGroup.  # noqa: E501


        :return: The byte_counts of this ProcedureGroup.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def byte_counts(self, byte_counts):
        """Sets the byte_counts of this ProcedureGroup.


        :param byte_counts: The byte_counts of this ProcedureGroup.  # noqa: E501
        :type: list[int]
        """
        if byte_counts is None:
            raise ValueError("Invalid value for `byte_counts`, must not be `None`")  # noqa: E501

        self._byte_counts = byte_counts

    @property
    def signature(self):
        """Gets the signature of this ProcedureGroup.  # noqa: E501


        :return: The signature of this ProcedureGroup.  # noqa: E501
        :rtype: list[list[str]]
        """
    ...
    def signature(self, signature):
        """Sets the signature of this ProcedureGroup.


        :param signature: The signature of this ProcedureGroup.  # noqa: E501
        :type: list[list[str]]
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this ProcedureGroup.  # noqa: E501


        :return: The tags of this ProcedureGroup.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ProcedureGroup.


        :param tags: The tags of this ProcedureGroup.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this ProcedureGroup.  # noqa: E501


        :return: The notes of this ProcedureGroup.  # noqa: E501
        :rtype: list[str]
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this ProcedureGroup.


        :param notes: The notes of this ProcedureGroup.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProcedureGroup, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProcedureGroup):
            return False
