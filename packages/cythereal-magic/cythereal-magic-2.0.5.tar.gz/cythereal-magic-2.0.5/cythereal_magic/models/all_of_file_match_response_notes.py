...
import six
from cythereal_magic.models.file_note_id_list import FileNoteIdList  # noqa: F401,E501

class AllOfFileMatchResponseNotes(FileNoteIdList):
    ...
    if hasattr(FileNoteIdList, "swagger_types"):
        swagger_types.update(FileNoteIdList.swagger_types)

    attribute_map = {
    }
    if hasattr(FileNoteIdList, "attribute_map"):
        attribute_map.update(FileNoteIdList.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileMatchResponseNotes - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileNoteIdList.__init__(self, *args, **kwargs)
