...
class EnvelopedTagList200EnvelopedIdList200(object):
    ...
    def __init__(self):  # noqa: E501
        """EnvelopedTagList200EnvelopedIdList200 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnvelopedTagList200EnvelopedIdList200, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnvelopedTagList200EnvelopedIdList200):
            return False
