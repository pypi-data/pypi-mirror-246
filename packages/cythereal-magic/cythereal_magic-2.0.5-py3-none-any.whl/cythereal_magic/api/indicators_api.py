...
class IndicatorsApi(object):
    ...
    def list_iocs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='EnvelopedIndicatorResponseList200',  # noqa: E501
    ...
    def upload_ioc_file(self, filedata, **kwargs):  # noqa: E501
        """Upload a text or csv file for IoC Extraction  # noqa: E501

           Upload a text or csv file for IoC Extraction           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_ioc_file(filedata, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.upload_ioc_file_with_http_info(filedata, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_ioc_file_with_http_info(filedata, **kwargs)  # noqa: E501
            return data

    def upload_ioc_file_with_http_info(self, filedata, **kwargs):  # noqa: E501
        """Upload a text or csv file for IoC Extraction  # noqa: E501

           Upload a text or csv file for IoC Extraction           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_ioc_file_with_http_info(filedata, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['filedata', 'format', 'explain', 'download', 'filename', 'no_links', 'uri']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EnvelopedIndicatorFileUploadResponse200',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
