...
class DataSourceClient:
    ...
    def get_data_source_files(self, data_source_id: str) -> typing.List[LoadedFile]:
        """
        ...
        client.data_source.get_data_source_files(
            data_source_id="data-source-id",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"api/data_source/{data_source_id}/file"),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
    ...
    def get_data_source_file_content(self, data_source_id: str, loaded_file_id: str) -> LoadedFilePayload:
        """
        Get loaded files for a data source by ID.
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            urllib.parse.urljoin(
                ...
                f"api/data_source/{data_source_id}/file/{loaded_file_id}/content",
            ),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
...
class AsyncDataSourceClient:
    ...
    async def get_data_source_files(self, data_source_id: str) -> typing.List[LoadedFile]:
        """
        Get loaded files for a data source by ID.
        ...
        await client.data_source.get_data_source_files(
            data_source_id="data-source-id",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def get_data_source_file_content(self, data_source_id: str, loaded_file_id: str) -> LoadedFilePayload:
        """
        Get loaded files for a data source by ID.
