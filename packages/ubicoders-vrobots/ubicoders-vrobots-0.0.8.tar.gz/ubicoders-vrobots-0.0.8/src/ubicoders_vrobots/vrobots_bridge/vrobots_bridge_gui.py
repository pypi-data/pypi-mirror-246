...
import pyperclip
from .vrobots_bridge import BRIDGE, ws_list
...
async def app(page: ft.Page):
    ...
    async def button_clicked(e):
        ...
        page.snack_bar = ft.SnackBar(ft.Text(f"Copied to clipboard:  {ws_url}"))
    ...
    txt_title = ft.Text(
        "Virtual Robots Bridge Running at",
        color="#4d4d4d",
        font_family="Sans",
    ...
    txt_title2 = ft.Text(
        ws_url, color="#059669", font_family="Sans", weight=ft.FontWeight.W_500, size=14
    )
