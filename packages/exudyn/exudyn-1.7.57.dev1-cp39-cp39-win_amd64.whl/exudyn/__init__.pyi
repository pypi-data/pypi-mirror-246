...
class MainSystem:
    ...
    @overload
    def CreateGround(self, name='', referencePosition=[0.,0.,0.], referenceRotationMatrix=np.eye(3), graphicsDataList=[], show=True) -> ObjectIndex: ...
    ...
    @overload
    def CreateSpringDamper(self, name='', bodyList=[None, None], localPosition0=[0.,0.,0.], localPosition1=[0.,0.,0.], referenceLength=None, stiffness=0., damping=0., force=0., velocityOffset=0., bodyOrNodeList=[None, None], show=True, drawSize=-1, color=color4default) -> ObjectIndex: ...

    @overload
    def CreateCartesianSpringDamper(self, name='', bodyList=[None, None], localPosition0=[0.,0.,0.], localPosition1=[0.,0.,0.], stiffness=[0.,0.,0.], damping=[0.,0.,0.], offset=[0.,0.,0.], bodyOrNodeList=[None, None], show=True, drawSize=-1, color=color4default) -> ObjectIndex: ...

    @overload
    def CreateRigidBodySpringDamper(self, name='', bodyList=[None, None], localPosition0=[0.,0.,0.], localPosition1=[0.,0.,0.], stiffness=np.zeros((6,6)), damping=np.zeros((6,6)), offset=[0.,0.,0.,0.,0.,0.], rotationMatrixJoint=np.eye(3), useGlobalFrame=True, intrinsicFormulation=True, bodyOrNodeList=[None, None], show=True, drawSize=-1, color=color4default) -> ObjectIndex: ...
