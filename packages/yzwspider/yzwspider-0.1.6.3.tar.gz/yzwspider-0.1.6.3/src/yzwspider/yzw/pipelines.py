...
class YzwPipeline(object):
    ...
    def newExcelFile(self):
        ...
        self.sheet.col(18).width = 10000
        self.list = ['id', '招生单位', '院校特性', '院系所', '专业', '研究方向', '学习方式', '拟招生人数'
            , '业务课一', '业务课二', '外语', '政治', '所在地', '专业代码', '指导老师', '门类', '一级学科', '备注', '是否接收退役大学生士兵专项计划考生报考']
    ...
    def __make_sql(self, item):
        sql = f"""insert into `{self.settings.get('TABLE')}` 
            (`id`, `招生单位`, `院校特性`, `院系所`, `专业`,`研究方向`,`学习方式`, `拟招生人数`, `备注`,
             `业务课一`, `业务课二`, `外语`, `政治`, `所在地`, `专业代码`,`指导老师`, `门类`, `一级学科`, `是否接收退役大学生士兵专项计划考生报考`)
