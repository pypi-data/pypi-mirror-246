...
def _gen(ds: str = None):
    ...
    for domain in domain_names:
        ...
        context = {
            ...
            'warnings': [],  # return warnings to user
        }
        #
        ...
        #
        # Print warnings of current domain
        # TODO: Show more generation stats
        #
        if context['warnings']:
            logger.warning(f'Encounter blew warnings when processing {domain}:')
            for i, w in enumerate(context['warnings']):
