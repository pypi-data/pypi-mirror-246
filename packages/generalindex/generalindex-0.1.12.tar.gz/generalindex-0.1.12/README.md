...
### Install
```text
pip3 install generalindex==0.1.7
```
...
generalindex==0.1.7
```
The package relies on the other libraries so, in the project, the user must install this library in the requirements.txt file.
```text
