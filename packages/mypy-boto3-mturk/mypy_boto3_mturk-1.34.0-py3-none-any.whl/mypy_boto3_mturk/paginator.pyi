...
class ListHITsPaginator(Paginator):
    ...
    ) -> _PageIterator[ListHITsResponsePaginatorTypeDef]:
        """
...
class ListHITsForQualificationTypePaginator(Paginator):
    ...
    ) -> _PageIterator[ListHITsForQualificationTypeResponsePaginatorTypeDef]:
        """
...
class ListReviewableHITsPaginator(Paginator):
    ...
    def paginate(
        ...
        *,
        ...
        PaginationConfig: PaginatorConfigTypeDef = ...
    ) -> _PageIterator[ListReviewableHITsResponsePaginatorTypeDef]:
        """
