...
from nanoCEM.cem_utils import read_fasta_to_dic,identify_file_path,build_out_path,extract_kmer_feature
...
if __name__ == '__main__':
    ...
    feature_matrix, label = extract_kmer_feature(df_copy, 1, args.pos + 1)
