...
class IngestionHealthCheckResult:
    ...
    git_healthcheck_result: list[GitHealthCheckResult] = field(default_factory=list)
    ...
    def __post_init__(self):
        ...
        git_successful = self.git_healthcheck_result and all([x.successful for x in self.git_healthcheck_result])
    ...
    def from_json(cls, body: str):
        ...
        for healthcheck_result in healthcheck_dict['git_healthcheck_result']:
            parsed_result = GitHealthCheckResult.from_dict(healthcheck_result)
            new_git_healthcheck_list.append(parsed_result)

        healthcheck_dict['git_healthcheck_result'] = new_git_healthcheck_list
