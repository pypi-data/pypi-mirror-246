...
Refer to the Terraform Registory for docs: [`data_dns_txt_record_set`](https://registry.terraform.io/providers/hashicorp/dns/3.4.0/docs/data-sources/txt_record_set).
'''
import abc
import builtins
import datetime
...
def _typecheckingstub__9999db56950aec01892ac92fc94fbab533568fe7436c5be652763fd498176221(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
