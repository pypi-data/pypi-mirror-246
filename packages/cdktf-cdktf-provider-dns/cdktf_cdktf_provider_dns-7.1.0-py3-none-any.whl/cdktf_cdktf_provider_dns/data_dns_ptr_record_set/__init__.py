...
Refer to the Terraform Registory for docs: [`data_dns_ptr_record_set`](https://registry.terraform.io/providers/hashicorp/dns/3.4.0/docs/data-sources/ptr_record_set).
'''
import abc
import builtins
import datetime
