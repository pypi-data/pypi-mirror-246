...
import { B as BlockLabel } from './BlockLabel-e5c3afdf.js';
import { I as IconButton } from './IconButton-26b6d1f3.js';
import { E as Empty } from './Empty-7c227cec.js';
import { S as ShareButton } from './ShareButton-8016cd46.js';
import { D as Download } from './Download-ea83bae3.js';
import './Index-c1c2c30a.js';
import { I as Image } from './Image-6cbf81d1.js';
import { I as Image$1 } from './Example.svelte_svelte_type_style_lang-e0652a7c.js';
import { D as DownloadLink } from './DownloadLink-34eb6098.js';
import { n as normalise_file } from './index-96c4f758.js';
import { U as Upload$1 } from './Upload-8f4bfd80.js';
import { D as DropdownArrow } from './DropdownArrow-ad6064fa.js';
import { U as Upload } from './Upload-778e2237.js';
...
function create_if_block$1(ctx) {
	...
	return {
		c() {
			...
			attr$2(button, "class", "svelte-akwmgk");
			attr$2(div, "class", "button-wrap svelte-akwmgk");
...
function create_else_block_1(ctx) {
	...
	return {
		c() {
			...
			attr$2(div, "class", "icon svelte-akwmgk");
...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			attr$2(div, "class", "icon red svelte-akwmgk");
...
function create_if_block_2$1(ctx) {
	...
	return {
		c() {
			...
			attr$2(span, "class", "inset-icon svelte-akwmgk");
			attr$2(div, "class", "select-wrap svelte-akwmgk");
		},
		m(target, anchor) {
			insert$2(target, div, anchor);
			append$1(div, span);
...
function create_each_block$1(ctx) {
	...
	return {
		c() {
			...
			t0 = text(t0_value);
			t1 = space$1();
			attr$2(div, "class", "svelte-akwmgk");
		},
		m(target, anchor) {
			insert$2(target, div, anchor);
			append$1(div, t0);
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			t = space$1();
			if (if_block) if_block.c();
			attr$2(video, "class", "svelte-akwmgk");
			toggle_class$1(video, "flip", /*mirror_webcam*/ ctx[2]);
			attr$2(div, "class", "wrap svelte-akwmgk");
		},
		m(target, anchor) {
			insert$2(target, div, anchor);
			append$1(div, video);
...
// (114:1) {#if value?.url && !active_streaming}
function create_if_block_4(ctx) {
	let clearimage;
	let current;
	clearimage = new ClearImage({});
	clearimage.$on("remove_image", /*remove_image_handler*/ ctx[23]);
...
// (134:3) {#if value === null && !active_tool}
...
// (123:2) <Upload    hidden={value !== null || active_tool === "webcam"}    bind:this={upload}    bind:uploading    bind:dragging    filetype="image/*"    on:load={handle_upload}    on:error    {root}    disable_click={!sources.includes("upload")}   >
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "image-frame svelte-5ik5tc");
...
function create_if_block_1(ctx) {
	...
	webcam.$on("capture", /*capture_handler*/ ctx[28]);
	webcam.$on("stream", /*stream_handler*/ ctx[29]);
	webcam.$on("error", /*error_handler_1*/ ctx[30]);
	webcam.$on("drag", /*drag_handler*/ ctx[31]);
	webcam.$on("upload", /*upload_handler*/ ctx[32]);
...
// (159:1) {#if sources.length > 1 || sources.includes("clipboard")}
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*sources_list*/ 16384 | dirty[1] & /*$$scope*/ 8) {
...
// (161:3) {#each sources_list as source}
function create_each_block(ctx) {
	let iconbutton;
	let current;

	function click_handler() {
		return /*click_handler*/ ctx[33](/*source*/ ctx[35]);
	}

	iconbutton = new IconButton({
			props: {
				Icon: /*sources_meta*/ ctx[19][/*source*/ ctx[35]].icon,
				size: "large",
				label: "" + (/*source*/ ctx[35] + "-image-toolbar-btn"),
				padded: false
			}
		});
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const iconbutton_changes = {};
			if (dirty[0] & /*sources_list*/ 16384) iconbutton_changes.Icon = /*sources_meta*/ ctx[19][/*source*/ ctx[35]].icon;
			if (dirty[0] & /*sources_list*/ 16384) iconbutton_changes.label = "" + (/*source*/ ctx[35] + "-image-toolbar-btn");
			iconbutton.$set(iconbutton_changes);
		},
		i(local) {
			if (current) return;
...
// (160:2) <Toolbar show_border={!value?.url}>
function create_default_slot(ctx) {
	let each_1_anchor;
	let current;
	let each_value = ensure_array_like(/*sources_list*/ ctx[14]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*sources_meta, sources_list, handle_toolbar*/ 1589248) {
				each_value = ensure_array_like(/*sources_list*/ ctx[14]);
				let i;
...
function create_fragment(ctx) {
	...
	function upload_1_uploading_binding(value) {
		/*upload_1_uploading_binding*/ ctx[25](value);
	}
	...
	/*upload_1_binding*/ ctx[24](upload_1);
	...
	upload_1.$on("load", /*handle_upload*/ ctx[15]);
	...
	return {
		c() {
			...
			attr(div0, "class", "upload-container svelte-5ik5tc");
			attr(div1, "data-testid", "image");
			attr(div1, "class", "image-container svelte-5ik5tc");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*value, active_tool*/ 3 | dirty[1] & /*$$scope*/ 8) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*streaming, active_tool*/ 34) {
			$$invalidate(12, active_streaming = streaming && active_tool === "webcam");
		}
		...
		if ($$self.$$.dirty[0] & /*sources*/ 16) {
			$$invalidate(14, sources_list = sources.sort((a, b) => sources_meta[a].order - sources_meta[b].order));
		}
	};
...
//# sourceMappingURL=ImageUploader-c8525721.js.map
