...
const ENTRY_CSS = "./assets/index-bd850389.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-e541bea9.js').then(n => n.I),true?["./Index-e541bea9.js","./Index-1d8dd0ac.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-0b565b60.js.map
