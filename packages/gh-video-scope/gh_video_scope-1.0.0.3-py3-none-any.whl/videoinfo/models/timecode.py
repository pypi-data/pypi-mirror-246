from videoinfo.errors.timecode_errors import TimeCodeErrors as TCErrors
from videoinfo.config.timecode import TimeCodeConfig as TCConfig
...
class Timecode:
    ...
    def timecode_to_frames(self, timecode=TCConfig.DEF_TC):
        self.__validate_timecode(timecode)
    ...
    def get_timecode_at_frame(self, frame: int):
        if frame is None:
            frame = 0
    ...
    def timecode_to_100ns_intervals(self, timecode):
        hours, minutes, seconds, frames = map(int, timecode.split(":"))
