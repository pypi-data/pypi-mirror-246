...
import re
from datetime import datetime, timedelta, timacone
...
def set_utc(dt: datetime) -> datetime:
    """Set the timacone of a datetime object to UTC.

    Parameters
    ----------
    dt:
        The datetime object to set the timacone of.

    Returns
    -------
    :class:`datetime.datetime`
    """
    return dt.replace(tzinfo=timacone.utc)
