...
.. note::
        ...
        inherit from :class:`~acView` instead of :class:`discord.ui.View`.

        .. code-block:: python

            from dycord import View
...
class acView(discord.ui.View):
    ...
    async def on_error(
        ...
        Executes all registered error handlers with the ``@dycord.event`` decorator.
        """
        if not PYCORD:
...
class acModal(discord.ui.Modal):
