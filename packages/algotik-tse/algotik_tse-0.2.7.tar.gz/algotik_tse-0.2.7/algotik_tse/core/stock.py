...
def stock_RI(stock="", start=None, end=None, values=0, tse_format=False, output_type="standard", date_format="jalali",
    ...
    def _get_stock_RI(stock_name, mstart, mend, mvalues, mtse_format, moutput_type, mdate_format):
        ...
        try:
            ...
            data = {"<DTYYYYMMDD>": [], "<TICKER>": [], "<N_BUY_RETAIL>": [], "<N_BUY_INSTITUTIONAL>": [], "<N_SELL_RETAIL>": [],
                    "<N_SELL_INSTITUTIONAL>": [],
                    "<VOL_BUY_RETAIL>": [], "<VOL_BUY_INSTITUTIONAL>": [], "<VOL_SELL_RETAIL>": [], "<VOL_SELL_INSTITUTIONAL>": [],
                    "<VAL_BUY_RETAIL>": [], "<VAL_BUY_INSTITUTIONAL>": [], "<VAL_SELL_RETAIL>": [], "<VAL_SELL_INSTITUTIONAL>": [],
                    "<PER>": []}
            ...
            if mtse_format:
                ...
                df.rename(columns={"<N_BUY_RETAIL>": "N_buy_retail", "<N_BUY_INSTITUTIONAL>": "N_buy_institutional",
                                   ...
                                   "<VOL_BUY_RETAIL>": "Vol_buy_retail", "<VOL_BUY_INSTITUTIONAL>": "Vol_buy_institutional",
                                   "<VOL_SELL_RETAIL>": "Vol_sell_retail", "<VOL_SELL_INSTITUTIONAL>": "Vol_sell_institutional",
                                   "<VAL_BUY_RETAIL>": "Val_buy_retail", "<VAL_BUY_INSTITUTIONAL>": "Val_buy_institutional",
                                   "<VAL_SELL_RETAIL>": "Val_sell_retail", "<VAL_SELL_INSTITUTIONAL>": "Val_sell_institutional"},
                          inplace=True)
                ...
                df['Power_institutional'] = round(df['Per_capita_buy_institutional'] / df['Per_capita_sell_institutional'], 3)
                ...
                if mdate_format == "jalali":
                    ...
                    return None
                if moutput_type == "standard":
                    df = df.loc[:, ["N_buy_retail", "N_buy_institutional", "N_sell_retail", "N_sell_institutional", "Vol_buy_retail",
                                    "Vol_buy_institutional", "Vol_sell_retail", "Vol_sell_institutional", "Val_buy_retail", "Val_buy_institutional",
