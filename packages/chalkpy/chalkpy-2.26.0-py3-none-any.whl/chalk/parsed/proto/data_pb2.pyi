...
class ScalarValue(_message.Message):
    ...
    CHALK_FLOAT16_VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        ...
        chalk_float16_value: _Optional[float] = ...,
    ) -> None: ...
...
class ArrowType(_message.Message):
    ...
    CHALK_DECIMAL_128_FIELD_NUMBER: _ClassVar[int]
    CHALK_DECIMAL_256_FIELD_NUMBER: _ClassVar[int]
    NONE: EmptyMessage
    BOOL: EmptyMessage
    UINT8: EmptyMessage
    INT8: EmptyMessage
    ...
    MAP: Map
    CHALK_DECIMAL_128: Decimal
    CHALK_DECIMAL_256: Decimal
    def __init__(
        self,
        ...
        CHALK_DECIMAL_128: _Optional[_Union[Decimal, _Mapping]] = ...,
        CHALK_DECIMAL_256: _Optional[_Union[Decimal, _Mapping]] = ...,
    ) -> None: ...
