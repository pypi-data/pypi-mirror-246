...
DeploymentLaunchConfigPaginatorTypeDef = TypedDict(
    "DeploymentLaunchConfigPaginatorTypeDef",
    {
        "packageName": str,
        "launchFile": str,
...
DeploymentApplicationConfigPaginatorTypeDef = TypedDict(
    "DeploymentApplicationConfigPaginatorTypeDef",
    {
        "application": str,
...
DeploymentJobPaginatorTypeDef = TypedDict(
    "DeploymentJobPaginatorTypeDef",
    {
        "arn": NotRequired[str],
        "fleet": NotRequired[str],
        "status": NotRequired[DeploymentStatusType],
        "deploymentApplicationConfigs": NotRequired[
            List[DeploymentApplicationConfigPaginatorTypeDef]
        ],
        "deploymentConfig": NotRequired[DeploymentConfigTypeDef],
        "failureReason": NotRequired[str],
        "failureCode": NotRequired[DeploymentJobErrorCodeType],
...
ListDeploymentJobsResponsePaginatorTypeDef = TypedDict(
    "ListDeploymentJobsResponsePaginatorTypeDef",
    {
