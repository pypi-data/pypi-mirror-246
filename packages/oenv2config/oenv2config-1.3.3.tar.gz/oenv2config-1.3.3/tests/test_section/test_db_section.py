...
from odoo_env_config.section.db_section import DatabaseOdooConfigSection, MaxConnMode
...
class TestDatabaseOdooConfigSection(unittest.TestCase):
    ...
    def test_max_con_auto_workers(self):
        ...
        """
        conf = DatabaseOdooConfigSection().init(
            Env({"DB_MAX_CONN_MODE": MaxConnMode.AUTO.value, "WORKER_HTTP": str(100), "DB_MAX_CONN": str(20)})
        )
