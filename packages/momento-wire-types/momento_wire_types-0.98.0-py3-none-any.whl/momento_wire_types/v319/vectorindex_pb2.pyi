...
class _FilterExpression(_message.Message):
    __slots__ = ["and_expression", "equals_expression", "greater_or_equal_expression", "greater_than_expression", "less_or_equal_expression", "less_than_expression", "list_contains_expression", "not_expression", "or_expression"]
    AND_EXPRESSION_FIELD_NUMBER: _ClassVar[int]
    EQUALS_EXPRESSION_FIELD_NUMBER: _ClassVar[int]
    GREATER_OR_EQUAL_EXPRESSION_FIELD_NUMBER: _ClassVar[int]
    GREATER_THAN_EXPRESSION_FIELD_NUMBER: _ClassVar[int]
    LESS_OR_EQUAL_EXPRESSION_FIELD_NUMBER: _ClassVar[int]
    ...
    greater_or_equal_expression: _GreaterOrEqualExpression
    greater_than_expression: _GreaterThanExpression
    less_or_equal_expression: _LessOrEqualExpression
    ...
    def __init__(self, equals_expression: _Optional[_Union[_EqualsExpression, _Mapping]] = ..., and_expression: _Optional[_Union[_AndExpression, _Mapping]] = ..., or_expression: _Optional[_Union[_OrExpression, _Mapping]] = ..., not_expression: _Optional[_Union[_NotExpression, _Mapping]] = ..., greater_than_expression: _Optional[_Union[_GreaterThanExpression, _Mapping]] = ..., greater_or_equal_expression: _Optional[_Union[_GreaterOrEqualExpression, _Mapping]] = ..., less_than_expression: _Optional[_Union[_LessThanExpression, _Mapping]] = ..., less_or_equal_expression: _Optional[_Union[_LessOrEqualExpression, _Mapping]] = ..., list_contains_expression: _Optional[_Union[_ListContainsExpression, _Mapping]] = ...) -> None: ...
...
class _GreaterOrEqualExpression(_message.Message):
...
class _LessOrEqualExpression(_message.Message):
    __slots__ = ["field", "float_value", "integer_value"]
    FIELD_FIELD_NUMBER: _ClassVar[int]
    FLOAT_VALUE_FIELD_NUMBER: _ClassVar[int]
    INTEGER_VALUE_FIELD_NUMBER: _ClassVar[int]
