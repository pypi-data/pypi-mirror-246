...
PYBIND11_MODULE(EXTENSION_NAME, h) {
    ...
    py::class_<Shapes2D::Point2d>(h_shapes, "Point")
            ...
            .def("__repr__",
                ...
                r += ")";
                return r;})
            .def("__eq__", &Shapes2D::Point2d::operator==, py::is_operator())
            .def("__ne__", &Shapes2D::Point2d::operator!=, py::is_operator())
            .def("__gt__", &Shapes2D::Point2d::operator>, py::is_operator())
            .def("__lt__", &Shapes2D::Point2d::operator<, py::is_operator());
    ...
    py::class_<Shapes2D::Segment2d>(h_shapes, "Segment")
            ...
            .def("isIntersect", &Shapes2D::Segment2d::isIntersect, "check if two segments intersect",
                 py::arg("segment"))
            .def("getIntersection", &Shapes2D::Segment2d::getIntersect, "return the intesection point of two segments")
            .def("doesPointContain", &Shapes2D::Segment2d::containPoint, "check if point is contained in segment", py::arg("point"))
            .def("getXfromY", &Shapes2D::Segment2d::getXfromY, "get projected x from y value")
            .def("getYfromX", &Shapes2D::Segment2d::getYfromX, "get projected y from x value")
            .def("__repr__",
            ...
            .def("__eq__", &Shapes2D::Segment2d::operator==, py::is_operator())
            .def("__ne__", &Shapes2D::Segment2d::operator!=, py::is_operator());
