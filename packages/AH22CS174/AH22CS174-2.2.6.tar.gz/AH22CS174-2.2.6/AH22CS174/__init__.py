...
class Result_cal:
    ...
    def per(self):
        ...
        try:
            ...
            self.x.insert(p ,"TOTAL",self.Total)
            self.x.insert(p+1 ,"percentage",self.percentage)
            self.x.insert(p+2,"SGPA",cgpa)
            self.x.insert(p+3,"Grade",self.grade)
            self.x.to_excel(self.path_out,index=False)
...
Teacher_name=["Mrs. Aswini","Mrs.vigneshwari","Mrs. Sandya Rani","Mr.Abishek ","Mr.Venkatesh kumar ","Dr.Senthil kuman",
"Mrs. Bhavani","Mrs. Shruthi","Dr.Pillai","Mr. Panchaxari"
]
