...
DnsConfigPaginatorTypeDef = TypedDict(
    "DnsConfigPaginatorTypeDef",
    {
...
ServiceSummaryPaginatorTypeDef = TypedDict(
    "ServiceSummaryPaginatorTypeDef",
    {
        "Id": NotRequired[str],
        "Arn": NotRequired[str],
        ...
        "DnsConfig": NotRequired[DnsConfigPaginatorTypeDef],
        "HealthCheckConfig": NotRequired[HealthCheckConfigTypeDef],
...
ListServicesResponsePaginatorTypeDef = TypedDict(
    "ListServicesResponsePaginatorTypeDef",
    {
